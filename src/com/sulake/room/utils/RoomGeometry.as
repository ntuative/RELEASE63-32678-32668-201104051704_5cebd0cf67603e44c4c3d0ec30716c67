package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_834:Number = 64;
      
      public static const const_1043:Number = 32;
      ...
      private var var_2910:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1169 = new Vector3d();
         this.var_1813 = 1;
         this.var_1814 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1816 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_1815.assign(this.var_151);
         return this.var_1815;
      }
      
      public function get location() : IVector3d
      {
         this.var_518.assign(this.var_92);
         this.var_518.x *= this.var_435;
         this.var_518.y *= this.var_434;
         this.var_518.z *= this.var_436;
         return this.var_518;
      }
      
      public function get direction() : IVector3d
      {
         this._direction.assign(this.var_361);
         return this._direction;
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_435 != param1 * this.var_1813)
         {
            this.var_435 = param1 * this.var_1813;
            ++this.var_161;
         }
      }
      ...
      {
         if(this.var_434 != param1 * this.var_1814)
         {
            this.var_434 = param1 * this.var_1814;
            ++this.var_161;
         }
      }
      ...
      {
         if(this.var_436 != param1 * this.var_1816)
         {
            this.var_436 = param1 * this.var_1816;
            ++this.var_161;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_92.x /= this.var_435;
         this.var_92.y /= this.var_434;
         this.var_92.z /= this.var_436;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_361.x;
         var _loc3_:Number = this.var_361.y;
         var _loc4_:Number = this.var_361.z;
         this.var_361.assign(param1);
         if(this.var_361.x != _loc2_ || this.var_361.y != _loc3_ || this.var_361.z != _loc4_)
         {
            ++this.var_161;
         }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_519 != null)
         {
            ...
            this.var_519.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_519.add(_loc3_,_loc4_);
            ++this.var_161;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_519 != null)
         {
            ...
            return this.var_519.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1169.assign(_loc22_);
         }
         else
         {
            this.var_1169.assign(_loc17_);
         }
         ++this.var_161;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_435;
         _loc2_.y *= this.var_434;
         _loc2_.z *= this.var_436;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1169);
         if(_loc3_ < this.var_2910 || _loc3_ > this.var_2909)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_434;
            _loc2_.z *= this.var_436;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1169);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_92.x * this.var_435,this.var_92.y * this.var_434,this.var_92.z * this.var_436);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_151;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_435,param2.y * this.var_434,param2.z * this.var_436);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_435,param3.y * this.var_434,param3.z * this.var_436);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_435,param4.y * this.var_434,param4.z * this.var_436);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1043;
         }
         else
         {
            this.scale = const_834;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_834;
      }
