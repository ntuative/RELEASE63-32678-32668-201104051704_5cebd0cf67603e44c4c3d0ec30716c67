package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1505:int = 0;
      ...
      private var var_160:IRoomManagerListener;
      
      private var var_2937:IRoomContentLoader;
      
      private var var_621:IRoomObjectFactory = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_524,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_774,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_621 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_621 == null || this.var_514 == null)
         {
            return;
         }
         this._state = const_1607;
         if(this.var_1163 != null)
         {
            _loc1_ = this.var_1163;
            this.var_1163 = null;
            this.initialize(_loc1_,this.var_160);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_620.indexOf(_loc5_) < 0)
            {
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_621.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_621 != null)
         {
            return this.var_621.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_751)
         {
            return;
         }
         if(this.var_55 == null)
         {
            this._state = const_751;
            return;
         }
         if(this.var_55.getGraphicAssetCollection(param1) != null)
         {
            ...
            {
               this._state = const_815;
               if(this.var_160 != null)
               {
                  this.var_160.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_751;
            this.var_160.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_160 != null)
            {
               this.var_160.contentLoaded(null,false);
            }
            return;
         }
         if(this.var_944.indexOf(_loc2_) < 0)
         {
            this.var_944.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_944.length > 0)
         {
            _loc2_ = this.var_944[0];
            this.var_944.splice(0,1);
            _loc3_ = this.var_55.getVisualizationXML(_loc2_);
            if(_loc3_ == null)
            {
               if(this.var_160 != null)
               {
                  this.var_160.contentLoaded(_loc2_,false);
               }
               return;
            }
            ...
            if(this.var_160 != null)
            {
               this.var_160.contentLoaded(_loc2_,true);
            }
            if(this.var_620.length > 0)
            {
                     ...
                     if(_loc15_ != null)
                     {
                        ...
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_621.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_160 != null)
                              {
                                 this.var_160.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
