package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      private var var_173:IRoomRendererBase;
      ...
      {
         return this.var_581[param1];
      }
      
      public function setNumber(param1:String, param2:Number, param3:Boolean = false) : void
      {
         if(this.var_1329.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         ...
         if(this.var_581[param1] != param2)
         {
            this.var_581[param1] = param2;
         }
      }
      ...
      {
         if(this.var_1330.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      public function createObjectInternal(param1:int, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         if(_loc5_ != null)
         {
            ...
            if(this.var_173 != null)
            {
               this.var_173.feedRoomObject(_loc6_);
            }
            return _loc6_;
         }
         return null;
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(this.var_173)
               {
                  this.var_173.removeRoomObject(_loc4_.getInstanceId());
               }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(this.var_173)
                  {
                     this.var_173.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
      ...
      public function setRenderer(param1:IRoomRendererBase) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            while(_loc6_ >= 0)
            {
               ...
               if(_loc7_ != null)
               {
                  this.var_173.feedRoomObject(_loc7_);
               }
               _loc6_--;
            }
            _loc3_--;
