package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1385:String = "asset-libraries";
      
      private static const const_1387:String = "library";
      
      private static const const_1383:String = "service-libraries";
      
      private static const const_1381:String = "library";
      
      private static const const_1384:String = "component-libraries";
      
      private static const const_1386:String = "library";
      
      private static const const_1388:String = "error_data";
      
      private static const const_1389:String = "error_cat";
      
      private static const const_1382:String = "error_desc";
       
      
      private var var_382:LibraryLoaderQueue;
      
      private var var_820:IEventDispatcher;
      
      private var var_544:uint;
      
      private var var_383:Function;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            case Core.const_1073:
               debug("Core; using simple frame update handler");
               this.var_383 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_786:
               debug("Core; using complex frame update handler");
               this.var_383 = this.complexFrameUpdateHandler;
               break;
            case Core.const_676:
               debug("Core; using profiler frame update handler");
               this.var_383 = this.profilerFrameUpdateHandler;
               this.var_214 = new Profiler(this);
               attachComponent(this.var_214,[new IIDProfiler()]);
               var_404.addChild(new ProfilerViewer(this.var_214));
               break;
            case Core.const_484:
               debug("Core; using experimental frame update handler");
               this.var_383 = this.experimentalFrameUpdateHandler;
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_383 = this.debugFrameUpdateHandler;
         }
      }
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1388,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1389,String(param3));
         ErrorReportStorage.setParameter(const_1382,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_820 = loadingEventDelegate;
         if(this.var_382 == null)
         {
         ...
         try
         {
            node = config.child(const_1385)[0];
            if(node != null)
            {
               list = node.child(const_1387);
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_329,e);
         }
         try
         {
            node = config.child(const_1383)[0];
            if(node != null)
            {
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_329,e);
         }
         try
         {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_329,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1538);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_820)
         {
            this.var_820.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_820)
         {
            ...
            this.var_820.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_820)
                  {
                     this.var_820.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_544 - this.var_382.length,this.var_544,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_214 ? 0 : this.var_1526 & 0;
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_214 ? 0 : this.var_1526 & 0;
         var _loc5_:int = 0;
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_383(_loc2_,_loc2_ - this._lastUpdateTimeMs);
