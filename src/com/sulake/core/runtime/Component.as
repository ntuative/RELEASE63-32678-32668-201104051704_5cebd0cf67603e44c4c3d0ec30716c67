package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1070:uint = 4;
       
      
      protected var var_817:uint = 0;
      
      protected var var_1314:String = "";
      ...
      private var var_541:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_541 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_541.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_541.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            this.var_1314 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1314);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1526 & const_1070)
         {
            if(_loc3_ == 0)
            {
               if(this.var_541.getTotalReferenceCount() == 0)
               {
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_541.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_541.getStructByIndex(_loc8_);
