package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1495:int = 10000;
      ...
      private var var_1285:IEncryption;
      
      private var var_848:IProtocol;
      
      private var _id:String;
      
      private var var_1286:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_1286 = new MessageClassManager();
         this.var_82 = new Socket();
         this.var_397 = new Timer(const_1495,1);
         this.var_397.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      {
         this.var_397.delay = param1;
      }
      
      public function addMessageEvent(param1:IMessageEvent) : void
      {
         this.var_331.addConnectionMessageEvent(this._id,param1);
      }
      
      public function removeMessageEvent(param1:IMessageEvent) : void
      {
         this.var_331.removeConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1286.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            this.logConnection("Could not find registered message composer for " + param1);
            return false;
         }
         var _loc5_:ByteArray = this.var_848.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_558)
         {
            this.var_558.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(this.var_1285 != null)
         {
            _loc3_ = this.var_1285.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      {
         this.var_1286.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_848.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_848.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1285 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_848.getMessages(this.var_557,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               eventClasses = this.var_1286.getMessageEventClasses(id);
               events = new Array();
               for each(eventClass in eventClasses)
               {
                  eventsForClass = this.var_331.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  if(parserClass != null)
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = this.var_331.getMessageParser(parserClass);
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_557.writeByte(this.var_82.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_397.stop();
         this.var_2037 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_847));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_2037 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_847));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_847));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_847));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_847));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_847));
         var _loc2_:IOErrorEvent = new IOErrorEvent(IOErrorEvent.IO_ERROR);
         _loc2_.text = "Socket Timeout (" + this.var_397.delay + " ms). Possible Firewall.";
