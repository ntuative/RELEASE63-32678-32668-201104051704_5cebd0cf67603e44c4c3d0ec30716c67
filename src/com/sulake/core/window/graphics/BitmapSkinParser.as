package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_104:String = "active";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_402 = SkinLayoutEntity.const_486;
                  break;
               case "move":
                  _loc5_.var_402 = SkinLayoutEntity.const_308;
                  break;
               case "strech":
                  _loc5_.var_402 = SkinLayoutEntity.const_487;
                  break;
               case "tiled":
                  _loc5_.var_402 = SkinLayoutEntity.const_337;
                  break;
               case "center":
                  _loc5_.var_402 = SkinLayoutEntity.const_1166;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_403 = SkinLayoutEntity.const_486;
                  break;
               case "move":
                  _loc5_.var_403 = SkinLayoutEntity.const_308;
                  break;
               case "strech":
                  _loc5_.var_403 = SkinLayoutEntity.const_487;
                  break;
               case "tiled":
                  _loc5_.var_403 = SkinLayoutEntity.const_337;
                  break;
               case "center":
                  _loc5_.var_403 = SkinLayoutEntity.const_1166;
            }
         }
