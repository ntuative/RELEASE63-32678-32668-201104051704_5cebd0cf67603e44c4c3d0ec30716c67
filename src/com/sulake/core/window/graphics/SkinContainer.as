package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1414:String = "skin";
      
      private static const const_1416:String = "bitmap";
      
      private static const const_1413:String = "fill";
      
      private static const const_1417:String = "text";
      
      private static const const_1412:String = "label";
      
      private static const const_1415:String = "shape";
      ...
      private var var_2857:Dictionary;
      
      private var var_2858:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_2049,this.var_2856);
         this.var_2857 = new Dictionary();
         this.var_2858 = new Dictionary();
         StateCodeTable.fillTables(this.var_2857,this.var_2858);
         this.var_469 = new Dictionary();
         this.var_469[const_1414] = BitmapSkinRenderer;
         this.var_469[const_1416] = BitmapDataRenderer;
         this.var_469[const_1413] = FillSkinRenderer;
         this.var_469[const_1417] = TextSkinRenderer;
         this.var_469[const_1412] = LabelRenderer;
         this.var_469[const_1415] = ShapeSkinRenderer;
         this.var_469[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_469[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_339 == null)
         {
            var_339 = new Array();
            var_339.push(WindowState.const_65);
            var_339.push(WindowState.const_86);
            var_339.push(WindowState.const_99);
            var_339.push(WindowState.const_55);
            var_339.push(WindowState.const_98);
            var_339.push(WindowState.const_85);
            var_339.push(WindowState.const_104);
            var_339.push(WindowState.const_101);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2862 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_2049[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_1054[param1] == null)
         {
            this.var_1054[param1] = new Array(const_1016);
         }
         this.var_1054[param1][param2] = param3;
         if(this.var_1055[param1] == null)
         {
            this.var_1055[param1] = new Array(const_1016);
         }
         this.var_1055[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1054[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1055[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_185)
