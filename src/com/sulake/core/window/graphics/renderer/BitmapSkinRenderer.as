package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      private static var var_27:Rectangle = new Rectangle();
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_472[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  _loc12_ = false;
                  _loc13_ = false;
                  var_27.x = _loc10_.region.x + param3.x;
                  var_27.y = _loc10_.region.y + param3.y;
                  var_27.width = _loc10_.region.width;
                  var_27.height = _loc10_.region.height;
                  if(_loc10_.var_402 == SkinLayoutEntity.const_308)
                  {
                     var_27.x += _loc14_;
                  }
                  else if(_loc10_.var_402 == SkinLayoutEntity.const_487)
                  {
                     _loc12_ = true;
                     var_27.right += _loc14_;
                     if(true)
                     {
                        break;
                     }
                  }
                  else if(_loc10_.var_402 == SkinLayoutEntity.const_337)
                  {
                     _loc12_ = true;
                     var_27.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.var_403 == SkinLayoutEntity.const_308)
                  {
                     var_27.y += _loc15_;
                  }
                  else if(_loc10_.var_403 == SkinLayoutEntity.const_487)
                  {
                     _loc13_ = true;
                     var_27.bottom += _loc15_;
                     if(true)
                     {
                        break;
                     }
                  }
                  else if(_loc10_.var_403 == SkinLayoutEntity.const_337)
                  {
                     _loc13_ = true;
                     var_27.bottom += _loc15_;
                     if(true)
                  ...
                  if(!_loc12_ && !_loc13_)
                  {
                     _loc6_.copyPixels(_loc18_,_loc18_.rect,var_27.topLeft,_loc19_,TOP_LEFT,true);
                  }
                  else if(_loc10_.var_403 == SkinLayoutEntity.const_337 || _loc10_.var_402 == SkinLayoutEntity.const_337)
                  {
                     ...
                     _loc24_ = 0 % _loc20_;
                     _loc25_ = 0 % _loc21_;
                     _loc26_ = new Point(var_27.x,var_27.y);
                  ...
                  {
                     this.var_251.a = var_27.width;
                     this.var_251.d = var_27.height;
                     this.var_251.tx = var_27.x;
                     this.var_251.ty = var_27.y;
                     ALPHA.alphaMultiplier = (_loc19_.getPixel32(0,0) >>> 24) / 255;
                     _loc6_.draw(_loc18_,this.var_251,ALPHA);
                  }
                  else
                  {
                     this.var_251.a = 0 / _loc18_.width;
                     this.var_251.d = 0 / _loc18_.height;
                     this.var_251.tx = 0;
                     this.var_251.ty = 0;
                     _loc31_ = new BitmapData(var_27.width,var_27.height,_loc18_.transparent);
                     _loc31_.draw(_loc18_,this.var_251);
                     _loc32_ = new BitmapData(var_27.width,var_27.height,true,0);
                     _loc32_.draw(_loc19_,this.var_251,null);
                     _loc6_.copyPixels(_loc31_,_loc31_.rect,var_27.topLeft,_loc32_,TOP_LEFT,true);
                     _loc32_.dispose();
                     _loc31_.dispose();
                  }
                  if(_loc16_ && _loc10_.colorize)
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_402 == SkinLayoutEntity.const_308)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_403 == SkinLayoutEntity.const_308)
               {
