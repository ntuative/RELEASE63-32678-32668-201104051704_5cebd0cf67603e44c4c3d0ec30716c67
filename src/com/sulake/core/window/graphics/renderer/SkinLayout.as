package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinLayout extends ChildEntityArray implements ISkinLayout
   {
      ...
      protected var var_276:uint;
      
      protected var _height:uint;
      
      protected var var_2826:String;
      
      protected var var_2867:Boolean;
      ...
      public function isFixedWidth() : Boolean
      {
         ...
         while(_loc2_ < _loc1_)
         {
            if(SkinLayoutEntity(getChildAt(_loc2_)).var_402 != SkinLayoutEntity.const_486)
            {
               return false;
            }
            _loc2_++;
      ...
      public function isFixedHeight() : Boolean
      {
         ...
         while(_loc2_ < _loc1_)
         {
            if(SkinLayoutEntity(getChildAt(_loc2_)).var_403 != SkinLayoutEntity.const_486)
            {
               return false;
            }
            _loc2_++;
      ...
      override public function addChild(param1:IChildEntity) : IChildEntity
      {
         ...
         this.var_276 = _loc2_.region.right > this.var_276 ? uint(_loc2_.region.right) : uint(this.var_276);
      ...
      override public function addChildAt(param1:IChildEntity, param2:int) : IChildEntity
      {
         ...
         this.var_276 = _loc3_.region.right > this.var_276 ? uint(_loc3_.region.right) : uint(this.var_276);
      ...
      override public function removeChild(param1:IChildEntity) : IChildEntity
      {
         ...
         this.var_276 = this.calculateWidth();
