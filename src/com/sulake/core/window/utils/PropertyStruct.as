package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2903 = param3 == const_254 || param3 == const_140 || param3 == const_238 || param3 == const_229;
      ...
      public function toString() : String
      {
         switch(this._type)
         {
            ...
            case const_40:
               return Boolean(this.var_187) == true ? "true" : "false";
            case const_238:
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            case const_254:
               ...
               _loc1_ = "<var key=\"" + this.var_615 + "\">\r<value>\r<" + this._type + ">\r";
               _loc2_ = 0;
            ...
            case const_229:
               ...
               break;
            case const_127:
               _loc1_ = "<var key=\"" + this.var_615 + "\" value=\"" + "0x" + uint(this.var_187).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_615 + "\" value=\"" + this.var_187 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
