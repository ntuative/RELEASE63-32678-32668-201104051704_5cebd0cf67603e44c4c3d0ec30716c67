package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      {
         this.var_326 = param1;
         if(this.var_326 > int.MIN_VALUE && !this._target.disposed && this._target.height < this.var_326)
         {
      ...
      {
         return this.var_329 == int.MIN_VALUE && this.var_327 == int.MAX_VALUE && this.var_326 == int.MIN_VALUE && this.var_328 == int.MAX_VALUE;
      }
      ...
      public function limit() : void
      {
         if(!this.isEmpty && this._target)
         {
            ...
            if(this._target.height < this.var_326)
            {
               this._target.height = this.var_326;
            }
