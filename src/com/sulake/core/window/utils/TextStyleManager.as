package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_181:String = "regular";
      ...
      private static var var_497:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_609:String = "{";
      
      private static const const_608:String = "}";
      
      private static const const_1280:String = "/*";
      
      private static const const_1279:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_85[const_181],var_85[ITALIC],var_85[BOLD]];
            var_85.reset();
            var_85[const_181] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_497.indexOf(_loc4_.name) == -1)
            {
               var_497.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_608);
         if(countSubStrings(param1,const_609) != countSubStrings(param1,const_608))
         {
            throw new Error("Mismatching amount of \"" + const_609 + "\" versus \"" + const_608 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1280) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1279) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_609)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
