package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1980:String = "_INCLUDE";
      
      public static const const_1858:String = "_TEMP";
      
      private static const const_1303:String = "layout";
      
      private static const const_951:String = "window";
      
      private static const const_952:String = "variables";
      
      private static const const_953:String = "filters";
      
      private static const const_436:String = "name";
      
      private static const const_1309:String = "style";
      
      private static const const_612:String = "params";
      
      private static const const_1301:String = "tags";
      ...
      private static const const_1297:String = "visible";
      
      private static const const_1304:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1170:String = "blend";
      
      private static const const_1305:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1298:String = "treshold";
      
      private static const const_1300:String = "children";
      
      private static const const_1296:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1308:String = "height_min";
      
      private static const const_1307:String = "height_max";
      
      private static const const_611:String = "true";
      
      private static const const_162:String = "0";
      
      private static const const_1306:String = "$";
      
      private static const const_1302:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1310:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1299:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1308:Dictionary;
      
      protected var var_1307:Dictionary;
      
      protected var var_1060:Dictionary;
      
      protected var var_1583:Dictionary;
      
      protected var var_2099:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1308,this.var_1307);
         this.var_1060 = new Dictionary();
         this.var_1583 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1060,this.var_1583);
         this.var_2099 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1299,const_50);
         return param1.replace(const_1310,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1307)
            {
               delete this.var_1307[_loc1_];
            }
            for(_loc1_ in this.var_1060)
            {
               delete this.var_1060[_loc1_];
            }
            for(_loc1_ in this.var_1583)
            {
               delete this.var_1583[_loc1_];
            }
            this.var_2099.dispose();
            this.var_2099 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1303)
         {
            _loc8_ = param1.child(const_952);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_953).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1308[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_436,variables,"")));
         style = uint(this.parseAttribute(xml,const_1309,variables,style));
         params = uint(this.parseAttribute(xml,const_612,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1301,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_162));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_162));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_162));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_162));
         visible = this.parseAttribute(xml,const_1297,variables,visible.toString()) == const_611;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_612).length() > 0)
         {
            list = xml.child(const_612).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_436,variables,"") as String;
               if(this.var_1060[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_436)) + "\"!");
               }
               params |= this.var_1060[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1304,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1302);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_952)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1296,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1308,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1307,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_611;
         blend = Number(this.parseAttribute(xml,const_1170,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1305,variables,window.clipping.toString()) == const_611;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1298,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_953).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_201)
                     {
                        window.x = rect.x;
                     }
                     if((params & 0) == WindowParam.const_193)
                     {
                        window.y = rect.y;
                     }
                  }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1307[param1.type];
