package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_173:IWindowRenderer;
      
      protected var var_83:IDesktopWindow;
      
      protected var var_863:IWindowContextStateListener;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_337 = new Array();
            var_337[0] = MouseCursorType.const_293;
            var_337[1] = MouseCursorType.const_29;
            var_337[2] = MouseCursorType.const_293;
            var_337[3] = MouseCursorType.const_293;
            var_337[4] = MouseCursorType.const_293;
            var_337[5] = MouseCursorType.const_29;
            var_337[6] = MouseCursorType.const_293;
         }
         if(var_291 == null)
         {
            var_291 = new Array();
            var_291[0] = WindowState.const_104;
            var_291[1] = WindowState.const_85;
            var_291[2] = WindowState.const_98;
            var_291[3] = WindowState.const_65;
            var_291[4] = WindowState.const_55;
            var_291[5] = WindowState.const_99;
            var_291[6] = WindowState.const_86;
         }
      }
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_65 = state.var_1305 as WindowController;
         this.var_174 = state.var_1301 as WindowController;
         this.var_173 = state.renderer;
         this.var_863 = state.var_1304;
         eventQueue.begin();
         this.var_694.x = -1;
         this.var_694.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_694.x || event.stageY != this.var_694.y)
            {
               ...
               array = new Array();
               this.var_83.groupParameterFilteredChildrenUnderPoint(this.var_694,array,WindowParam.const_31);
            }
            ...
            if(index == 0)
            {
               if(event.type == MouseEvent.MOUSE_MOVE)
               {
                  ...
                  {
                     this.var_65.getGlobalPosition(var_409);
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_65 && !this.var_65.disposed)
                     {
                        ...
                        {
                           this.var_863.mouseEventReceived(event.type,this.var_65);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1305 = this.var_65;
         state.var_1301 = this.var_174;
         state.renderer = this.var_173;
         state.var_1304 = this.var_863;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         var _loc5_:BitmapData = this.var_173.getDrawBufferForRenderable(param1);
         if(!param1.validateLocalPointIntersection(_loc4_,_loc5_))
         {
            return null;
         }
         if(param1.testParamFlag(WindowParam.const_571))
         {
