package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1237:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_867:Number;
      
      protected var var_570:Number;
      
      protected var var_569:Boolean;
      ...
      protected var var_1064:Boolean = false;
      
      private var var_438:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_438,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_438 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_438,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_181);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_748 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_438);
      }
      ...
      {
         this.var_867 = param1;
         this._field.scrollH = this.var_867 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_867 * this.maxScrollH,this.var_570 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_438);
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1061) ? new PropertyStruct(PropertyDefaults.const_668,this._field.antiAliasType,PropertyStruct.const_54,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1226) : PropertyDefaults.const_1525);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1206 ? new PropertyStruct(PropertyDefaults.const_917,this._autoSize,PropertyStruct.const_54,true,PropertyDefaults.const_1184) : PropertyDefaults.const_1662);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_40,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_127,this._field.borderColor != 0));
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1201 ? new PropertyStruct(PropertyDefaults.const_1133,this._field.gridFitType,PropertyStruct.const_54,true,PropertyDefaults.const_1034) : PropertyDefaults.const_1593);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_731) ? new PropertyStruct(PropertyDefaults.const_378,this._field.textColor,PropertyStruct.const_127,true) : PropertyDefaults.const_1120);
         _loc1_.push(this.var_438 != TextStyleManager.const_181 ? new PropertyStruct(PropertyDefaults.const_425,this.var_438,PropertyStruct.const_54,true,PropertyDefaults.const_710) : PropertyDefaults.const_1042);
         _loc1_.push(this.var_40.left != PropertyDefaults.const_659 ? new PropertyStruct(PropertyDefaults.const_226,this.var_40.left,PropertyStruct.const_42,true) : PropertyDefaults.const_532);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_831 ? new PropertyStruct(PropertyDefaults.const_263,this.var_40.top,PropertyStruct.const_42,true) : PropertyDefaults.const_585);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_671 ? new PropertyStruct(PropertyDefaults.const_246,this.var_40.right,PropertyStruct.const_42,true) : PropertyDefaults.const_498);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_888 ? new PropertyStruct(PropertyDefaults.const_225,this.var_40.bottom,PropertyStruct.const_42,true) : PropertyDefaults.const_459);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1087 ? new PropertyStruct(PropertyDefaults.const_929,this._field.mouseWheelEnabled,PropertyStruct.const_40,true) : PropertyDefaults.const_1587);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_281,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_281,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_281,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
