package com.sulake.core.window.components
{
   ...
   public class SelectableButtonController extends ButtonController implements ISelectableWindow
   {
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param2.type == WindowEvent.const_572)
         {
            if(_parent)
            {
               if(!(_parent is ISelectorWindow))
               {
                  ...
                  while(_loc3_)
                  {
                     ...
                     {
                        _loc4_ = WindowEvent.allocate(WindowEvent.const_327,this,null);
      ...
      public function select() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_318,this,null);
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_60,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unselect() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_466,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
