package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1115:IItemListWindow;
      
      private var var_424:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_424)
         {
            this.var_424.removeEventListener(WindowEvent.const_250,this.scrollBarEventProc);
            this.var_424.removeEventListener(WindowEvent.const_197,this.scrollBarEventProc);
            this.var_424 = null;
         }
         if(this.var_1115)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1115)
         {
            this.var_1115 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_424)
         {
            this.var_424 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_424)
            {
               this.var_424.addEventListener(WindowEvent.const_250,this.scrollBarEventProc);
               this.var_424.addEventListener(WindowEvent.const_197,this.scrollBarEventProc);
            }
         }
         return this.var_424;
      }
