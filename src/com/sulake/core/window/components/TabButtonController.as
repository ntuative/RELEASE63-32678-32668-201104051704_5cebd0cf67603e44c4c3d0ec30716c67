package com.sulake.core.window.components
{
   ...
   public class TabButtonController extends SelectableController implements ITabButtonWindow
   {
      ...
      private static const const_1737:String = "TAB_BUTTON_CONTENT";
      
      private static const const_1332:String = "TAB_BUTTON_TITLE";
      
      private static const const_1738:String = "TAB_BUTTON_ICON";
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:IWindow = findChildByTag(const_1332);
         if(_loc2_ != null)
         {
      ...
      {
         if(param2.type == WindowEvent.const_138)
         {
