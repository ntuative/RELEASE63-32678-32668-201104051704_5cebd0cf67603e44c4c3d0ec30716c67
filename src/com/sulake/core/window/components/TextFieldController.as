package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      {
         this.var_1311 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1188,var_11);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_779 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_370,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_391,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_639,false,PropertyStruct.const_40,true) : PropertyDefaults.const_1680);
         _loc1_.push(this.var_1321 != PropertyDefaults.const_1085 ? new PropertyStruct(PropertyDefaults.const_872,this.var_1321,PropertyStruct.const_40,true) : PropertyDefaults.const_1600);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1140 ? new PropertyStruct(PropertyDefaults.const_892,_field.selectable,PropertyStruct.const_40,true) : PropertyDefaults.const_1685);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1047 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_40,true) : PropertyDefaults.const_1547);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_872:
                  this.var_1321 = _loc2_.value as Boolean;
                  if(this.var_1321)
                  {
               ...
               case PropertyDefaults.const_639:
                  ...
                  break;
               case PropertyDefaults.const_1038:
