package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private var var_985:String = "default";
      
      private var var_1201:String = null;
      
      private var var_1891:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1201 == param2)
         {
            return;
         }
         param1.var_1201 = param2;
         param1.var_1891 = null;
         if(param1.var_1201 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1201);
            param1.var_1891 = _loc3_;
         }
      }
      ...
      {
         return this.var_985 == LinkTarget.const_29 ? defaultLinkTarget : this.var_985;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_20);
            _field.styleSheet = this.var_1891;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_773)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_985 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_875,this.var_985,PropertyStruct.const_54,true,PropertyDefaults.const_824));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_875)
            {
               this.var_985 = _loc2_.value as String;
               break;
            }
