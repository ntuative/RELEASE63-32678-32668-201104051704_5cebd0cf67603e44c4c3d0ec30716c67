package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_1070:ITabSelectorWindow;
      
      protected var var_2112:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1070 = findChildByTag(const_1418) as ITabSelectorWindow;
            if(this.var_1070 != null)
            {
               this.var_1070.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2112 = findChildByTag(const_1419) as IWindowContainer;
         }
      ...
      {
         return !!this.var_779 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1070.numSelectables;
      }
