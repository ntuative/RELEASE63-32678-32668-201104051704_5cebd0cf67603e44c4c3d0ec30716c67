package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_438);
         if(_loc1_)
         {
      ...
      {
         if(this.var_438 != param1.name)
         {
            this.var_438 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2493 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_363 != _loc2_.color : this.var_363 != null && this.var_363 != PropertyDefaults.const_731) ? new PropertyStruct(PropertyDefaults.const_378,this.var_363,PropertyStruct.const_127,true) : PropertyDefaults.const_1120);
         if(this.var_40)
         {
            if(this.var_40.left != PropertyDefaults.const_659)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_226,this.var_40.left,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_532);
            }
            if(this.var_40.top != PropertyDefaults.const_831)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_263,this.var_40.top,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_585);
            }
            if(this.var_40.right != PropertyDefaults.const_671)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_246,this.var_40.right,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_498);
            }
            if(this.var_40.bottom != PropertyDefaults.const_888)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_225,this.var_40.bottom,PropertyStruct.const_42,true));
            }
            else
            {
