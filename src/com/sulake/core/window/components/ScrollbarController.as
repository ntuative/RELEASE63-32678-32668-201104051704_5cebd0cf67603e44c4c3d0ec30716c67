package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1318:String = "increment";
      
      private static const const_1317:String = "decrement";
      
      private static const const_965:String = "slider_track";
      
      private static const const_613:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_695:Number = 0.1;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_18.removeEventListener(WindowEvent.const_38,this.onScrollableResized);
            this.var_18.removeEventListener(WindowEvent.const_479,this.onScrollableScrolled);
         }
         this.var_18 = param1;
         if(this.var_18 != null && !this.var_18.disposed)
         {
            this.var_18.addEventListener(WindowEvent.const_38,this.onScrollableResized);
            this.var_18.addEventListener(WindowEvent.const_479,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return findChildByName(const_965) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_613) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_613:
         ...
         if(param2.type == WindowEvent.const_826)
         {
            if(this.var_18 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_319)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_695;
                  }
                  else
                  {
                     this.scrollV -= this.var_695;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_45 || param1.type == WindowTouchEvent.const_670)
         {
            ...
            else if(param2.name == const_1317)
            {
               if(this.var_18)
               {
                  this.var_1155 = true;
            ...
            else if(param2.name == const_965)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_613).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
