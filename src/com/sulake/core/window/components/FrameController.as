package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1253:String = "_TITLE";
      
      private static const const_1260:String = "_HEADER";
      
      private static const const_1261:String = "_CONTENT";
      
      private static const const_1262:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1359:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1253) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1359 = findChildByTag(const_1260) as IHeaderWindow;
            if(!this.var_1359)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_192 = findChildByTag(const_1261) as IWindowContainer;
            if(!this.var_192)
            {
      ...
      {
         return findChildByTag(const_1262) as IScalerWindow;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_313);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_257);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_283);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_257,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_257,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_226,_loc3_.left,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_263,_loc3_.top,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_246,0 - _loc3_.right,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_225,0 - _loc3_.bottom,PropertyStruct.const_42,_loc2_));
         }
         else
         {
