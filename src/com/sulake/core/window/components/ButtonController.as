package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_429:String = "_BTN_TEXT";
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:IWindow = getChildByName(const_429);
         if(_loc2_ != null)
         {
         ...
         if(event is WindowEvent)
         {
            switch(event.type)
            {
               ...
               case WindowEvent.const_250:
                  try
                  {
                     getChildByName(const_429).blend = getChildByName(const_429).blend + 0.5;
                  }
                  catch(e:Error)
                  {
                  }
         ...
         else if(event is WindowTouchEvent)
         {
            ...
            switch(event.type)
            {
               ...
               case WindowTouchEvent.const_1229:
                  type = "null";
                  break;
               case WindowTouchEvent.const_670:
                  type = "null";
            }
