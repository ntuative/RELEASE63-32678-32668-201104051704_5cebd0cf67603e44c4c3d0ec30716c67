package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1248:uint = 0;
      ...
      protected static const const_1239:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_1001:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            var_408 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_63 = var_408.clone();
            var_11 = var_408.clone();
         ...
         if(_loc13_)
         {
            var_786 = _loc13_.blend;
            var_478 = _loc13_.var_2862;
         ...
         if(param7 != null)
         {
            ...
            if(this.var_21)
            {
               _context.invalidate(this,var_11,WindowRedrawFlag.const_58);
            }
         }
      }
      ...
      {
         var_479 = param1;
         var_243 = !!var_479 ? uint(var_243 | var_573) : uint(var_243 & 16777215);
      ...
      {
         var_573 = param1 & 4278190080;
         var_243 = !!var_479 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_58);
      }
      ...
      {
         var_573 = param1 << 24;
         var_243 = !!var_479 ? uint(var_573 | var_243) : uint(16777215 & var_243);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_58);
      }
      
      public function set blend(param1:Number) : void
      {
         var_786 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_11,WindowRedrawFlag.const_819);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_79)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1239) == -1)
               {
                  _loc4_.style = var_79;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               ...
               _loc4_ = WindowEvent.allocate(WindowEvent.const_826,this,this._parent);
            ...
            else
            {
               ...
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1430,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_924,var_11);
            this.var_21.visible = var_318;
         }
         return this.var_21;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_79,var_19,_context,var_11,null,this.var_702,this.properties,var_872.concat(),_id) as WindowController;
         ...
         _loc2_.var_573 = var_573;
         _loc2_.var_703 = var_703;
         _loc2_.var_318 = var_318;
         _loc2_.var_786 = var_786;
      ...
      override public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            if(true)
            {
               ...
               {
                  if(this.getStateFlag(WindowState.const_104))
                  {
                     this.deactivate();
                  }
               }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2731 + "]";
      }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         _context.invalidate(this,param1,WindowRedrawFlag.const_58);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_595)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            ...
            _loc7_ = uint(var_19 & 0);
            if(_loc7_ == WindowParam.const_537)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1116,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_240,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_45:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1069;
                  if(testParamFlag(WindowParam.const_420))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_252))
                        {
                  ...
                  if((var_19 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_313))
                        {
               ...
               case WindowMouseEvent.const_61:
                  ...
                  if(testParamFlag(WindowParam.const_252))
                  {
                     _context.getWindowServices().getMouseDraggingService().end(this);
                  }
                  if(testParamFlag(WindowParam.const_313))
                  {
         ...
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_38:
                  ...
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1032,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_201,WindowParam.const_169))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_193,WindowParam.const_173))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc6_ = uint(var_19);
                        var_19 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_514))
                        {
                        ...
                        var_19 = _loc6_;
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_138,this._parent,this);
               ...
               case WindowEvent.const_240:
                  _context.invalidate(this,var_11.union(var_63),WindowRedrawFlag.const_1203);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1572,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_182,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_572:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1101,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_327,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_826:
                  if(testParamFlag(WindowParam.const_201,WindowParam.const_169))
                  {
                     this.updateScaleRelativeToParent();
                  }
         ...
         if(this.var_176 && var_478 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1001,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1001,param3,param1)) : false;
            }
         }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_79 != _loc3_)
         {
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1239) == -1)
               {
                  _loc6_.style = var_79;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_149,WindowParam.const_169);
         var _loc2_:* = !testParamFlag(WindowParam.const_131,WindowParam.const_173);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_376)
               {
                  _loc3_.width += _loc4_;
               }
               ...
               else if(_loc5_ == WindowParam.const_201)
               {
      ...
      public function destroy() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1424,this,null);
      ...
      public function minimize() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1598,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1472,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_65,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1425,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1502,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1470,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1584,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_104,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_572,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1563,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_104,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_522,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1492,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_65,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1627,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1666,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_65,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1446,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_687,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_806,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_197,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1451,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1570,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1545,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1249 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_550,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1249 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_550,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
