package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_764:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         ...
         while(_loc2_ < var_764.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_764.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_764.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
      ...
      {
         var_764.remove(param1);
         var_764.add(param1,param2);
      }
