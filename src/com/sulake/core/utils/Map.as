package com.sulake.core.utils
{
   ...
   public class Map extends Proxy implements IDisposable
   {
      ...
      public function dispose() : void
      {
         ...
         {
            for(_loc1_ in this.var_140)
            {
               delete this.var_140[_loc1_];
            }
            this.var_140 = null;
         }
         this._length = 0;
      ...
      {
         if(this.var_140[param1] != null)
         {
            return false;
         }
         this.var_140[param1] = param2;
      ...
      {
         var _loc2_:Object = this.var_140[param1];
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      override flash_proxy function setProperty(param1:*, param2:*) : void
      {
         ...
         if(this._singleWrite)
         {
            if(this.var_140[param1] != null)
            {
               Core.error("Trying to write to a single write Map. Key: " + param1 + ", value: " + param2,true,Core.const_1153);
            }
         }
         this.var_140[param1] = param2;
