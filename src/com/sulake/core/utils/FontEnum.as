package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_614:Map = new Map();
      
      private static const const_352:Map = new Map();
      
      private static var var_1161:Boolean = false;
      ...
      {
         return const_614.getValue(param1) != null;
      }
      
      public static function isEmbeddedFont(param1:String) : Boolean
      {
         return const_352.getValue(param1) != null;
      }
      ...
      public static function registerFont(param1:Class) : Font
      {
         ...
         const_352.add(_loc4_.fontName,_loc4_);
         return _loc4_;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1161)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_614.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1161 = true;
         }
      ...
      public static function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            _loc3_ = const_352.getValue(_loc2_.fontName);
            if(!_loc3_ || _loc3_.fontType != _loc2_.fontType || _loc3_.fontStyle != _loc2_.fontStyle)
            {
               const_352.add(_loc2_.fontName,_loc2_);
            }
            _loc5_++;
         }
      }
