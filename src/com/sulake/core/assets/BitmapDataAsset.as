package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_106 is Class)
         {
            _loc1_ = new this.var_106() as Bitmap;
            if(_loc1_ != null)
            {
            ...
            this._bitmap = new this.var_106() as BitmapData;
            if(this._bitmap != null)
            {
               this.var_106 = null;
               return;
         ...
         if(this.var_106 is Bitmap)
         {
            this._bitmap = Bitmap(this.var_106).bitmapData;
            if(this._bitmap == null)
            {
         ...
         if(this.var_106 is BitmapData)
         {
            this._bitmap = this.var_106 as BitmapData;
            if(this._bitmap != null)
            {
               this.var_106 = null;
               return;
         ...
         if(this.var_106 is BitmapDataAsset)
         {
            this._bitmap = BitmapDataAsset(this.var_106)._bitmap;
            this._offset = BitmapDataAsset(this.var_106)._offset;
            this.var_1506 = BitmapDataAsset(this.var_106).var_1506;
            this.var_1507 = BitmapDataAsset(this.var_106).var_1507;
            if(this._bitmap != null)
            {
               this.var_106 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1506 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1507 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
