package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_1061 = new LoaderContext();
         this.var_1061.checkPolicyFile = true;
         ...
         {
            this.var_42.load(param2,this.var_1061);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_335 = 0;
         this.var_42.load(param1,this.var_1061);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_335 < var_2868)
            {
               ...
               this.var_42.load(new URLRequest(this.var_1062 + (this.var_1062.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_335),this.var_1061);
               return true;
            }
         }
         return false;
