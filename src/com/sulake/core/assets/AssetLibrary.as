package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1136:String = "AssetLibraryReady";
      
      public static const const_907:String = "AssetLibraryLoaded";
      
      public static const const_1712:String = "AssetLibraryUnloaded";
      
      public static const const_1553:String = "AssetLibraryLoadError";
      
      private static const const_436:String = "name";
      
      private static const const_983:String = "asset";
      
      private static const const_985:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_984:String = "library";
      
      private static var var_317:Dictionary;
      
      private static var var_1884:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_528;
         this.var_449 = new Dictionary(false);
         this.var_527 = new Dictionary(false);
         this.var_977 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_647 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_984);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_436);
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_647 + "!");
               }
               _loc15_++;
            }
         }
      ...
      {
         if(this.var_647 == param1.url && this.var_979)
         {
            if(!this.var_980 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_648);
            }
            this.var_980 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1136));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         this.var_979 = false;
         this.var_647 = null;
         dispatchEvent(new Event(AssetLibrary.const_1712));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_977[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_527[param2.url];
         if(_loc4_ != null)
         {
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_527[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_30:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_448;
                     this.var_450.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_527[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_450.length ? this.getAssetByName(this.var_450[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_168)
         {
            ...
            {
               return this.var_450.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_168[param1] != null || (this.var_648 != null ? this.var_648[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1884.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_168)
            {
               if(this.var_168[_loc2_] == param1)
               {
                  this.var_450.splice(this.var_450.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_449.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_449[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_449[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_449)
         {
            _loc3_ = AssetTypeDeclaration(this.var_449[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_449)
         {
            _loc4_ = AssetTypeDeclaration(this.var_449[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_648 = _loc2_.resource;
         this.var_647 = _loc2_.url;
         if(this.var_980)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_648);
         }
         this.var_979 = true;
         dispatchEvent(new Event(AssetLibrary.const_907));
         dispatchEvent(new Event(AssetLibrary.const_1136));
         if(this.var_980)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1553));
         this.var_42 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_984);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_436).toString() == param1)
               {
                  _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_647 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_648[param1]);
