package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2047:int = 0;
      
      private const const_940:int = 1;
      
      private const const_1749:int = 2;
      
      private const const_1748:int = 3;
      
      private const const_1747:int = 42;
      
      private const const_1750:int = 120;
      ...
      private var var_723:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_345 = param6;
         this.var_345.events.addEventListener(SongInfoReceivedEvent.const_139,this.onSongInfoReceivedEvent);
         this.var_440 = new Map();
         this.var_440.add(FurniModel.const_48,new FurniGridView(this.var_69,FurniModel.const_48,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_440.add(FurniModel.const_52,new FurniGridView(this.var_69,FurniModel.const_52,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_345)
            {
               if(this.var_345.events != null)
               {
                  this.var_345.events.removeEventListener(SongInfoReceivedEvent.const_139,this.onSongInfoReceivedEvent);
               }
               this.var_345 = null;
            }
            this.var_186 = null;
      ...
      public function setViewToState() : void
      {
         ...
         {
            _loc2_ = this.const_940;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1749;
         }
         else
         {
            _loc2_ = this.const_1748;
         }
         if(this.var_2444 == _loc2_)
         {
            return;
         }
         this.var_2444 = _loc2_;
         ...
         switch(_loc2_)
         {
            case this.const_940:
               ...
               break;
            case this.const_1749:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               break;
            case this.const_1748:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_48,FurniModel.const_52];
         var _loc4_:int = 0;
      ...
      public function method_2(param1:String, param2:int) : void
      {
         ...
         var _loc4_:IWindow = _loc3_.method_2(param2);
         if(_loc4_)
         {
            _loc4_.dispose();
         }
      ...
      public function updateActionView() : void
      {
         ...
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_324);
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_298);
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_330);
            ...
            {
               if(_loc5_.category == FurniCategory.const_196)
               {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_723 && this.var_723.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc13_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_803)
               {
                  _loc24_ = this.var_345.musicController.getSongInfo(_loc5_.extra);
                  if(_loc24_ != null)
                  {
                  ...
                  {
                     this.var_345.musicController.requestSongInfoWithoutSamples(_loc5_.extra);
                     this.var_186.push(_loc5_.extra);
                  }
               }
            }
         ...
         if(_loc14_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_803)
               {
                  _loc25_ = this.var_345.musicController.getSongInfo(_loc5_.extra);
                  if(_loc25_ != null)
                  {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1750)
         {
            _loc3_ = this.const_1750;
         }
         else if(_loc3_ < this.const_1747)
         {
            _loc3_ = this.const_1747;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_60)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_407);
            }
         }
      }
      ...
      {
         if(this.var_186.indexOf(param1.id as Number) != -1)
         {
            this.updateActionView();
            while(this.var_186.indexOf(param1.id as Number) != -1)
            {
               this.var_186.splice(this.var_186.indexOf(param1.id as Number),1);
            }
         }
      }
   }
