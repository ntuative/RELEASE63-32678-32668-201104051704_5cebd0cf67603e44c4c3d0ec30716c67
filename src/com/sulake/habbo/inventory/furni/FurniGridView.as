package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(this._view != null)
         {
            this.var_254 = this._view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      public function method_2(param1:int) : IWindow
      {
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_45)
         {
            ...
            this.var_69.toggleItemSelection(this._category,this.var_254.getGridItemIndex(param1.window));
            this.var_602 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_602 != null && this.var_602 == param2 && !this.var_69.isTradingOpen)
         {
