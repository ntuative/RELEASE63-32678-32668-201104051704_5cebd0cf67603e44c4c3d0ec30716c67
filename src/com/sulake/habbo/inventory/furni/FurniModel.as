package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_52:String = "I";
      
      public static const const_407:String = "pets";
      
      private static const const_1367:int = 100;
      ...
      private var var_654:Timer;
      
      private var var_2151:Boolean;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1925:Vector.<Array>;
      
      private var var_1926:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_345 = param8;
         this.var_654 = new Timer(const_1367,1);
         this.var_654.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2652 = XML(_loc10_.content);
         this.clearFurniList();
         this._view = new FurniView(this,param2,this._windowManager,this._assets,this._roomEngine,this.var_345);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_654.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_654.stop();
               this.var_654 = null;
            }
            if(this.var_208 != null)
            {
               this.var_208.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_208.stop();
               this.var_208 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_48)
            {
               ...
               {
                  this.var_1925 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1925;
            }
            else
            {
               if(this.var_1926 == null)
               {
                  this.var_1926 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1926;
            }
         ...
         if(this.getSelectedItemIndex(FurniModel.const_52) == -1)
         {
            this.toggleItemSelection(FurniModel.const_52,0);
         }
         this.initListImages();
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_994 == null)
         {
            this.var_994 = this._windowManager.buildFromXML(this.var_2652) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_994.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_48,const_52];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_208 = new Timer(param1,1);
            this.var_208.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_208.start();
         }
         else
         {
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_398);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_48,const_52];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_48,const_52];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_655.add(const_48,new Array());
         this.var_655.add(const_52,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         ...
         else
         {
            ...
            for(; _loc8_ < _loc6_.length; _loc8_++)
            {
               ...
               if(_loc7_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_196)
                  {
                     _loc5_ = _loc7_;
                  }
            ...
            if(_loc2_ != null)
            {
               ...
               while(_loc7_ < _loc2_.length)
               {
                  ...
                  if(_loc8_)
                  {
                     ...
                     {
                        this._view.method_2(_loc3_,_loc7_);
      ...
      public function updatePostItCount(param1:int, param2:int) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc3_:Array = this.getCategoryContent(const_52);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_297;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_311 || _loc3_.category == FurniCategory.const_333 || _loc3_.category == FurniCategory.const_336)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_655.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_655.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_706)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
