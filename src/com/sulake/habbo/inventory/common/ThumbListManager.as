package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1512:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_663 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_663.width;
         this.var_94 = this.var_663.height;
         this.var_1224 = param5;
         this.var_1003 = param6;
         this.var_234 = Math.floor(this.var_1224 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1224,this.var_1003);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_662 = this.resolveRowCountFromList();
         if(this.var_662 == 0)
         {
            this.var_26 = new BitmapData(this.var_1224,this.var_1003);
            return;
         }
         this.var_26 = new BitmapData(Math.max(this.var_234 * this._thumbWidth,this.var_1224),Math.max(this.var_662 * this.var_94,this.var_1003),true,16777215);
         this.var_26.fillRect(this.var_26.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_662)
         {
            _loc4_ = 0;
            while(_loc4_ < this.var_234)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     this.var_26.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * this._thumbWidth,_loc3_ * this.var_94),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_234 && this.var_26.height < _loc3_.y * this.var_94)
         {
            _loc2_ = new BitmapData(this.var_26.width,this.var_26.height + this.var_94);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_234 - 1),this.var_94);
         ...
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(0,this.var_94),null,null,true);
         _loc4_ = new Rectangle(0,this.var_94,this._thumbWidth * (this.var_234 - 1),this.var_26.height - this.var_94);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(this._thumbWidth,this.var_94),null,null,true);
         this.var_26 = _loc2_;
      }
      ...
      public function replaceItemImage(param1:int, param2:IThumbListDrawableItem) : void
      {
         ...
         var _loc4_:Point = new Point(_loc3_.x * this._thumbWidth,_loc3_.y * this.var_94);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1512.getDrawableList();
         }
      ...
      {
         var _loc2_:int = Math.floor(param1.y / this.var_94);
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(param1.y >= this.var_662)
         {
            return;
         }
         var _loc4_:int = this.var_234 - param1.x - 1;
         _loc2_ = new Rectangle((param1.x + 1) * this._thumbWidth,param1.y * this.var_94,_loc4_ * this._thumbWidth,this.var_94);
         _loc3_ = new Point(param1.x * this._thumbWidth,param1.y * this.var_94);
         ...
         if(param1.y < this.var_662 - 1)
         {
            _loc7_ = this.var_26.width - this._thumbWidth;
            _loc8_ = this.var_26.height - (param1.y + 1) * this.var_94;
            _loc9_ = new BitmapData(_loc7_,_loc8_);
            _loc2_ = new Rectangle(this._thumbWidth,(param1.y + 1) * this.var_94,_loc9_.width,_loc9_.height);
            ...
            this.var_26.fillRect(new Rectangle(0,this.var_26.height - this.var_94,this.var_26.width,this.var_94),4294967295);
            _loc3_ = new Point(this.var_26.width - this._thumbWidth,_loc2_.y - this.var_94);
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(this.var_26.width,this.var_26.height - this.var_94);
               _loc2_ = new Rectangle(0,0,this.var_26.width,this.var_26.height - this.var_94);
               _loc11_.copyPixels(this.var_26,_loc2_,new Point(0,0),null,null,true);
               this.var_26 = _loc11_;
               --this.var_662;
            }
         }
         if(this.var_26.height < this.var_1003)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_1003);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_663.width,this.var_663.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_663.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_663,this.var_663.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
