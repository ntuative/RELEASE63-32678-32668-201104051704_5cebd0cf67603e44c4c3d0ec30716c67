package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2875:String;
      
      protected var _category:int;
      
      protected var var_2103:String;
      
      protected var var_1534:Number;
      
      protected var var_868:int = 0;
      
      protected var var_697:BitmapData;
      
      protected var var_2202:int;
      
      protected var var_1587:Boolean;
      
      protected var var_2104:Boolean;
      
      protected var var_2876:BitmapData;
      
      private const const_2004:int = 8947848;
      
      private const const_2003:int = 13421772;
      
      private const const_1759:Number = 1;
      
      private const const_1758:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this._type = param1;
         this._window = param4;
         this.var_1419 = this._window.findChildByTag("BG_COLOR");
         this._roomEngine = param5;
         this.var_2876 = param6;
         this.var_2104 = param7;
         this._items = new Map();
         this.var_2875 = param2;
         this._category = param3;
         this.var_2103 = param8;
         this.var_1534 = param9;
         if(param10 != null)
         {
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2875 == FurniModel.const_48)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1534));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2103);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_706)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1758;
               _loc1_.blend = this.const_1758;
            }
            else
            {
               this._window.blend = this.const_1759;
               _loc1_.blend = this.const_1759;
            }
         }
         if(this.isSelected)
         {
            this.var_1419.color = this.const_2004;
         }
         else
         {
            this.var_1419.color = this.const_2003;
         }
         ...
         if(_loc5_)
         {
            if(this.var_2104 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2876;
               _loc5_.visible = true;
            }
            else
            {
