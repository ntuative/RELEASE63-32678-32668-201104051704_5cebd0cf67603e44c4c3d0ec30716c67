package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_45:
               this.var_1383.setSelectedGridItem(this);
               this.var_1384 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1384 = false;
                  this.var_1383.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this.var_1419.color = !!this._isSelected ? uint(this.const_2004) : uint(this.const_2003);
      }
