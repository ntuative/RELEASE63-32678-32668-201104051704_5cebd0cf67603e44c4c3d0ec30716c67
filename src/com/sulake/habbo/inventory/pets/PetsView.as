package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private var var_371:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_254 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_371);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_649.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_254.removeGridItem(_loc2_.window);
      ...
      private function selectFirst() : void
      {
         ...
         this.setSelectedGridItem(this.var_649.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_649.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_254.addGridItem(_loc2_.window);
            this.var_649.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_371.pet;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1.type == WindowEvent.const_60)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  this.var_69.switchCategory(FurniModel.const_52);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_371 != null)
         {
            this.var_371.setSelected(false);
         }
         this.var_371 = param1;
         if(this.var_371 != null)
         {
            this.var_371.setSelected(true);
         }
