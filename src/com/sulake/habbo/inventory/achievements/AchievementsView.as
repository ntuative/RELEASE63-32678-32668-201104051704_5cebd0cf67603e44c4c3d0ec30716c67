package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_426 = new Timer(1000,1);
         this.var_426.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_426)
            {
               this.var_426.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
               this.var_426.reset();
               this.var_426 = null;
            }
            this._disposed = true;
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_426.running);
         this.var_1117[param1.badgeId] = param1.badgeImage;
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_1117[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this.var_305.getBadgeImage(param2.badgeId);
            this.var_1117[param2.badgeId] = _loc4_;
         }
