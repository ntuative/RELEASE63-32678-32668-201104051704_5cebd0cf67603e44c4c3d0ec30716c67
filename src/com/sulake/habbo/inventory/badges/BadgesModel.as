package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2043:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_1005 = new Array();
         this._assets = param4;
         this._communication = param3;
         this.var_305 = param5;
         this.var_305.events.addEventListener(BadgeImageReadyEvent.const_152,this.onBadgeImageReady);
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_1005.length)
         {
            if(this.var_1005[_loc2_] == param1)
            {
               this.var_1005.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = this.var_305.getBadgeImage(param1);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = this.var_270[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < this.var_270.length)
               {
                  if((this.var_270[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(this.var_270[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      {
         if(param1 == InventoryCategory.const_304 && this._controller.isVisible)
         {
