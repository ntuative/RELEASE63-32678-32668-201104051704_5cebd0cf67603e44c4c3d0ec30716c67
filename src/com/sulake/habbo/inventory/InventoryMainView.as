package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2897:IWindowContainer;
      
      private var _controller:HabboInventory;
      
      private var var_159:IHabboToolbar;
      
      private var var_1100:Boolean = true;
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this.var_159 != null && this.var_1100)
         {
            this.var_159.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_59,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            this.var_1100 = false;
         }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            ...
            if(this.var_159 != null && this.var_1100)
            {
               this.var_159.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_59,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
               this.var_1100 = false;
            }
      ...
      public function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_159.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_136,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1678);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_724 == InventoryCategory.const_147)
            {
               this.toggleCategoryView(InventoryCategory.const_147);
            }
            else if(this.var_724 == InventoryCategory.const_81)
            {
