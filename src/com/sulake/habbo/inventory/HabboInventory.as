   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_445,this.roomSessionEventHandler);
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_51.getValue(InventorySubCategory.const_297));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_51.getValue(InventoryCategory.const_897));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_51.getValue(InventoryCategory.const_304));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_51.getValue(InventoryCategory.const_394));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_51.getValue(InventoryCategory.const_147));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_51.getValue(InventoryCategory.const_398) as MarketplaceModel;
      }
      ...
      {
         this.var_305 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_445,this.roomSessionEventHandler);
         this.initInventory();
      }
      
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_345 = IHabboSoundManager(param2);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_89:
               this.var_1133 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_445:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_305 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_159 || !this.var_345)
         {
            return;
         }
         this._view = new InventoryMainView(this,this._windowManager,this._assetLibrary);
         this._view.setToolbar(this.var_159);
         this.var_51 = new Map();
         ...
         this.var_51.add(InventoryCategory.const_398,_loc1_);
         var _loc2_:FurniModel = new FurniModel(this,_loc1_,this._windowManager,this._communication,this._assetLibrary,this._roomEngine,this._catalog,this.var_345);
         this.var_51.add(InventoryCategory.const_81,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_305);
         this.var_51.add(InventoryCategory.const_304,_loc3_);
         ...
         this.var_51.add(InventoryCategory.const_897,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_305);
         this.var_51.add(InventoryCategory.const_394,_loc5_);
         var _loc6_:TradingModel = new TradingModel(this,this._windowManager,this._communication,this._assetLibrary,this._roomEngine,this._localization,this.var_345);
         this.var_51.add(InventorySubCategory.const_297,_loc6_);
         ...
         this.var_51.add(InventoryCategory.const_147,_loc8_);
         this.var_196 = true;
         if(this.var_2349)
         {
            this.requestData();
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_920.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_920.indexOf(param1);
            if(_loc3_ >= 0)
            {
      ...
      {
         if(this.var_920.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_660));
      }
