package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_897);
         _loc2_.refreshViews();
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_304);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_394);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         this._inventory.toggleInventorySubPage(InventorySubCategory.const_297);
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_196)
            {
            ...
            else
            {
               ...
               if(_loc6_ == null)
               {
                  _loc6_ = _loc11_.createNewGroupItemTemplate(_loc7_,FurniModel.const_52,_loc9_.category,_loc9_.stuffData);
                  _loc3_.add(_loc8_,_loc6_);
               }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_398);
      ...
      {
         var _loc2_:* = null;
         if(this._inventory.isInventoryCategoryInit(InventoryCategory.const_398))
         {
