package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_959:uint = 4284532064;
      
      private static const const_960:uint = 2577770;
      ...
      private var var_614:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_614 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1764 = this.createMinimizedWindow();
         }
         if(!this.var_2404)
         {
            return this.var_70;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_70)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_17.ownUserAccepts ? uint(const_959) : uint(const_960);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_17.otherUserAccepts ? uint(const_959) : uint(const_960);
            }
      ...
      {
         this.method_5(param1,param2,true);
      }
      
      private function othersThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         this.method_5(param1,param2,false);
      }
      
      private function method_5(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc6_:* = null;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1699)
            {
            ...
            this.var_614.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_458);
            this.var_614.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_614.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         var _loc7_:ISongInfo = this.var_345.musicController.getSongInfo(_loc6_.extra);
         if(_loc7_ != null)
         {
         ...
         else if(param3)
         {
            ...
            this.var_186.push(param4);
            this.var_186.push(param1);
            this.var_186.push(param5);
            this.var_345.musicController.requestSongInfoWithoutSamples(_loc6_.extra);
         }
         return param2;
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_186.length > 0)
         {
            _loc2_ = this.var_186.pop();
            _loc3_ = this.var_186.pop();
            _loc4_ = uint(this.var_186.pop());
            _loc5_ = _loc3_.peek();
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_17.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_17.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_614.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_458);
               }
            }
            else
            {
               this.var_186.push(_loc4_);
               this.var_186.push(_loc3_);
               this.var_186.push(_loc2_);
            }
         }
      }
   }
