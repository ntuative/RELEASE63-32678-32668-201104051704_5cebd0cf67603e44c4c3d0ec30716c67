package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_509:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_162.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_145,HabboWindowStyle.const_44,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1743,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1743,"/");
         ...
         {
            dispatchEvent(new Event(const_509));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_132.removeEventListener(SSOTicket.const_387,this.onParsedTicketSuccess);
            this.var_132.removeEventListener(SSOTicket.const_299,this.onParsedTicketFailure);
            this.var_132 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_132.addEventListener(SSOTicket.const_387,this.onParsedTicketSuccess);
         this.var_132.addEventListener(SSOTicket.const_299,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_162.flashClientUrl = this.var_132.flashClientUrl;
