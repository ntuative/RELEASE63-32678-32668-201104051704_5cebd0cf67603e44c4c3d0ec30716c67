package com.sulake.habbo.communication.messages.parser.room.engine
{
   ...
   public class UsersMessageParser implements IMessageParser
   {
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            if(_loc13_ == 1)
            {
               ...
               _loc14_.userType = RoomObjectTypeEnum.const_184;
            ...
            {
               _loc14_.userType = RoomObjectTypeEnum.const_183;
               _loc14_.figure = _loc7_;
               _loc14_.webID = _loc4_;
            ...
            {
               _loc14_.userType = RoomObjectTypeEnum.const_914;
               ...
               _loc14_.sex = UserMessageData.const_1029;
            }
            _loc3_++;
         }
         return true;
      ...
      private function resolveSex(param1:String) : String
      {
         ...
         {
            return UserMessageData.const_1448;
         }
         return UserMessageData.const_1029;
      }
