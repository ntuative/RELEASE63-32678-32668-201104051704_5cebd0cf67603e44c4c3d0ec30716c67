package com.sulake.habbo.communication.messages.parser.room.engine
{
   ...
   public class FurnitureAliasesMessageParser implements IMessageParser
   {
      ...
      public function getName(param1:int) : String
      {
         ...
         return this.var_597.getKey(param1);
      }
      ...
      public function getAlias(param1:int) : String
      {
         ...
         return this.var_597.getWithIndex(param1);
      }
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            this.var_597.remove(_loc4_);
            this.var_597.add(_loc4_,_loc5_);
            _loc3_++;
         }
         return true;
      }
