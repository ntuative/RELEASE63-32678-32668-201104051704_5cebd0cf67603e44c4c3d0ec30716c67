package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl implements IDisposable
   {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!this.var_1689 ? 0 : 1,this._roomId),this.var_34,WindowTracker.const_841,this._roomId),this._frame,false,false,true);
      }
