package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1015:OffenceCategoryData;
      
      private var var_1014:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1235 = IButtonWindow(this.var_34.getXmlWindow("modact_offence"));
         this.var_1236 = IButtonWindow(this.var_34.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1687;
         ...
         this.var_1234 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1234);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_1015 != null;
         if(this.var_1014 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_1014.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_1015 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1015.offences,this.var_1235,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_34.initMsg.offenceCategories,this.var_1236,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1591;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.connection.send(new ModAlertMessageComposer(this.var_1522,this.var_542.text,this.var_1521));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1015 = this.var_34.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1014 = this.var_1015.offences[_loc3_];
         this.var_542.text = this.var_1014.msg;
         this.var_656 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.connection.send(new ModKickMessageComposer(this.var_1522,this.var_542.text,this.var_1521));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1234.selection < 0)
         {
            this.var_34.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_34.connection.send(new ModBanMessageComposer(this.var_1522,this.var_542.text,this.getBanLength(),this.var_1521));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1234.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1235.destroy();
            this.var_1235 = null;
         }
         if(this.var_1236 != null)
         {
            this.var_1236.destroy();
            this.var_1236 = null;
         }
         this.var_1234 = null;
         this.var_542 = null;
