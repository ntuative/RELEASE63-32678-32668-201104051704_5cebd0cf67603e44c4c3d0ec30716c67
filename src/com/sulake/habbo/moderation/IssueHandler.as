package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_509:UserInfoCtrl;
      
      private var var_1149:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         if(this.var_66.windowManager == null || this.var_66.assets == null)
         {
            return;
         }
         var _loc1_:XmlAsset = this.var_66.assets.getAssetByName("issue_handler_xml") as XmlAsset;
         if(_loc1_ == null || _loc1_.content == null)
         {
            return;
         }
         this._window = this.var_66.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(this._window == null)
         {
            return;
         }
         ...
         this.var_66.disableButton(this.var_66.initMsg.chatlogsPermission,this._window,"show_chatlog");
         ...
         this.var_509 = new UserInfoCtrl(this._window,this.var_66,_loc3_.message);
         this.var_1149 = new UserInfoCtrl(this._window,this.var_66,_loc3_.message);
         this.var_509.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1149.load(_loc4_,this.var_156.reportedUserId);
         }
         else
         {
      ...
      private function updateIssueList() : void
      {
         ...
         if(_loc5_ < _loc6_)
         {
            _loc9_ = this.var_66.assets.getAssetByName("issue_handler_issue_info_xml") as XmlAsset;
            if(_loc9_ == null || _loc9_.content == null)
            {
               return;
            }
            _loc4_ = this.var_66.windowManager.buildFromXML(_loc9_.content as XML) as IWindowContainer;
            if(_loc4_ == null)
            {
               return;
            }
      ...
      private function updateMessages() : void
      {
         ...
         if(_loc5_ < _loc6_)
         {
            _loc8_ = this.var_66.assets.getAssetByName("issue_handler_message_list_item_xml") as XmlAsset;
            if(_loc8_ == null || _loc8_.content == null)
            {
               return;
            }
            _loc4_ = this.var_66.windowManager.buildFromXML(_loc8_.content as XML) as ITextWindow;
            if(_loc4_ == null)
            {
               return;
            }
      ...
      {
         if(this.var_66 != null && this.var_66.issueManager != null && this.var_156 != null)
         {
            this.var_66.issueManager.removeHandler(this.var_156.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_66.issueManager.closeBundle(this.var_156.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_66.issueManager.closeBundle(this.var_156.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_66.issueManager.closeBundle(this.var_156.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_66.issueManager.releaseBundle(this.var_156.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_66.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_66,WindowTracker.const_1230,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_509 = new UserInfoCtrl(this._window,this.var_66,_loc3_.message);
            this.var_509.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      {
         if(this._window == null || this.var_66 == null || this.var_66.issueManager == null)
         {
            return;
         }
         ...
         {
            this.var_66.issueManager.autoPick();
         }
      }
   }
}
