package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1933:int = 1000;
      
      private static var var_999:Array = [];
      
      private static var var_1932:int = 200;
      ...
      private var var_1596:IMessageComposer;
      ...
      {
         this.var_806 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_805 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         ...
         this.var_34.connection.send(this.var_1596);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         ...
         return IWindowContainer(this.var_805.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_998.length < var_1933)
         {
            ...
            param1.width = this.var_805.width;
            param1.height = this.var_805.height;
            var_998.push(param1);
         }
         else
         {
