package com.sulake.habbo.moderation
{
   ...
   public class ModerationMessageHandler
   {
      ...
      {
         if(param1 == null || this.var_66 == null)
         {
            return;
         }
         ...
         this.var_66.issueManager.playSound(_loc3_);
         this.var_66.issueManager.updateIssue(_loc3_);
      }
      ...
      private function onModeratorInit(param1:ModeratorInitMessageEvent) : void
      {
         ...
         {
            this.var_66.issueManager.updateIssue(_loc6_);
         }
         this.var_66.issueManager.updatePriorities();
         this.var_66.initMsg = _loc3_;
         this.var_66.startPanel.show();
      }
      ...
      private function onIssuePickFailed(param1:IssuePickFailedMessageEvent) : void
      {
         ...
         var pickedAlready:Boolean = this.var_66.issueManager.issuePickFailed(issues);
         if(pickedAlready)
         {
            if(retryEnabled)
            {
               ...
               {
                  alert = false;
                  this.var_66.issueManager.autoPick(retryEnabled,retryCount);
               }
            }
         }
         if(alert)
         {
            this.var_66.windowManager.alert("Error","Issue picking failed",0,function(param1:IAlertDialog, param2:WindowEvent):void
            {
               param1.dispose();
            });
         }
      ...
      private function onIssueDeleted(param1:IssueDeletedMessageEvent) : void
      {
         ...
         this.var_66.issueManager.removeIssue(_loc2_.issueId);
      }
      ...
      private function onUserInfo(param1:ModeratorUserInfoEvent) : void
      {
         ...
         for each(_loc3_ in this.var_1078)
         {
      ...
      private function onRoomInfo(param1:ModeratorRoomInfoEvent) : void
      {
         ...
         for each(_loc3_ in this.var_1077)
         {
      ...
      private function onCfhChatlog(param1:CfhChatlogEvent) : void
      {
         ...
         this.onChatlog("Call For Help Chatlog: " + _loc2_.data.chatRecordId,WindowTracker.const_1230,_loc2_.data.callId,_loc3_,_loc4_);
      }
      ...
      private function onRoomChatlog(param1:RoomChatlogEvent) : void
      {
         ...
         var _loc4_:Dictionary = new Dictionary();
         this.onChatlog("Room Chatlog: " + _loc2_.data.roomName,WindowTracker.const_841,_loc2_.data.roomId,_loc3_,_loc4_);
      }
      ...
      private function onUserChatlog(param1:UserChatlogEvent) : void
      {
         ...
         this.onChatlog("User Chatlog: " + _loc2_.data.userName,WindowTracker.const_1090,_loc2_.data.userId,_loc2_.data.rooms,_loc3_);
      }
      
      private function onChatlog(param1:String, param2:int, param3:int, param4:Array, param5:Dictionary) : void
      {
         var _loc6_:* = null;
         for each(_loc6_ in this.var_1076)
         {
      ...
      private function onRoomVisits(param1:RoomVisitsEvent) : void
      {
         ...
         for each(_loc3_ in this.var_1075)
         {
      ...
      private function onRoomEnter(param1:RoomEntryInfoMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            this.var_66.currentFlatId = _loc2_.guestRoomId;
            this.var_66.startPanel.guestRoomEntered(_loc2_);
         }
         else
         {
            this.var_66.currentFlatId = 0;
         }
      ...
      private function onPublicSpaceCastLibs(param1:PublicSpaceCastLibsEvent) : void
      {
         ...
         this.var_66.startPanel.publicSpaceEntered(_loc2_);
      }
      ...
      private function onRoomExit(param1:CloseConnectionMessageEvent) : void
      {
         var _loc2_:* = null;
         this.var_66.currentFlatId = 0;
         this.var_66.startPanel.roomExited();
      ...
      private function onModeratorActionResult(param1:ModeratorActionResultMessageEvent) : void
      {
         ...
         if(_loc2_.success)
         {
            this.var_66.connection.send(new GetModeratorUserInfoMessageComposer(_loc2_.userId));
         }
         else
         {
            this.var_66.windowManager.alert("Alert","Moderation action failed",0,this.onAlertClose);
         }
      }
      ...
      public function removeChatlogListener(param1:ChatlogCtrl) : void
      {
         var _loc3_:* = null;
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_1076)
         {
            if(_loc3_ != param1)
            {
               _loc2_.push(_loc3_);
