package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1090:int = 5;
      
      public static const const_1630:int = 6;
      
      public static const const_1591:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1612:int = 9;
      ...
      {
         var _loc2_:Dictionary = this.var_1911[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1911[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
