package com.sulake.habbo.moderation
{
   ...
   public class SendMsgsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Msg To: " + this.var_1687;
      ...
      {
         return WindowTracker.const_1676;
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.initMsg.messageTemplates[this.var_1104.selection];
         if(_loc3_ != null)
         {
            this.var_656 = false;
      ...
      private function onSendMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.connection.send(new ModMessageMessageComposer(this.var_1522,this.var_542.text,this.var_1521));
         this.dispose();
      }
