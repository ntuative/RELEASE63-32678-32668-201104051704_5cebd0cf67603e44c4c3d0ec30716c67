package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1013:int = 60;
      
      private static const const_1014:int = 3600;
      
      private static const const_1012:int = 86400;
      
      private static const const_1015:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         if(param1 < 2 * const_1014)
         {
            return Math.round(param1 / const_1013) + " mins ago";
         }
         if(param1 < 2 * const_1012)
         {
            return Math.round(param1 / const_1014) + " hours ago";
         }
         if(param1 < 2 * const_1015)
         {
            return Math.round(param1 / const_1012) + " days ago";
         }
         return Math.round(param1 / const_1015) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1281.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_34.getXmlWindow("user_info"));
            this.var_1281.addChild(_loc1_);
         ...
         _loc1_.findChildByName("message_but").procedure = this.method_8;
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_34,WindowTracker.const_1090,this._data.userId),this._callerFrame,this.var_1280,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new RoomVisitsCtrl(this.var_34,this._data.userId),this._callerFrame,this.var_1280,false,true);
      }
      ...
      private function method_8(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new SendMsgsCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1521),this._callerFrame,this.var_1280,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ModActionCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1521),this._callerFrame,this.var_1280,false,true);
      }
