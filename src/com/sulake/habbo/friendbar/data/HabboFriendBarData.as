package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_623:String = "FriendBar";
      
      private static const const_622:String = "user_interaction";
      
      private static const TRACKING_EVENT_ACTION_VISIT:String = "visit_btn_click";
      
      private static const const_1360:String = "chat_btn_click";
      ...
      private var var_976:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_976)
            {
               this.var_976.release(new IIDHabboMessenger());
               this.var_976 = null;
            }
            this.var_137 = null;
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_207)
         {
            ...
            this.var_207.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_623,const_622,TRACKING_EVENT_ACTION_VISIT));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_976)
         {
            this.var_976.startConversation(param1);
            if(this.var_207)
            {
               this.var_207.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_623,const_622,const_1360));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_207)
         {
            ...
            this.var_207.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_623,const_622,const_1361));
         }
      }
      ...
      {
         this.var_976 = param2 as IHabboMessenger;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_137 = !!const_284 ? this.sortByNameAndOnlineStatus(this.var_137) : this.sortByName(this.var_137);
         }
         events.dispatchEvent(new FriendBarUpdateEvent(FriendBarUpdateEvent.const_564));
      }
