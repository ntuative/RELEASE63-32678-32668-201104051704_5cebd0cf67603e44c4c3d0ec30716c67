   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_59)
         {
            ...
            this.var_34.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_591));
         }
      }
      
      public function setToolbarIconHighlight(param1:Boolean) : void
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_93,HabboToolbarIconEnum.MEMENU);
         if(param1)
         {
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         this.var_784 = this.var_34.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = this.var_784.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         this.var_34.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_59,HabboToolbarIconEnum.MEMENU_ARROW,this.var_784));
      }
      ...
      private function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param2.name)
         {
            case "button_cancel":
               ...
               {
                  this.var_34.showView(TutorialUI.const_88);
               }
         }
      }
   }
