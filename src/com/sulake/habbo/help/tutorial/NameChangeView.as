package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1415:uint = 13232628;
      ...
      private var var_1137:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_288;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_502 = param1;
         if(this.var_1738 == this.var_502)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1737 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_743)
         {
            this.var_743 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_743)
            {
               return;
            }
            this._window.content.addChild(this.var_743);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_742)
         {
            this.var_742 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_742)
            {
               return;
            }
            this._window.content.addChild(this.var_742);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_742.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_502;
         }
         this.showView(this.var_742);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_502);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_861:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_858:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_860:
               break;
            ...
            case ChangeUserNameResultMessageEvent.var_1056:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1058:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1058 || param1 == ChangeUserNameResultMessageEvent.var_1056)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1137 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1137.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1415;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_502 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "select_name_button":
               ...
               if(this.var_502 != _loc5_)
               {
                  this.var_1738 = _loc5_;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_502);
               break;
