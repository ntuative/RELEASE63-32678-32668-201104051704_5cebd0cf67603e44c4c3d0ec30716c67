package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_288:String = "TUI_NAME_VIEW";
      
      public static const const_403:String = "TUI_CLOTHES_VIEW";
      
      public static const const_561:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_499,this.onTaskDoneEvent);
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_477,this.onTaskDoneEvent);
         if(this.var_34.sessionDataManager != null)
         {
            this.var_34.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_338,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1119 && this.var_1120 && this.var_1396;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_34)
         {
            ...
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_499,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_477,this.onTaskDoneEvent);
            if(this.var_34.sessionDataManager != null)
            {
               this.var_34.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_338,this.onFigureUpdate);
            }
            this.var_34 = null;
         }
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_43 == null || this.var_43.id == const_88)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_526:
               this.var_1396 = true;
               if(this.var_43 != null && this.var_43.id == const_561)
               {
                  this.showView(const_88);
               }
               break;
            case HabboHelpTutorialEvent.const_499:
               if(this.var_43 != null && this.var_43.id == const_403)
               {
                  this.var_1712 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2298 = this._window.width - _loc2_.width;
         ...
         this._window.height = _loc2_.height + this.var_2299;
         this._window.width = _loc2_.width + this.var_2298;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_43 != null && (this.var_43.id == const_288 || this.var_43.id == const_88))
         {
            this.showView(const_88);
         }
      }
      ...
      {
         this.var_1119 = true;
         if(this.var_43 != null && (this.var_43.id == const_403 || this.var_43.id == const_88))
         {
            this.showView(const_88);
         }
      }
