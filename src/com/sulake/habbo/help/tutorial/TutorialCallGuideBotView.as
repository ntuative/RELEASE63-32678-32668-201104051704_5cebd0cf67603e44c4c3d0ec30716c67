package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialCallGuideBotView implements ITutorialUIView
   {
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_93,HabboToolbarIconEnum.HELP);
         if(param1)
         {
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         this.var_34.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_59,HabboToolbarIconEnum.HELP_ARROW,this.var_784));
      }
