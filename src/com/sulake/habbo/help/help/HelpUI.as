package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_358 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201104051659));
         this.var_159 = param5;
         this.var_114 = new Map();
         this.var_114.add(HabboHelpViewEnum.const_1638,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_195,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_540,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_294,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_244,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_406,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_657,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_268,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_114.add(HabboHelpViewEnum.const_1021,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_114.add(HabboHelpViewEnum.const_1134,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_902,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_513.length == 0 || param1 != this.var_358)
            {
               this.var_513.push(this.var_358);
            }
         }
         this.var_358 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_358);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_268:
               this.showUI(HabboHelpViewEnum.const_268);
               break;
            case CallForHelpResultEnum.const_1030:
               this.showUI(HabboHelpViewEnum.const_1134);
               break;
            case CallForHelpResultEnum.const_1143:
               this.showUI(HabboHelpViewEnum.const_1021);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_114.getValue(HabboHelpViewEnum.const_195) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_526));
      }
      ...
      {
         return this.var_114.getValue(this.var_358);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2298 = this._window.width - _loc3_.width;
         this.var_2299 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2299;
         this._window.width = _loc1_.width + this.var_2298;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_513.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_358 == HabboHelpViewEnum.const_195)
         {
            return;
         }
         if(this.var_618.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_618.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_618.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_359.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_618[1],this.var_618[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_618[0],this.var_618[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_358 == HabboHelpViewEnum.const_195 || this.var_513.length == 0)
         {
            return;
         }
         if(this.var_359 == null)
         {
            ...
            this.var_359 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_359.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_359.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_359 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_359 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_359 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
