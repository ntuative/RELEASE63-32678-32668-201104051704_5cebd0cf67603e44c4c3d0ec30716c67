package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      {
         return this._notifications[this.var_1414];
      }
      ...
      public function dispose() : void
      {
         if(this.var_129)
         {
            ...
            this.var_129.toolbar.events.removeEventListener(HabboToolbarEvent.const_36,this.onToolbarClicked);
            this.var_129.toolbar.events.removeEventListener(HabboToolbarEvent.const_716,this.onToolbarResized);
            this.var_129 = null;
         }
         ...
         {
            this.var_741.stop();
            this.var_741.removeEventListener(TimerEvent.TIMER,this.onReminderTimer);
            this.var_741 = null;
         }
      ...
      public function showWelcomeScreen(param1:Boolean) : void
      {
         ...
         this.var_129.toolbar.events.addEventListener(HabboToolbarEvent.const_36,this.onToolbarClicked);
         this.var_129.toolbar.events.addEventListener(HabboToolbarEvent.const_716,this.onToolbarResized);
         var _loc4_:int = parseInt(this._config.getKey("welcome.screen.delay","5000"));
         this.var_741 = new Timer(_loc4_);
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         this.var_236.y = this.var_129.toolbar.getIconLocation(this.current.targetIconId) - this._window.height / 2;
         this._window.y = this.var_236.y;
      ...
      private function initializeWindow() : void
      {
         ...
         _loc4_.content.setParamFlag(WindowParam.const_287,false);
         _loc4_.height -= 20;
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_93,this.current.targetIconId);
      ...
      private function closeWindow() : void
      {
         ...
         if(this.var_1414 < this._notifications.length - 1)
         {
            ++this.var_1414;
         }
         else
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Number = Point.distance(this._window.rectangle.topLeft,this.var_236);
         if(_loc2_ > 5)
         {
            _loc3_ = Point.interpolate(this._window.rectangle.topLeft,this.var_236,0.5);
            this._window.x = _loc3_.x;
            this._window.y = _loc3_.y;
         }
         else
         {
            this._window.x = this.var_236.x;
            this._window.y = this.var_236.y;
            this.var_129.removeUpdateReceiver(this);
         }
      }
