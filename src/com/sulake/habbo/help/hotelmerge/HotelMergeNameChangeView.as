package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_743)
         {
            this.var_743 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_743)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_742)
         {
            this.var_742 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_742)
            {
               return;
            }
