package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1378:int = 0;
      
      private static const const_441:int = 1;
      ...
      override public function render() : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if(_loc7_ != 0)
            {
               this.var_818.push(_loc7_);
            }
         }
         _loc6_ = 0;
         while(_loc6_ < this.var_818.length)
         {
            _loc8_ = this.var_818[_loc6_];
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(this.var_818 == null || _loc3_ < 0 || _loc3_ >= this.var_818.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = this.var_818[_loc3_];
