package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_263:MessengerView;
      ...
      {
         var _loc2_:Conversation = this.var_625.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            this.var_625.setSelected(_loc2_);
            this.var_263.openMessenger();
      ...
      {
         this.var_625.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_625.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      public function playSendSound() : void
      {
         ...
         {
            this.var_345.playSound(HabboSoundTypesEnum.const_1102);
         }
      }
      ...
      {
         this.var_625 = new Conversations(new ConversationsDeps(this));
         this.var_263 = new MessengerView(this);
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            this.var_159.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_155,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         this.var_159.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_136,HabboToolbarIconEnum.MESSENGER));
         var _loc3_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_93,HabboToolbarIconEnum.MESSENGER);
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_263.isMessengerOpen())
            {
               this.var_263.close();
            }
            else
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_845,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1200,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_625.addMessageAndUpdateView(param1);
         if(!this.var_263.isMessengerOpen())
         {
            if(this.var_345 != null)
            {
               this.var_345.playSound(HabboSoundTypesEnum.const_1231);
            }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1193,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         this.var_625.addMessageAndUpdateView(_loc3_);
      }
