package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1373:int = 10;
      
      private static const const_995:int = 100;
      
      private static const const_1374:int = 20;
       
      
      private var var_142:HabboMessenger;
      
      private var var_2666:IScrollbarWindow;
      
      private var var_1938:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_142 = param1;
         this.var_1938 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_62 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2666 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_995 + const_1374)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1373;
         param1.invalidate();
      }
      ...
      public function refreshHeader() : void
      {
         ...
         {
            this.var_1938.enable();
         }
         else
         {
            this.var_1938.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_62.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_534.messages.length - const_995);
         _loc1_ = 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_647 || param3.type == Message.const_845 ? param3.time + ": " : "";
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_142.send(new FollowFriendMessageComposer(this.var_534.id));
      }
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_845)
         {
            return 4292801535;
         }
         if(param1 == Message.const_1193)
         {
            return 4294927974;
         }
         ...
         if(param1 == Message.const_850)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1200)
         {
            return 4288269465;
         }
         return 4291611852;
