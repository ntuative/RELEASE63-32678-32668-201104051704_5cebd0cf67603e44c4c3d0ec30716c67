package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_2756:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_60.type)
         {
            ...
            case QuestTypeEnum.WEAR_BADGE:
               ...
               this.var_2756 = this.find("quest.content.itemlist") as IScrollableListWindow;
               if(!this._view)
               {
      ...
      private function localize() : void
      {
         ...
         if(_loc33_)
         {
            this.var_673 = new Timer(20,1);
            this.var_673.addEventListener(TimerEvent.TIMER,this.onShowReward);
            this.var_673.start();
      ...
      private function setText(param1:String, param2:String, param3:Boolean = true, param4:Boolean = false) : void
      {
         ...
         if(_loc5_)
         {
            ...
            if(param4 && _loc5_ is IHTMLTextWindow)
            {
               ...
               (_loc5_ as IHTMLTextWindow).linkTarget = LinkTarget.const_773;
            }
         }
      }
