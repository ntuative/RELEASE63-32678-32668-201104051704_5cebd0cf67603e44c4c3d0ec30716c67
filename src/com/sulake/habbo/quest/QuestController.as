package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      {
         var _loc3_:QuestCampaign = this.var_103[param1];
         if(!_loc3_)
         {
         ...
         if(this.var_134 != null && this.var_134.quest.id == param2.id)
         {
      ...
      public function questCompleted(param1:String, param2:QuestMessageData) : void
      {
         ...
         if(this.var_134 != null && this.var_134.quest.id == param2.id && this.var_96 != null)
         {
      ...
      public function openCampaign(param1:String, param2:int, param3:Array, param4:Boolean) : void
      {
         ...
         if(this.var_577 != MODE_TABS)
         {
            this.var_577 = MODE_NO_TABS;
         }
         this.detachCampaign();
         _loc5_ = this.var_103[param1];
         if(!_loc5_)
      ...
      private function attachCampaign() : void
      {
         ...
         this._selectedCampaign.attachTo(this.var_1173);
      ...
      public function openCampaigns(param1:Array, param2:Boolean = false) : void
      {
         ...
         this.var_577 = MODE_TABS;
         for each(_loc3_ in param1)
         {
            _loc4_ = this.var_103[_loc3_];
            if(!_loc4_)
            {
               _loc4_ = new QuestCampaign(this,_loc3_);
               this.var_103[_loc3_] = _loc4_;
            }
      ...
      private function resolveDefaultCampaignCode() : String
      {
         ...
         if(this.var_103.getKeys().length > 0)
         {
            return this.var_103.getKeys()[0];
         }
         return "";
      }
      ...
      private function prepareWindow(param1:Boolean) : void
      {
         ...
         this._window.center();
         this.var_1173 = this._window.findChildByName("content") as IWindowContainer;
      }
      ...
      public function initializeReminderTimer() : void
      {
         ...
         this.var_741 = new Timer(_loc1_ * 1000);
         this.var_741.addEventListener(TimerEvent.TIMER,this.onReminderTimer);
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         var _loc3_:QuestCampaign = this.var_103[_loc2_];
      ...
      private function showQuestReminder(param1:QuestCampaign, param2:Quest) : void
      {
         ...
         if(this.var_96 != null)
         {
            _loc3_ = this.var_96.rectangle;
            this.var_96.dispose();
            this.var_96 = null;
         }
         this.var_96 = IWindowContainer(this.var_56.getXmlWindow("QuestReminder"));
         this.var_96.findChildByTag("close").procedure = this.onReminderWindowClose;
         if(_loc3_ != null)
         {
            this.var_96.x = _loc3_.x;
            this.var_96.y = _loc3_.y;
         }
         else
         {
            this.var_96.center();
         }
         var _loc4_:IWindowContainer = IWindowContainer(this.var_96.findChildByName("quest.container"));
         ...
         this.var_134 = new QuestView(param1,param2,true);
         _loc4_.addChild(this.var_134.view);
         this.var_134.init();
         this.var_96.height = param2.type == "FIND_STUFF" ? 453 : 390;
      ...
      {
         if(this.var_134 != null && this.var_96 != null && this.var_134.quest != null && this.var_134.quest.status != QuestStatusEnum.const_46)
         {
            this.var_96.visible = false;
         }
      }
      ...
      {
         return param1 == QuestStatusEnum.const_46 || param1 == QuestStatusEnum.const_373;
      }
      ...
      private function onReminderWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            this.var_96.visible = false;
            this.var_1455 = true;
            _loc3_ = this.var_134.quest.campaign.code + "." + this.var_134.quest.localizationCode;
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_103.getKeys())
         {
            _loc3_ = this.var_103[_loc4_];
            _loc2_ = _loc1_.getTabItemByName("tab_" + _loc4_);
            if(!_loc2_)
            {
               _loc6_ = "quest_" + _loc4_ + ".tab";
               _loc2_ = this.var_56.windowManager.createWindow("tab_" + _loc4_,"${" + _loc6_ + "}",WindowType.const_500) as ITabButtonWindow;
               if(_loc3_.expired)
               {
