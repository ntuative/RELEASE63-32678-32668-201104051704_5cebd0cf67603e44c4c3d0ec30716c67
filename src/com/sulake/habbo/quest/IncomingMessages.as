package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_1802:IAlertDialog;
      ...
      private function setQuestingEnabled(param1:Boolean) : void
      {
         ...
         if(this.var_56.toolbar != null)
         {
            if(param1)
            {
               ...
               _loc4_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_93,HabboToolbarIconEnum.QUESTS);
               _loc4_.iconState = "0";
            ...
            {
               this.var_56.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_155,HabboToolbarIconEnum.QUESTS));
            }
         }
      }
