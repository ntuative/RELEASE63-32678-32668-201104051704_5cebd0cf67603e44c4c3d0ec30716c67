package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      private var var_184:IFrameWindow;
      
      private var var_825:Boolean = false;
      
      private const const_1887:String = "achievement_bg_001";
      ...
      {
         this.var_184 = IFrameWindow(this.var_64.controller.questEngine.getXmlWindow("QuestCompletedDialog"));
         this.var_184.findChildByTag("close").procedure = this.onCompletedDialogClose;
         var _loc2_:IWindow = this.var_184.findChildByName("close_button");
         ...
         this.var_184.findChildByName("description_txt").caption = this.var_64.controller.questEngine.localization.getKey(_loc5_);
         ...
         this.var_184.findChildByName("reward_txt").caption = this.var_64.controller.questEngine.localization.getKey(_loc6_);
         var _loc7_:IWindow = this.var_184.findChildByName("reward_info_txt");
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_184.findChildByName("quest.reward.icon"));
         ...
         var _loc10_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_184.findChildByName("background_image"));
      ...
      private function onRewardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(!this.var_825 && this.var_184 && _loc2_)
         {
            _loc3_ = IBitmapWrapperWindow(this.var_184.findChildByName("quest.reward.icon"));
      ...
      private function onBackgroundImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(!this.var_825 && this.var_184 && _loc2_)
         {
            _loc3_ = IBitmapWrapperWindow(this.var_184.findChildByName("background_image"));
            this.var_64.controller.questEngine.setImageFromAsset(_loc3_,_loc2_.assetName,this.onRewardImageReady);
         }
      }
