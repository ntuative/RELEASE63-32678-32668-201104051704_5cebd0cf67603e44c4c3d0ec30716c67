package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_1461:uint = 7645971;
      
      private var var_1836:uint = 6710886;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1823 = param1.roomItemTypeName;
         this.var_1822 = param1.rewardCurrencyAmount;
         this.var_1835 = new Date();
         this.var_1835.setTime(param1.endDateTimeStamp);
         this.var_771 = param1.localizationCode;
         this.var_2506 = param1.questBadgeAchievementTypeId;
         this.updateView();
      }
      ...
      private function createView() : void
      {
         switch(this.var_407)
         {
            case QuestStatusEnum.const_46:
               ...
               break;
            case QuestStatusEnum.const_373:
            ...
            case QuestStatusEnum.const_176:
               ...
               break;
            case QuestStatusEnum.const_770:
         ...
         this.var_52.color = this.var_1461;
      }
      ...
      private function updateView() : void
      {
         ...
         var _loc3_:String = ["quest",this.var_64.code,this.var_771].join("_");
      ...
      private function itemGridEventProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this._selected)
            {
               this.var_52.color = this.var_1836;
            }
         }
