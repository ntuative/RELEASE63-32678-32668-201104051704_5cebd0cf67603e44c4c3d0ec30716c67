package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_334:int = 3;
      
      private static var var_1375:int = 2;
      ...
      private var var_1667:TriggerConfs;
      
      private var var_1668:ActionTypes;
      
      private var var_1669:ConditionTypes;
      
      private var var_249:Dictionary;
      
      private var var_35:Triggerable;
      
      private var var_722:RoomObjectHightLighter;
      ...
      {
         this.var_1667 = new TriggerConfs();
         this.var_1668 = new ActionTypes();
         this.var_1669 = new ConditionTypes();
         this.var_249 = new Dictionary();
         super();
         this.var_80 = param1;
         this.var_722 = new RoomObjectHightLighter(param1);
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1096 = new SliderWindowController(this.var_80,IWindowContainer(this.find(this.var_50,"delay_slider_container")),this.var_80.assets,0,20,1);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_722.hideAll(this.var_249);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_722.showAll(this.var_249);
         if(this.var_35 as ActionDefinition != null)
         {
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_35.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_334)
            {
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = this.var_35.stuffTypeSelectionCode < 1 ? int(var_1375) : int(this.var_35.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = (this.var_35.stuffTypeSelectionCode + 1) % (var_1375 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_334)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1667);
         this.refreshConfigureElement(this.var_1668);
         this.refreshConfigureElement(this.var_1669);
