package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      private var var_1219:SliderWindowController;
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1219.getValue());
      ...
      {
         this.var_80 = param2;
         this.var_1219 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1219.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1219.setValue(1);
         this.var_1218 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1218.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1218.setValue(50);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_1219.setValue(_loc3_);
         this.var_1218.setValue(_loc4_);
      }
