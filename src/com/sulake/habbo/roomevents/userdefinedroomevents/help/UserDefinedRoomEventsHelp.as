package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1786:IWindowContainer;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1786 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1160 = this.var_1786.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1160)
         {
            this.var_1160.procedure = this.onButtonClick;
         }
         this.var_1159 = this.var_1786.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1159)
         {
            this.var_1159.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_262 >= this.var_67.length - 1)
         {
            this.var_1159.disable();
         }
         else
         {
            this.var_1159.enable();
         }
         if(this.var_262 <= 0)
         {
            this.var_1160.disable();
         }
         else
         {
            this.var_1160.enable();
         }
      }
      ...
      {
         ++this.var_262;
         this.var_262 = Math.min(this.var_262,this.var_67.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_262;
         this.var_262 = Math.max(this.var_262,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_67[this.var_262][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_67[this.var_262][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_67[this.var_262][1]).value;
