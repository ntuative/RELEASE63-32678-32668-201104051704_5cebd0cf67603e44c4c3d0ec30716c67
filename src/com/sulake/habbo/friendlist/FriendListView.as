package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1740:String = "noconvinfo";
      
      private static const const_1739:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1442:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1442 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_1023 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_272 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1442.prepare(this.var_1023);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1082,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1171,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_771,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_818,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_771,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_818,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1441 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1441.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1790 == -1 ? 0 : int(this.var_16.height - this.var_1790);
         var _loc4_:int = this.var_1792 == -1 ? 0 : int(this.var_16.width - this.var_1792);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1084,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_771,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1082,false);
         ...
         this.var_1790 = this.var_16.height;
         this.var_1792 = this.var_16.width;
