package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      public function fillFooter(param1:IWindowContainer) : void
      {
         ...
         this.var_852.addEventListener(WindowKeyboardEvent.const_190,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_62.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_375,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_614.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_614.showPopup(this._friendList.view.mainWindow,IWindowContainer(param2));
         }
