package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_1887:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2536:IContainerButtonWindow;
      
      private var var_2534:IContainerButtonWindow;
      
      private var var_2535:IContainerButtonWindow;
      
      private var var_2537:IContainerButtonWindow;
      
      private var var_62:IItemListWindow;
      
      private var var_614:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_614 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2536 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2534 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2535 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2537 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_96,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2536,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2534,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2535,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2537,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_614.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_614.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_614.closePopup();
         }
