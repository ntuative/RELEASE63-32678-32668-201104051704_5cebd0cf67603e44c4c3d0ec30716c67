package com.sulake.habbo.friendlist
{
   ...
   public class FriendListTabsView
   {
      ...
      public function refresh(param1:String) : void
      {
         ...
         this.var_192.width = this._friendList.tabs.tabContentWidth;
         this.var_192.findChildByName("bg").width = this._friendList.tabs.tabContentWidth;
         var _loc2_:int = 1;
         for each(_loc3_ in this._friendList.tabs.getTabs())
         {
            _loc4_ = this.var_192.getChildByName("flt_" + _loc3_.id) as IWindowContainer;
         ...
         this.var_192.height = _loc2_ + 1;
         this.var_192.findChildByName("bg").height = this.var_192.height;
      ...
      private function refreshHeader(param1:FriendListTab, param2:IWindowContainer) : int
      {
         ...
         this.showBgImage(_loc3_,param1.method_3,"hdr_hilite");
         this.showBgImage(_loc3_,!param1.method_3,param1.headerPicName);
         var _loc4_:Boolean = param1.id == FriendListTab.const_96 && !param1.method_3;
      ...
      private function refreshTabText(param1:FriendListTab, param2:IWindowContainer) : void
      {
         ...
         _loc3_.textColor = this._friendList.laf.getTabTextColor(param1.method_3,param1.id);
      }
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this._friendList.trackFriendListEvent(HabboFriendListTrackingEvent.const_410);
         }
      }
