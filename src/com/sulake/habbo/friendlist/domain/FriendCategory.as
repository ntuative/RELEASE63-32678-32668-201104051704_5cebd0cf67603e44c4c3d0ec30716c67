package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         var _loc4_:* = null;
         if(this.var_233.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         while(_loc3_ < this.var_233.length)
         {
            ...
            {
               this.var_233.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean = false) : int
      {
         var _loc4_:* = null;
         var _loc3_:int = 0;
         for each(_loc4_ in this.var_233)
         {
      ...
      public function removeFriend(param1:int) : Friend
      {
         ...
         if(_loc2_ != null)
         {
            Util.remove(this.var_233,_loc2_);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         if(this.var_1000 >= this.getPageCount())
         {
            this.var_1000 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_233.length / const_401);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_1000 * const_401;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_1000 + 1) * const_401,this.var_233.length);
      }
