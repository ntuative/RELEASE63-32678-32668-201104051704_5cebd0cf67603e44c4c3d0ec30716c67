package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_846:ISessionDataManager;
      
      private var var_2822:FriendListLookAndFeel;
      
      private var var_431:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_2035:OpenedToWebPopup;
      
      private var var_2157:int;
      
      var var_101:FriendCategories;
      
      private var var_396:FriendRequests;
      
      private var var_2036:AvatarSearchResults;
      ...
      {
         this.var_2822 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_101 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_2036 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_690.stop();
            this.var_690.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_690 = null;
         }
         ...
         if(this.var_846)
         {
            this.var_846.release(new IIDSessionDataManager());
            this.var_846 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_2035 = new OpenedToWebPopup(this);
         }
         this.var_2035.show(x,y);
      }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_93,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(this.var_396.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_159.events.dispatchEvent(_loc1_);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_310,HabboWindowStyle.const_44,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1113.createAvatarImage(param1,AvatarScaleType.const_92,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_159 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         this.var_846 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_396 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_101.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_101.addCategory(new FriendCategory(FriendCategory.const_1126,this.getText("friendlist.friends")));
         this.var_101.addCategory(new FriendCategory(FriendCategory.const_427,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_101.addFriend(new Friend(_loc4_));
         }
         this.var_431 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_690)
         {
            this.var_690 = new Timer(120000);
            this.var_690.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_690.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_159.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_136,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_101.findCategory(FriendCategory.const_427);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_431.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_410));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_396.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_396.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_431.findTab(FriendListTab.const_100).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_396.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_431.findTab(FriendListTab.const_100);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_2036.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_431.findTab(FriendListTab.const_100);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_846 || !this.var_396)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_846.method_1("fuse_super_extended_buddylist",HabboClubLevelEnum.const_47))
         {
            _loc2_ = this.var_396.vipLimit;
         }
         else if(this.var_846.method_1("fuse_extended_buddylist",HabboClubLevelEnum.const_43))
         {
            _loc2_ = this.var_396.clubLimit;
         }
         if(_loc2_ > this.var_396.limit)
         {
            this.var_396.limit = _loc2_;
         }
      }
