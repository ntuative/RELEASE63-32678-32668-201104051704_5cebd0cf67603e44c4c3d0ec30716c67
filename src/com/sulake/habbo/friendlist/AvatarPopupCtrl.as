package com.sulake.habbo.friendlist
{
   ...
   public class AvatarPopupCtrl extends PopupCtrl
   {
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_1747 != "")
         {
            friendList.refreshText(param1,"name_text_online",this.var_849,this.var_1747);
         }
         else
         {
            friendList.refreshText(param1,"name_text_online",this.var_849,this.var_2044);
         }
         friendList.refreshText(param1,"name_text_offline",!this.var_849,this.var_2044);
         friendList.refreshText(param1,"motto_text",this.var_849,this.var_2386);
         friendList.refreshButton(param1,"offline",!this.var_849,null,0);
         if(this.var_849)
         {
            this.refreshFigure(param1,this.var_2383);
