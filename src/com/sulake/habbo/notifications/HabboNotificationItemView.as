package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_848:int = 70;
      
      public static const const_528:int = 4;
      
      private static const name_3:int = 0;
      
      private static const const_548:int = 1;
      
      private static const const_979:int = 2;
      
      private static const const_980:int = 3;
      ...
      private var var_1188:uint;
      
      private var var_1187:uint;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_1868 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_1868 = 15;
         }
         this.var_1867 = this._window.height;
         this.var_785 = 4;
         this.var_786 = 0;
         this._state = name_3;
         this.var_159 = param5;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_548:
               ...
               _loc2_ = Number(this.var_1188) / Number(this.var_446["time_fade_in"]);
               if(this.var_1188 > int(this.var_446["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_979:
               ...
               if(this.var_1472 > int(this.var_446["time_display"]) && !this.var_1866)
               {
                  this.startFadeOut();
               }
               break;
            case const_980:
               ...
               _loc3_ = 1 - Number(this.var_1187) / Number(this.var_446["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1187 > int(this.var_446["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1868;
         if(this._window.height < this.var_1867)
         {
            this._window.height = this.var_1867;
         }
      }
      ...
      {
         this.var_1187 = 0;
         this._state = const_980;
      }
      
      private function startDisplay() : void
      {
         this.var_1472 = 0;
         this._state = const_979;
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this.var_159.orientation == "TOP" ? int(const_435) : 0;
         var _loc4_:int = this.var_159.orientation == "BOTTOM" ? int(_loc2_.height - const_435) : int(_loc2_.height);
         var _loc5_:int = this.var_159.orientation == "LEFT" ? int(const_435) : 0;
         var _loc6_:int = this.var_159.orientation == "RIGHT" ? int(_loc2_.width - const_435) : int(_loc2_.width);
         if(this.var_446["position_horizontal_follow_toolbar"] == "true" && (this.var_159.orientation != "TOP" && this.var_159.orientation != "BOTTOM"))
         {
            if(this.var_159.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_528;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_528;
            }
         }
         ...
         if(this.var_446["position_vertical_follow_toolbar"] == "true" && (this.var_159.orientation != "RIGHT" && this.var_159.orientation != "LEFT"))
         {
            if(this.var_159.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_785;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_785;
            }
         }
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_786;
      }
   }
}
