package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1730:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1532:IAvatarImage;
      ...
      private var var_452:AvatarImageBodyPartContainer;
      ...
      private var var_2255:ByteArray;
      
      private var var_2253:ImageData;
      
      private var var_1017:PaletteMap;
      ...
      {
         if(this.var_730 == param1)
         {
            return;
         }
         if(this.var_730 == GeometryType.const_1019 && param1 == GeometryType.const_1106 || this.var_730 == GeometryType.const_1106 && param1 == GeometryType.const_1019)
         {
            this.var_730 = param1;
            this.var_88 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_348.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_738)
                     {
                        if(_loc14_.action != null)
                        {
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1532.getFigure(),_loc5_,this.var_730,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_452 = _loc10_.getImageContainer(_loc4_);
         if(this.var_452 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_452 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_348);
            if(this.var_452 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_452,_loc4_);
         }
         this.var_452.offset = _loc8_;
         return this.var_452;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_88)
         {
            this.var_88 = this._structure.getCanvas(this._scale,this.var_730);
            if(!this.var_88)
            {
               return null;
            }
            this.var_2254 = new Point(0,this.var_88.height - int(this.var_88.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1497[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_916 || _loc10_ == AvatarAction.const_396;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1381 = this.var_111.bodyPartId;
               this.var_181 = this.var_111.partType;
               this.var_1686 = this.var_111.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_111.flippedPartType != this.var_181)
                     {
                        this.var_181 = this.var_111.flippedPartType;
                     }
                  }
               }
               this.var_1382 = this._scale + "_" + this.var_111.action.assetPartDefinition + "_" + this.var_181 + "_" + this.var_1686 + "_" + _loc5_ + "_" + this._frame;
               this.var_422 = this._assets.getAssetByName(this.var_1382) as BitmapDataAsset;
               if(this.var_422 == null)
               {
                  this.var_1382 = this._scale + "_std_" + this.var_181 + "_" + this.var_1686 + "_" + _loc5_ + "_0";
                  this.var_422 = this._assets.getAssetByName(this.var_1382) as BitmapDataAsset;
               }
               if(!(!this.var_422 || !this.var_422.content))
               {
                  if(this.var_111.method_6 > -1)
                  {
                     this.var_1017 = this._structure.renderManager.paletteManager.getPalette(this.var_111.method_6);
                     if(this.var_1017 != null)
                     {
                        this.var_902 = this.var_422.content as BitmapData;
                        this.var_180 = new BitmapData(this.var_902.width,this.var_902.height);
                        this.var_2255 = this.var_1017.colorize(this.var_902.getPixels(this.var_902.rect));
                        this.var_180.setPixels(this.var_180.rect,this.var_2255);
                     }
                     else
                     {
                        this.var_180 = (this.var_422.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1381 == AvatarBodyPartType.const_256 || this.var_1381 == AvatarBodyPartType.const_1649 || this.var_1381 == AvatarBodyPartType.const_1494) && this.var_111.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_180.colorTransform(this.var_180.rect,this.var_111.color.colorTransform);
                  }
                  if(this.var_111.isBlendable)
                  {
                     this.var_180.colorTransform(this.var_180.rect,this.var_111.method_9);
                  }
                  this.var_901 = this.var_422.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_56)
                     {
                  ...
                  this.var_2253 = new ImageData(this.var_180,this.var_901,_loc7_);
                  this.var_903.push(this.var_2253);
               }
            }
            _loc8_--;
         }
         ...
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2254.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_56)
            {
