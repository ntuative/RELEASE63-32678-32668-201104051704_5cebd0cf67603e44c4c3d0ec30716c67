package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1401:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1400:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1267:AvatarEditorHandler;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_196)
         {
            ...
            _loc2_.loadAvatarData(const_1401,FigureData.const_82);
            _loc3_.loadAvatarData(const_1400,FigureData.FEMALE);
            this.var_101 = new Map();
            this.var_552 = new Map();
            this.var_101.add(AvatarEditorFigureCategory.const_734,new BodyModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_256,new TorsoModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_793,new LegsModel(this));
            ...
            this.var_552.add(AvatarEditorSideCategory.const_108,new WardrobeModel(this));
            this.var_552.add(AvatarEditorSideCategory.const_563,new ClubPromoModel(this));
            this.var_196 = true;
         }
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_279 == null)
            {
               this.var_279 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_68,HabboWindowStyle.const_29,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_279.addChild(this._view.window);
               if(param5)
               {
                  this.var_279.center();
               }
            ...
            this.var_279.visible = !this.var_279.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_734);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_552.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_551 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_1027 = this.var_551.getFigureData(AvatarType.const_114);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1267 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_678[this.var_899];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1546 != null)
         {
            ...
            this.var_1546.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_2003;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1266 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1399)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1579.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_551.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_551.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1302.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1602)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1266 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1302.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1266 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_552.getValue(AvatarEditorSideCategory.const_108);
      }
