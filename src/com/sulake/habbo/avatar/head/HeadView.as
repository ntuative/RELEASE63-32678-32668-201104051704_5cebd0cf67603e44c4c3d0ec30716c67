   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_69,FigureData.const_212,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_69,FigureData.const_276,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_69,FigureData.const_278,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_69,FigureData.const_231,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_69,FigureData.const_228,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_69 && var_146 == "")
         {
            var_69.switchCategory(FigureData.const_212);
         }
      }
