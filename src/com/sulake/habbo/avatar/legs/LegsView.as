   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_69,FigureData.const_272,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_69,FigureData.const_269,_windowManager,_assetLibrary);
         }
         else
         {
