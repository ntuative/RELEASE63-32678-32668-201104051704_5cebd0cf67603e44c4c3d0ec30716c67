   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_69,FigureData.const_259,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_69,FigureData.const_186,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_69,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_69,FigureData.const_266,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_69 && var_146 == "")
         {
            var_69.switchCategory(FigureData.const_186);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "tab_jacket":
                  ...
                  break;
               case "tab_shirt":
                  this.switchCategory(FigureData.const_186);
                  break;
