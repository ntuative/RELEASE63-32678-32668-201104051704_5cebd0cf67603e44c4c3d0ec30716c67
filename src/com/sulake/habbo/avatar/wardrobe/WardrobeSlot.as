package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_596 && this.var_1378)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_92,this.var_899,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_37,parseInt(FigureData.const_644));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_596 = this._controller.figureData.getFigureString();
               this.var_899 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_1676,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_596)
               {
                  this._controller.loadAvatarInEditor(this.var_596,this.var_899,this._controller.clubMemberLevel);
               }
         }
      }
