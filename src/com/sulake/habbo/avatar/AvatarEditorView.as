package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1302:IWindowContainer;
      
      public static var var_1579:IWindowContainer;
      
      public static var var_2069:int = 6710886;
      ...
      private var var_496:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_495:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1106 = [];
         this.var_1351 = [AvatarEditorFigureCategory.const_734,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_256,AvatarEditorFigureCategory.const_793,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_108];
         super();
         ...
         if(var_1302 == null)
         {
            ...
            var_1302 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1579 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1579 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_423 = new Timer(1000);
         this.var_423.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1351;
         }
         for each(_loc6_ in param4)
         {
            this.var_1106.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_423.stop();
            this.var_423.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_423 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1351);
         }
         if(param1.length != this.var_1106.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1106.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2261 = this.canChangeOutfit();
            this.var_423.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_496 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_496.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_496.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1106.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_496.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_496.numSelectables)
               {
                  this.var_496.getSelectableAt(_loc6_).x = this.var_496.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_496.setSelected(this.var_496.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1351;
      ...
      public function update() : void
      {
         ...
         {
            _loc3_.visible = this._controller.sessionData.method_1("fuse_use_wardrobe",HabboClubLevelEnum.const_43) && this._controller.isWardrobeAllowed();
         }
         var _loc4_:String = "null";
         if(this._controller.sessionData && this._controller.sessionData.method_1("fuse_use_wardrobe",HabboClubLevelEnum.const_43) && (this.var_1690 == AvatarEditorSideCategory.const_108 || this.var_2262))
         {
         ...
         this.setViewToCategory(this.var_358);
      }
      ...
      {
         if(this.var_1690 == AvatarEditorSideCategory.const_108)
         {
            this.var_2262 = false;
            this.setSideContent(AvatarEditorSideCategory.const_729);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarEditorSideCategory.const_563:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_563);
               break;
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2243 = new Date().valueOf();
                  this.var_2261 = false;
                  this.var_423.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_495)
         {
            ...
            this.var_495 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_495.procedure = this.stripClubDialogEventProc;
            this.var_495.center();
         }
         else
         {
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2243 > 5000;
      }
   }
}
