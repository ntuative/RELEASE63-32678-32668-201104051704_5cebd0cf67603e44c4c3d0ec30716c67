package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_452:IBitmapWrapperWindow;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         {
            this.var_452 = this._window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      
      public function udpate(param1:BitmapData) : void
      {
         if(this.var_452 && this.var_1097)
         {
            this.var_452.bitmap = new BitmapData(this.var_452.width,this.var_452.height,true,16777215);
            this.var_452.bitmap.copyPixels(this.var_1097,this.var_1097.rect,new Point(0,this.var_452.height - this.var_1097.height - 8));
            this.var_452.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
