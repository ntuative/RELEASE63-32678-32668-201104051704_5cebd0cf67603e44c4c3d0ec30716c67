package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_619:String = "tab_boy";
      
      private const const_618:String = "tab_girl";
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_69.controller.gender)
         {
            case FigureData.const_82:
               activateTab(this.const_619);
               inactivateTab(this.const_618);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_618);
               inactivateTab(this.const_619);
         }
      }
