package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      protected var var_250:AvatarImageCache;
      
      protected var var_596:AvatarFigureContainer;
      
      protected var var_568:IAvatarDataContainer;
      
      protected var var_336:Array;
      ...
      protected var var_1309:Boolean = false;
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_825)
         {
            ...
            if(this.var_749)
            {
               for each(_loc2_ in this.var_749)
               {
                  _loc2_.dispose();
               }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_260.length == 1 && this.var_89 == this.var_1826)
         {
            return this.var_89 + this.var_508 + this.var_610 % 4;
         }
         if(this.var_260.length == 2)
         {
            for each(_loc1_ in this.var_260)
            {
               ...
               {
                  return this.var_89 + this.var_508 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_610 % 11;
                  return this.var_89 + "_" + this.var_1826 + this.var_508 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2390 || param2 != this.var_2391 || param1 != this.var_2389)
         {
            this.var_2390 = param3;
            this.var_2391 = param2;
            this.var_2389 = param1;
            this.var_1757 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1309 || this.var_46 == null || (this.var_46.width != _loc5_.width || this.var_46.height != _loc5_.height))
         {
            if(this.var_46 != null && !this.var_1309)
            {
               this.var_46.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_610);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_610);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_336.push(new ActiveActionData(param1,param2,this.var_610));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.resetBodyPartCache(this.var_898);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_508 = "";
         this.var_260 = this._structure.sortActions(this.var_336);
         if(this.var_260 == null)
         {
         ...
         {
            this.var_826 = this._structure.getCanvasOffsets(this.var_260,this._scale,this.var_89);
            for each(_loc4_ in this.var_260)
            {
               this.var_508 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_295)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1422 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1422 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_260)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_897 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_343 || _loc1_.actionType == AvatarAction.const_224 || _loc1_.actionType == AvatarAction.const_396)
               {
                  this.var_897 = true;
               }
            }
