package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1279:Matrix4x4;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc15_:* = null;
         var _loc16_:* = null;
         this.var_1044 = new Vector3D(0,0,10);
         super();
         this.var_1279 = new Matrix4x4();
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_1044.x = _loc11_;
            this.var_1044.y = _loc12_;
            this.var_1044.z = _loc13_;
         }
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            this.var_2030[String(_loc6_.@id)] = _loc8_;
         }
      }
      ...
      public function getBodyPartOfItem(param1:String, param2:String) : GeometryBodyPart
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Dictionary = this.var_2030[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:String) : Array
      {
         ...
         this.var_1279 = Matrix4x4.getYRotationMatrix(param2);
         for each(_loc7_ in _loc5_)
         {
            _loc7_.applyTransform(this.var_1279);
            _loc9_ = _loc7_.getDistance(this.var_1044);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(this.hasBodyPart(param1,param2))
         {
            ...
            this.var_1279 = Matrix4x4.getYRotationMatrix(param3);
            return _loc5_.getParts(this.var_1279,this.var_1044,param4);
         }
         return [];
      }
