package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2758 = parseInt(param1.@precedence);
         this.var_2763 = String(param1.@activepartset);
         this.var_2759 = String(param1.@assetpartdefinition);
         this.var_2762 = String(param1.@lay);
         this.var_730 = String(param1.@geometrytype);
         this.var_2352 = Boolean(parseInt(param1.@main));
         this.var_2761 = Boolean(parseInt(param1.@var_830));
         this.var_2760 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2764 = _loc6_;
            }
            else
            {
               this.var_1937[_loc5_] = _loc6_;
            }
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(this.var_826.getValue(param1) == null)
         {
            this.var_826.add(param1,new Map());
         }
         var _loc4_:Map = this.var_826.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_826.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1937[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2764;
         }
         return _loc2_;
      }
