package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_376:FigureData;
      
      private var var_454:PartSetsData;
      ...
      private var var_1500:PartOffsetData;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:String, param3:PartOffsetData)
      {
         super();
         this.var_443 = param1;
         this.var_376 = new FigureData();
         this.var_454 = new PartSetsData();
      ...
      {
         this.var_1500.loadOffsets(param1);
      }
      ...
      public function initGeometry(param1:XML) : void
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Geometry for structure: " + this.var_533);
            return;
         }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         if(!param2)
         {
            Logger.log("[AvatarStructure] Could not init Actions for structure: " + this.var_533);
            return;
         }
         this.var_993 = new AvatarActionManager(param1,this.var_533,param2);
         this.var_898 = this.var_993.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Part Sets for structure: " + this.var_533);
            return false;
         }
         if(this.var_454.parse(param1))
         {
            if(this.var_533 == AvatarType.const_114)
            {
               this.var_454.getPartDefinition("ri").appendToFigure = true;
               this.var_454.getPartDefinition("li").appendToFigure = true;
            }
            return true;
         }
         return false;
      ...
      public function initAnimation(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Animations for structure: " + this.var_533);
            return false;
         }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Figure Data for structure: " + this.var_533);
            return false;
         }
         return this.var_376.parse(param1);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         this.var_376.injectXML(param1);
      }
      ...
      public function getPartColor(param1:IAvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = this.var_376.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = this.var_376.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         {
            this.var_653[param1] = new Dictionary();
         }
         if(this.var_653[param1][param2])
         {
            return this.var_653[param1][param2];
         }
         this.var_653[param1][param2] = this.var_376.getMandatorySetTypeIds(param1,param2);
         return this.var_653[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return this.var_376.getDefaultPartSet(param1,param2);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = this.var_454.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = this.var_454.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1428[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:Array = this.var_454.getActiveParts(param3.definition);
         ...
         for each(_loc16_ in _loc20_)
         {
            ...
            _loc29_ = this.var_376.getSetType(_loc16_);
            if(_loc29_)
            {
               _loc30_ = this.var_376.getPalette(_loc29_.paletteID);
               if(_loc30_)
               {
                  ...
                  if(_loc31_)
                  {
                     ...
                     for each(_loc32_ in _loc31_.parts)
                     {
                        if(_loc15_.indexOf(_loc32_.type) > -1)
                        {
                           ...
                           {
                              _loc33_ = this.var_898;
                           }
                           _loc12_ = this.var_454.getPartDefinition(_loc32_.type);
         ...
         for each(_loc11_ in _loc15_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc8_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc12_ = this.var_454.getPartDefinition(_loc11_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         return this.var_1500.getOffset(param1,param2,param3,param4,param5,param6);
      }
