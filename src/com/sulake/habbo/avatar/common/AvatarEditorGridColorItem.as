package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_974:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_990.width,this.var_990.height,true,0);
            _loc5_ = this.var_990.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_974.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_975.width,this.var_975.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_975,this.var_975.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(this.var_974)
            {
               switch(this.var_974.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_47:
                     _loc4_.style = HabboIconType.const_709;
                     _loc4_.visible = true;
               }
            }
            else
