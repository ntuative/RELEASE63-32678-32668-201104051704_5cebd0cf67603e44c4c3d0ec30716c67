package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         this.var_237 = new Array(param1.length);
         var _loc3_:int = 0;
      ...
      public function method_4(param1:int) : AvatarEditorGridPartItem
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(!this._parts)
         ...
         if(this.var_1018 >= 0 && this._parts.length > this.var_1018)
         {
            _loc2_ = this._parts[this.var_1018];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         this.deselectColorIndex(this.var_237[param2],param2);
         this.var_237[param2] = param1;
      ...
      public function getSelectedColorIds() : Array
      {
         var _loc7_:* = null;
         var _loc8_:* = null;
         if(!this.var_237 || this.var_237.length == 0)
         {
            return null;
         }
         ...
         var _loc5_:int = 0;
         while(_loc5_ < this.var_237.length)
         {
            _loc7_ = this.var_275[_loc5_];
            if(!(!_loc7_ || _loc7_.length <= _loc5_))
            {
               if(_loc7_.length > this.var_237[_loc5_])
               {
                  _loc8_ = _loc7_[this.var_237[_loc5_]] as AvatarEditorGridColorItem;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= this.var_237[param1])
         {
            return null;
         }
         return _loc2_[this.var_237[param1]] as AvatarEditorGridColorItem;
      }
      ...
      {
         return this._parts[this.var_1018] as AvatarEditorGridPartItem;
      }
