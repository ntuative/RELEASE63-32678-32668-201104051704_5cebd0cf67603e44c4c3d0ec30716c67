package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_773:IFigurePartSet;
      ...
      private const const_2004:int = 13421772;
      
      private const const_2003:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            this.var_697 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc7_ = param3.parts;
            ...
            {
               this.var_1840 = Math.max(this.var_1840,_loc6_.colorLayerIndex);
            }
         }
         this.var_443 = this.var_69.controller.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_697 != null && !this.var_1841)
            {
               _loc3_ = this.var_697;
            }
            else
            ...
            if(this.var_773)
            {
               switch(this.var_773.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_47:
                     _loc2_.style = HabboIconType.const_709;
               }
            }
            else
            {
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_353[_loc6_] + "_" + FigureData.const_145;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_635 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1842)
               {
                  ...
                  this.var_1842 = _loc9_.content as BitmapData;
               }
         ...
         _loc1_ = new BitmapData(this.var_635.width,this.var_635.height,true,16777215);
         var _loc6_:int = 0;
         var _loc7_:Boolean = false;
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               _loc10_ = -1 * _loc4_.offset.x - this.var_635.x;
               _loc11_ = -1 * _loc4_.offset.y - this.var_635.y;
               if(this.var_1841 && _loc2_.colorLayerIndex > 0)
               {
