package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
      ...
      private var var_669:IItemGridWindow;
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(this._view != null)
         {
            this.var_669 = this._view.findChildByName("part_thumbs") as IItemGridWindow;
      ...
      public function initFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:CategoryData = this.var_69.getCategoryData(this.var_1527);
         if(!_loc1_)
         {
            return;
         }
         this.var_669.removeGridItems();
         for each(_loc2_ in _loc1_.parts)
         {
            if(_loc2_)
            {
               this.var_669.addGridItem(_loc2_.view);
      ...
      {
         var _loc3_:IWindow = this.var_669.getGridItemAt(param1);
         if(!_loc3_)
         {
            return;
         }
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this.var_669.getGridItemIndex(param1.window);
            this.var_69.selectPart(this.var_1527,_loc3_);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.const_45)
         {
            ...
            while(_loc7_ < this.const_1399)
            {
               if(this.var_545.length > _loc7_)
               {
                  ...
                  if(_loc5_ > -1)
                  {
                     this.var_69.selectColor(this.var_1527,_loc5_,_loc7_);
                     return;
                  }
               }
               _loc7_++;
