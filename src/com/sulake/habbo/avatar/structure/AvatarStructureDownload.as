package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      private var var_2388:IStructureData;
      
      private var var_1755:XML;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            this.var_1755 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         this.var_2388.appendXML(this.var_1755);
