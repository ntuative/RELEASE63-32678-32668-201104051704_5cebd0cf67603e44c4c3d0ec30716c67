package com.sulake.habbo.avatar.structure.figure
{
   ...
   public class SetType implements ISetType
   {
      ...
      public function SetType(param1:XML)
      {
         ...
         this.var_2809 = parseInt(param1.@paletteid);
         this.var_685 = new Dictionary();
         this.var_685["F"] = new Dictionary();
         this.var_685["M"] = new Dictionary();
         this.var_685["F"][0] = Boolean(parseInt(param1.@mand_f_0));
         this.var_685["F"][1] = Boolean(parseInt(param1.@mand_f_1));
         this.var_685["M"][0] = Boolean(parseInt(param1.@mand_m_0));
         this.var_685["M"][1] = Boolean(parseInt(param1.@mand_m_1));
      ...
      {
         return this.var_685[param1.toUpperCase()][Math.min(param2,1)];
      }
