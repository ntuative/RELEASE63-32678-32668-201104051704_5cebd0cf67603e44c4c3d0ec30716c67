package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private var var_451:AssetLoaderStruct;
      
      private var var_983:Timer;
      ...
      private const const_2013:int = 100;
      
      private const const_1595:int = 2;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         if(_loc6_ == null)
         {
            this.var_451 = this._assets.loadAssetFromFile("figuremap",_loc5_,"text/xml");
         ...
         this.var_983 = new Timer(this.const_2013,1);
         this.var_983.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_451)
         {
            this.var_451.addEventListener(AssetLoaderEvent.const_30,this.onConfigurationComplete);
            this.var_451.addEventListener(AssetLoaderEvent.const_49,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_451)
         {
            this.var_451.removeEventListener(AssetLoaderEvent.const_30,this.onConfigurationComplete);
            this.var_451.removeEventListener(AssetLoaderEvent.const_49,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         {
            Logger.log("Could not download figuremap.xml. Retries left: " + this.var_982);
            if(this.var_1486.indexOf("?") > 0)
            {
               _loc2_ = this.var_1486 + "&retry=" + this.var_982;
            }
            else
            {
               _loc2_ = this.var_1486 + "?retry=" + this.var_982;
            ...
            this.var_451 = this._assets.loadAssetFromFile("figuremap",_loc3_,"text/xml");
            this.addMapLoaderEventListeners();
         }
      }
      ...
      private function loadFigureMapData(param1:XML) : void
      {
         ...
         this.var_1890 = true;
         for each(_loc2_ in this.var_1199)
         {
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2603,this._assets);
            _loc3_.addEventListener(Event.COMPLETE,this.libraryComplete);
            for each(_loc4_ in _loc2_.part)
            {
               _loc5_ = _loc4_.@type + ":" + _loc4_.@id;
               _loc6_ = this.var_1200[_loc5_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(_loc3_);
               this.var_1200[_loc5_] = _loc6_;
            }
         }
      }
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1890)
         {
            this.var_1199.push([param1,param2]);
            return;
         }
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         var _loc10_:* = null;
         var _loc2_:* = [];
         for(_loc3_ in this.var_984)
         {
            _loc7_ = true;
            _loc4_ = this.var_984[_loc3_];
         ...
         {
            delete this.var_984[_loc3_];
         }
         while(_loc6_ < this.var_791.length)
         {
            _loc5_ = this.var_791[_loc6_];
            if(_loc5_.libraryName == (param1.target as AvatarAssetDownloadLibrary).libraryName)
            {
               this.var_791.splice(_loc6_,1);
            }
            _loc6_++;
         }
         this.var_983.start();
      ...
      {
         var _loc1_:* = null;
         while(this.var_790.length > 0 && this.var_791.length < this.const_1595)
         {
            _loc1_ = this.var_790[0];
            _loc1_.startDownloading();
            this.var_791.push(this.var_790.shift());
         }
      }
      
      private function addToQueue(param1:AvatarAssetDownloadLibrary) : void
      {
         if(!param1.isReady && this.var_790.indexOf(param1) == -1 && this.var_791.indexOf(param1) == -1)
         {
