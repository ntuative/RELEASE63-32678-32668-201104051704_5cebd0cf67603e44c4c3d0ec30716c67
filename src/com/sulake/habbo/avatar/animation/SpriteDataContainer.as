package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      private var var_2729:IAnimation;
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_1695 = parseInt(param2.@ink);
         this.var_2730 = String(param2.@member);
         this.var_2728 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1531 = [];
         this.var_1530 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1531[_loc4_] = parseInt(_loc3_.@dy);
            this.var_1530[_loc4_] = parseInt(_loc3_.@dz);
         }
      }
      ...
      {
         if(param1 < this.var_1531.length)
         {
