package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1662:Number = 1.0;
      
      private var var_1663:Number = 1.0;
      
      private var var_1664:Number = 1.0;
      ...
      {
         super();
         this.var_1695 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2265 = parseInt(_loc2_,16);
         this.var_2264 = parseInt(_loc3_,16);
         ...
         this.var_731 = new ColorTransform(this.var_1662,this.var_1663,this.var_1664,this._alphaMultiplier);
         this.var_1107 = this.generatePaletteMapForGrayscale(this.var_2264,this.var_2265);
      }
      ...
      {
         return this.var_1107.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1107.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1107.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1107.getValue("alphas") as Array;
      }
