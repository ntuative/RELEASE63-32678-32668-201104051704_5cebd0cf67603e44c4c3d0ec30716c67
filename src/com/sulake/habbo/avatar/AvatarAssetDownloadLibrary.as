package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_1721:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this.var_1401 = param3 + this.var_911 + ".swf";
         this.var_1401 = this.var_1401.replace("%revision%",this._revision);
      ...
      {
         this._state = var_1721;
         var _loc1_:URLRequest = new URLRequest(this.var_1401);
