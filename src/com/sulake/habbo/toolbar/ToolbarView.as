package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1135:Number = 1;
      
      private var var_1412:Number = 0;
      
      private var var_1735:Number = 15;
      
      private var var_1734:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IConnection, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_223 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_68,HabboWindowStyle.const_1157,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1134 = String(_loc8_.relocate_by_drag.@state) == "true";
         if(this.var_1134)
         {
         ...
         this.var_1135 = _loc8_.toolbar.@margin_top;
         this.var_1412 = _loc8_.toolbar.@margin_bottom;
         this.var_1735 = _loc8_.toolbar.@min_group_margin;
         this.var_1734 = _loc8_.toolbar.@margin_to_extrabar;
         this.var_333 = new ToolbarBarMenuAnimator(param1,this);
         var _loc9_:XMLList = XMLList(_loc8_.toolbar).children();
         var _loc10_:XMLList = XMLList(_loc8_.extras).children();
         this.createGroupsFromXmlList(_loc9_,this.var_258,param1,param2,param3,this._window,this.var_333);
         this.createGroupsFromXmlList(_loc10_,this.var_605,param1,param2,param3,this.var_223,this.var_333);
         this.alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_154,this.var_501,param3);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_154,this.var_501);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_154,this.var_501);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_716);
      ...
      private function alignWindows() : void
      {
         ...
         if(this._window == null || this.var_223 == null)
         {
            return;
         }
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_223.x = this.var_154 + this.var_1734;
               this.var_223.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_223.x = 0;
               this.var_223.y = this.var_154 + this.var_1734;
         ...
         _loc4_ -= this.var_1412;
         _loc4_ -= this.var_1135;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1135;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_258.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1735,(this._window.height - _loc5_ * _loc8_ - this.var_1135 - this.var_1412) / (this.var_258.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1735,(this._window.width - _loc5_ * _loc8_ - this.var_1135 - this.var_1412) / (this.var_258.length - 1)));
               }
            }
         }
         _loc2_ = 0;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1134 && this.var_1413)
         {
            ...
            if(_loc2_ != null && _loc2_ != this.var_501)
            {
               ...
               {
                  _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_530);
                  _loc3_.orientation = this.var_501;
