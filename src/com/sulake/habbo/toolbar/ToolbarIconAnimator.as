package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      private var var_2911:Number;
      
      private var var_2912:Number;
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_1474 = param1.loop;
         if(param1.background != null)
         {
            this.var_787 = this.getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         if(_loc9_.length() > 0)
         {
            ...
            while(_loc10_ < _loc9_.length())
            {
               ...
               if(_loc8_ != null)
               {
                  this.var_971.push(_loc11_);
                  this.var_970.push(_loc8_);
               }
               _loc10_++;
            }
         }
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_971.push(new XML());
               this.var_970.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_970[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1474 == true || this.var_969 == 0)
         {
            if(this.var_971.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_971.length)
               {
                  this._frame = 0;
                  ++this.var_969;
               }
      ...
      {
         return this.var_1474 == false && this.var_969 == 1 && this.var_1643 != this._state;
      }
      ...
      {
         var _loc2_:* = null;
         if(this._frame <= this.var_970.length)
         {
            _loc2_ = this.var_970[this._frame];
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_787.width),Math.max(param2.height,this.var_787.height),true,0);
            _loc4_ = _loc3_.height - this.var_787.rect.height;
            _loc3_.copyPixels(this.var_787,this.var_787.rect,new Point(0,_loc4_),null,null,true);
