package com.sulake.habbo.toolbar
{
   ...
   public class LogoutController
   {
      ...
      private const const_585:int = 46;
      
      private const const_498:int = 3;
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_498;
         _loc3_.y = this.const_585;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_692)
         {
            this.var_692 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
