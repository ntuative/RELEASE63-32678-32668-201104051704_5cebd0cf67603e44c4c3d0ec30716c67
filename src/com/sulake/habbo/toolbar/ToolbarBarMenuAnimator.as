package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1334:Number = 25;
      
      private static const const_1369:Number = 90;
      
      private static const const_969:int = 50;
      ...
      private var var_1444:ToolbarView;
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_360[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_969 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_969 || param1.desktop.height - param1.y < const_1333;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1444.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_360.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1444.getIconLoc(param1.iconId);
      ...
      {
         return this.var_622[this.var_623.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_623[this.var_622.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_623.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_623.splice(_loc3_,1);
            this.var_622.splice(_loc3_,1);
         }
         this.var_622.push(param1.name);
         this.var_623.push(param2);
         param1.addEventListener(WindowEvent.const_240,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_197,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_624[_loc3_] == null)
            {
               this.var_624[_loc3_] = new Array();
            }
            if(this.var_624[_loc3_].indexOf(param1) < 0)
            {
               this.var_624[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         if(this.var_360.indexOf(param1) > -1)
         {
            if(const_219)
            {
            ...
            else
            {
               ...
               this.var_360.splice(this.var_360.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(this.var_622[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_623[_loc2_];
               if(this.var_624[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_624[_loc3_].length)
                  {
                     this.repositionWindow(this.var_624[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_360.length)
         {
            _loc2_ = this._itemList[this.var_360[_loc7_]];
            if(_loc2_.active)
            {
