package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1374:LogoutController;
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_1374 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_1197,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_155,this.onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_93,this.onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_59,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_555,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1089,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1119,this.onHideWindowEvent);
         this._state = true;
