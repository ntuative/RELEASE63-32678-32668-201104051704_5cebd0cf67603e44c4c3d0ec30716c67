package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_2304:int = 5;
      
      private var var_2303:int;
      
      private var var_154:Number;
      
      private var var_2302:XML;
      ...
      {
         return this.var_1399.indexOf(param1) > -1;
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2302.elements("menu");
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_735.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1397.length)
         {
            _loc2_ = this.var_735.indexOf(this.var_1397[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_299[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1253 + _loc3_);
                  _loc3_ += this.var_1398;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_299[this.var_735.indexOf(param1)];
      }
