package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1209:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_650 = new Timer(100);
         this.var_650.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         ...
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_43,80,"g"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_43,74,"h"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_43,416,"o"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_43,352,"p"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_43,304,"q"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_43,336,"r"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_43,748,"u"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_43,438,"v"));
      ...
      public function dispose() : void
      {
         if(this.var_650)
         {
            this.var_650.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_650.reset();
            this.var_650 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1209.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1899 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1899 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_192 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_62 = IItemListWindow(this.var_192.findChildByName("item_list"));
         ...
         this.var_1208 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_192.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_192.desktop,this.var_192.width,this.var_192.height);
         this.var_192.x = _loc4_.x;
         this.var_192.y = _loc4_.y;
      }
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         if(this._navigator.sessionData.method_1("fuse_use_special_room_layouts",HabboClubLevelEnum.const_43))
         {
            if(this._navigator.sessionData.method_1("fuse_use_vip_room_layouts",HabboClubLevelEnum.const_47))
            {
               _loc5_ = null;
            }
            else
      ...
      private function isAllowed(param1:RoomLayout) : Boolean
      {
         switch(param1.requiredClubLevel)
         {
            case HabboClubLevelEnum.const_53:
               return true;
            case HabboClubLevelEnum.const_43:
               return this._navigator.sessionData.method_1("fuse_use_special_room_layouts",HabboClubLevelEnum.const_43);
            case HabboClubLevelEnum.const_47:
               return this._navigator.sessionData.method_1("fuse_use_vip_room_layouts",HabboClubLevelEnum.const_47);
            default:
               return false;
         }
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_68,HabboWindowStyle.const_29,HabboWindowParam.const_62,new Rectangle(0,0,100,300)));
      }
      ...
      {
         return IButtonWindow(this.var_192.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_192.findChildByName("back_button"));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent) : void
      {
         ...
         var _loc3_:String = "model_" + this.var_1209.name;
