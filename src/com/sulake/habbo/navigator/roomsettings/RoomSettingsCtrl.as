package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_457:IRoomSettingsCtrlOwner;
      ...
      private var var_1240:TextFieldManager;
      ...
      private var var_2724:ITextWindow;
      
      private var var_2723:ITextWindow;
      ...
      {
         this.var_381 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_381));
         if(this.var_1245 != null)
         {
            this.var_1245.visible = false;
         }
      }
      
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         if(param1.roomId != this.var_381)
         {
            return;
         }
         this.var_77 = param1;
         this._active = true;
         this.var_1972 = true;
         this.var_457.roomSettingsRefreshNeeded();
      }
      
      public function onFlatControllerAdded(param1:int, param2:FlatControllerData) : void
      {
         if(param1 != this.var_381)
         {
            return;
         }
         if(!this.include(param2.userId))
         {
      ...
      private function include(param1:int) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
      ...
      {
         if(param1 != this.var_381 || this.var_1241 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1241 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1455)
         {
            this.var_819.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1489)
         {
            this.var_819.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1500)
         {
            this.var_1240.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1706)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1686)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1443)
         {
            this.var_1016.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_819.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_318,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_466,this.onDoorModePasswordUnselect);
         ...
         this.var_819 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1240 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         ...
         this.var_1244 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1238 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         ...
         this.var_667 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1973 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1525 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1242 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1237 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         ...
         this.var_273 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1245 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2724 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2723 = ITextWindow(this._window.findChildByName("advanced_caption"));
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1973.visible = this._inRoom;
         this._switchViewContainer.visible = this._inRoom;
         this.var_2723.visible = this.var_543;
         this.var_2724.visible = !this.var_543;
         if(this.var_543)
         {
            this.var_1237.visible = true;
            this.var_1524.visible = false;
            this.refreshFlatControllers();
            this.var_1237.height = Util.getLowestPoint(this.var_1237) + 4;
         }
         else
         {
            this.populateForm();
            ...
            this.var_1525.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1525.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1242.height = Util.getLowestPoint(this.var_1242) + 4;
         }
         this.var_1523.text = !!this.var_543 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1973.name,this.var_1525.name,this.var_1242.name,this.var_1237.name,this.var_1524.name,this._switchViewContainer.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_819.setText(_loc1_.name);
         this.var_1240.setText(_loc1_.description);
         this.var_1016.setText("");
         this.var_1244.setText("");
         ...
         {
            case RoomSettingsData.const_203:
         ...
         if(this.var_667)
         {
            ...
            {
               this.var_667.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_667.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      {
         return this._navigator.sessionData.method_1("fuse_hide_room_walls",HabboClubLevelEnum.const_47);
      }
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_381);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_77.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_381]);
         _loc2_.show();
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_273.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_273.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_273.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_273.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_273.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_273.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_273.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_273);
         this.var_273.findChildByName("ruler").visible = true;
         ...
         if(this.var_77.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_273,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_68,HabboWindowStyle.const_29,HabboWindowParam.const_62,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_381));
      }
