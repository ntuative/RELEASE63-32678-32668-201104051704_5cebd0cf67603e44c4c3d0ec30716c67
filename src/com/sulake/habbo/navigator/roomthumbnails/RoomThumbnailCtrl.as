package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2622:IWindowContainer;
      
      private var var_2623:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1902 = IButtonWindow(this.find("bg_tab"));
         this.var_1901 = IButtonWindow(this.find("top_tab"));
         this.var_1900 = IButtonWindow(this.find("obj_tab"));
         this.var_2622 = IWindowContainer(this.find("tile_grid"));
         this.var_2623 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1902,this.onBgTabButton);
         Util.setProcDirectly(this.var_1901,this.onTopTabButton);
         Util.setProcDirectly(this.var_1900,this.onObjTabButton);
      }
      ...
      {
         this.setEnabled(this.var_1902,this.var_69.mode != ThumbnailEditorModel.const_39);
         this.setEnabled(this.var_1901,this.var_69.mode != ThumbnailEditorModel.const_63);
         this.setEnabled(this.var_1900,this.var_69.mode != ThumbnailEditorModel.const_35);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2623;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2622;
         _loc1_.visible = true;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_68,HabboWindowStyle.const_29,HabboWindowParam.const_62,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_552,HabboWindowStyle.const_44,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_310,HabboWindowStyle.const_44,HabboWindowParam.const_62,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
