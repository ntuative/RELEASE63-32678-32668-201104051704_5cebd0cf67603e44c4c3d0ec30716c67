package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_2038 = this._navigator.getButtonImage(this.var_2040);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_2041 == null)
         {
            ...
            this.var_2041 = new Rectangle(this.var_1569,this.var_1569,_loc1_.width - 2 * this.var_1569,_loc1_.height - 2 * this.var_1569);
         }
         this.var_691.bitmap.fillRect(this.var_691.bitmap.rect,4281545523);
         this.var_691.bitmap.fillRect(this.var_2041,4284900966);
         this.copyTo(this.var_691.bitmap);
         if(this._selected)
         {
            this.var_691.bitmap.copyPixels(this.var_2039,this.var_2039.rect,new Point(0,0),null,null,true);
         }
