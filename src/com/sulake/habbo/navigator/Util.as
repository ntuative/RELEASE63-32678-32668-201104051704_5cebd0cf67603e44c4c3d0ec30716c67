package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1361:CutToWidth = new CutToWidth();
      
      private static var var_1360:CutToHeight = new CutToHeight();
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1361.beforeSearch(param2,param1,param3);
         binarySearch(var_1361,param2.length - 1);
      }
