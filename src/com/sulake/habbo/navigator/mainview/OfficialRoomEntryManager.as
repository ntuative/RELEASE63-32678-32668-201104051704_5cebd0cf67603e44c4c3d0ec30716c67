package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomEntryManager implements IDisposable
   {
      ...
      private var var_2311:PublicRoomThumbs;
      
      public function OfficialRoomEntryManager(param1:HabboNavigator)
      {
         this.var_2311 = new PublicRoomThumbs();
         super();
      ...
      public function refreshEntry(param1:IWindowContainer, param2:Boolean, param3:int, param4:OfficialRoomEntryData) : void
      {
         ...
         if(param2)
         {
            ...
            if(param4.type == OfficialRoomEntryData.const_1664)
            {
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_876 || param2.type == OfficialRoomEntryData.const_812))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
      ...
      {
         var _loc4_:String = this.var_2311.resolveRoomImageName(param2);
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         if(_loc2_.guestRoomData != null)
         {
            ...
            if(_loc2_.guestRoomData.doorMode == RoomSettingsFlatInfo.const_113)
            {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_248,Tabs.const_405,_loc2_.tag);
         }
