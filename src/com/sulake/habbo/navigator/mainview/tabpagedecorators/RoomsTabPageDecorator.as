package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_353:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_353 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
      ...
      public function prepareRoomCategories() : void
      {
         ...
         this.var_353.procedure = null;
         this.var_353.populate(_loc1_);
         this.var_353.selection = 0;
         this.var_353.procedure = this.onChangeFilter;
      }
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = this.var_353 == null ? 0 : int(this.var_353.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_242,Tabs.const_389);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_242,Tabs.const_765);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_242,Tabs.const_389,"" + _loc3_);
         }
      }
   }
}
