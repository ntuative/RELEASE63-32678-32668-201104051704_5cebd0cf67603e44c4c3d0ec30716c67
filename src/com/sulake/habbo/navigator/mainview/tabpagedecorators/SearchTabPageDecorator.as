package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1865:TextSearchInputs;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_1865 == null)
         {
            ...
            this.var_1865 = new TextSearchInputs(this._navigator,false,_loc4_);
            this.initClearResults(_loc4_);
         }
         var _loc3_:IWindowContainer = param1.getChildByName("search_header") as IWindowContainer;
         if(this._navigator.data.guestRoomSearchArrived && this._navigator.data.guestRoomSearchResults.searchType == Tabs.const_258)
         {
            this.var_1865.searchStr.setText(this._navigator.data.guestRoomSearchResults.searchParam);
         }
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.mainViewCtrl.startSearch(Tabs.const_248,Tabs.const_258,"-1",MainViewCtrl.const_689);
      }
