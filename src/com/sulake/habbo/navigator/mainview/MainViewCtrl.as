package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      public static const const_586:int = 1;
      ...
      private static const const_631:int = 2;
      ...
      private var var_1231:OfficialRoomListCtrl;
      ...
      private var var_1229:Boolean = true;
      
      private var var_1517:int = 0;
      
      private var var_1518:IWindow;
      
      private var var_1230:IRegionWindow;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_1231 = new OfficialRoomListCtrl(this._navigator);
      ...
      private function prepare() : void
      {
         ...
         this.var_269 = ITabContextWindow(this.var_16.findChildByName("tab_context"));
         if(!this.var_269)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _tabContext is null!");
         }
         this.var_192 = IWindowContainer(this.var_16.findChildByName("tab_content"));
         this.var_235 = IWindowContainer(this.var_16.findChildByName("custom_content"));
         this.var_212 = IWindowContainer(this.var_16.findChildByName("list_content"));
         this.var_272 = IWindowContainer(this.var_16.findChildByName("custom_footer"));
         this.var_1518 = this.var_16.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_16.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1230 = IRegionWindow(this.var_16.findChildByName("to_hotel_view"));
         if(!this.var_1230)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1230.procedure = this.onHotelView;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1634,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_192,["custom_content","list_content"],this.var_235.y,8);
         this.var_212.height = this.var_212.height + _loc1_ - this.var_212.y - this.var_272.height + this.var_2699;
         Util.moveChildrenToColumn(this.var_192,["list_content","custom_footer"],this.var_212.y,0);
         this.var_2699 = this.var_272.height;
      ...
      {
         this.refreshList(param1,param2,this.var_1231,"official_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_665 == const_999)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_212.blend - _loc2_));
            this.var_212.blend = _loc3_;
            this.var_235.blend = !!this.var_1229 ? Number(_loc3_) : Number(1);
            this.var_272.blend = !!this.var_1229 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_665 = const_631;
            }
         }
         else if(this.var_665 == const_631)
         {
            if(this.var_1517 % 10 == 1)
            {
               this.var_1518.visible = !this.var_1518.visible;
            }
            ++this.var_1517;
            if(!this._navigator.data.isLoading())
            {
               this.var_665 = const_998;
            }
         }
         else if(this.var_665 == const_998)
         {
            this.refresh();
            this.var_665 = const_1379;
         }
         else
         {
      ...
      {
         this._navigator.refreshButton(this.var_1230,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1230,"icon_hotelview_reactive",param1,null,0);
      }
