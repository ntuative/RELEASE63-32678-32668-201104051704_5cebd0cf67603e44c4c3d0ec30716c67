package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1409:int = 60;
      ...
      private var var_556:Number = 1.0;
      ...
      private var var_842:TraxSequencer;
      
      private var var_219:IHabboMusicController;
      
      private var var_1277:Map;
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_1043.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            ...
            this.var_1043.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_556;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_686.add(_loc4_,param1);
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1277.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_687,events);
         _loc5_.volume = this.var_556;
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_687.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      {
         if(this.var_179 == null || this._connection == null || this._roomEngine == null || this.var_219 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1554,this.var_843));
         this.var_843 = -1;
         this.var_842 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_556 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_556 * 100)));
         }
      }
      ...
      {
         this.var_556 = param1;
         this.var_219.updateVolume(this.var_556);
      ...
      private function setHabboToolbarIconState(param1:Boolean) : void
      {
         ...
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_93,HabboToolbarIconEnum.SOUNDS);
         _loc2_.iconState = !!param1 ? "1" : "0";
         this.var_159.events.dispatchEvent(_loc2_);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         {
            _loc2_ = this.var_686.remove(param1);
            if(this.var_687.getValue(_loc2_) == null)
            {
               _loc3_ = new ByteArray();
               _loc4_ = param1.length;
               param1.extract(_loc3_,int(_loc4_ * 44.1));
               _loc5_ = new TraxSample(_loc3_,_loc2_);
               this.var_687.add(_loc2_,_loc5_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1278.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1409 && this.var_1278.length > 0)
            {
               _loc3_ = this.var_1278.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_686.length == 0 && this.var_843 != -1)
            {
               this.var_842.ready = true;
               _loc4_ = this.var_843;
               this.var_843 = -1;
               this.var_842 = null;
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_842 == null && this.var_1277.length > 0)
         {
            _loc1_ = this.var_1277.getKey(0);
            _loc2_ = this.var_1277.remove(_loc1_);
            if(_loc2_ != null)
            {
