package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1101:IRoomWidgetFactory;
      ...
      private var var_321:IAdManager;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1233:IHabboHelp;
      ...
      {
         this.var_1519 = RoomDesktop.const_567;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1101.release(new IIDHabboRoomWidget());
            this.var_1101 = null;
         }
         ...
         {
            this.var_1233.release(new IIDHabboHelp());
            this.var_1233 = null;
         }
         ...
         if(this.var_322)
         {
            while(this.var_322.length > 0)
            {
               _loc1_ = this.var_322.getKey(0) as String;
               _loc2_ = this.var_322.remove(_loc1_) as RoomDesktop;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1101 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1967 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_321 != null && this.var_321.events != null)
         {
            this.var_321.events.addEventListener(AdEvent.const_464,this.adEventHandler);
            this.var_321.events.addEventListener(AdEvent.const_474,this.adEventHandler);
            this.var_321.events.addEventListener(AdEvent.const_452,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1233 = param2 as IHabboHelp;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            this.var_15.events.addEventListener(RoomSessionEvent.const_227,this.roomSessionStateEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_601,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPresentEvent.const_347,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_592,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_470,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_599,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_455,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_925,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1124,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1036,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_816,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_891,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_575,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionVoteEvent.const_156,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionVoteEvent.const_133,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_594,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionUserDataUpdateEvent.const_120,this.roomSessionEventHandler);
         }
      }
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionEvent.const_227:
            ...
            case RoomSessionEvent.const_89:
               if(param1.session != null)
               {
                  ...
                  this.var_159.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_155,HabboToolbarIconEnum.ZOOM));
                  this.var_159.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_155,HabboToolbarIconEnum.MEMENU));
                  this.var_159.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_155,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_265:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_925:
            ...
            case RoomSessionErrorMessageEvent.const_236:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_816:
            ...
            case RoomSessionErrorMessageEvent.const_923:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_891:
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_759,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_328,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_302,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_492,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_476,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_64,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_750,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_361,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_682,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineSoundMachineEvent.const_371,this.roomObjectEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_759)
         {
            if(this.var_15 != null)
            {
               this.var_15.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_476 || param1.type == RoomEngineEvent.const_492)
         {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_328:
               ...
               if(this._roomEngine != null)
               {
                  ...
                  {
                     _loc7_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_93,HabboToolbarIconEnum.ZOOM);
                     _loc7_.iconState = "2";
                     this.var_159.events.dispatchEvent(_loc7_);
                  }
                  else
                  {
                     _loc5_ = true;
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_843);
               ...
               if(this._config.getKey("purse.widget.enabled","0") == "1")
               {
                  ...
                  _loc3_.initializeWidget(RoomWidgetEnum.const_428);
               }
               if(!_loc5_)
               {
               ...
               if(this.var_1519 != RoomDesktop.const_567)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_312,this.var_1519);
               }
               if(this.var_321 != null)
               {
                  this.var_321.showRoomAd();
               }
               ...
               break;
            case RoomEngineEvent.const_302:
               this.disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_750:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1101;
         _loc3_.sessionDataManager = this.var_305;
         _loc3_.roomSessionManager = this.var_15;
         _loc3_.friendList = this._friendList;
         _loc3_.avatarRenderManager = this.var_551;
         _loc3_.inventory = this._inventory;
         _loc3_.toolbar = this.var_159;
         _loc3_.navigator = this._navigator;
         _loc3_.avatarEditor = this.var_1967;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_321;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1233;
         _loc3_.moderation = this.var_1013;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_345;
         ...
         _loc3_.init();
         this.var_322.add(_loc2_,_loc3_);
         return _loc3_;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:RoomDesktop = this.var_322.remove(param1) as RoomDesktop;
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_312);
            if(_loc3_ != RoomDesktop.const_567)
            {
      ...
      {
         return this.var_322.getValue(param1) as RoomDesktop;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_322.getWithIndex(_loc2_) as RoomDesktop;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
