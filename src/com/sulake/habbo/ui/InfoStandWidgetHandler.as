package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_219.events.addEventListener(NowPlayingEvent.const_679,this.onNowPlayingChanged);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_174,this.onUserTags);
            ...
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_168,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_174,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_152,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_168,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_593.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_593.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_219 != null)
         {
            this.var_219.events.removeEventListener(NowPlayingEvent.const_679,this.onNowPlayingChanged);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_367);
         _loc1_.push(RoomWidgetUserActionMessage.const_652);
         _loc1_.push(RoomWidgetUserActionMessage.const_822);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_776);
         _loc1_.push(RoomWidgetUserActionMessage.const_922);
         _loc1_.push(RoomWidgetUserActionMessage.const_912);
         _loc1_.push(RoomWidgetUserActionMessage.const_899);
         _loc1_.push(RoomWidgetGiveBadgeMessage.GIVE_BADGE);
         _loc1_.push(RoomWidgetFurniActionMessage.const_232);
         ...
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_794);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_833);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1608);
         _loc1_.push(RoomWidgetPetCommandMessage.const_556);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_598)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_414 || param1.type == RoomWidgetUserActionMessage.const_480 || param1.type == RoomWidgetUserActionMessage.const_587)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_367:
            ...
            case RoomWidgetUserActionMessage.const_652:
               ...
               break;
            case RoomWidgetUserActionMessage.const_822:
            ...
            case RoomWidgetUserActionMessage.const_696:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1067,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_680:
               ...
               break;
            case RoomWidgetUserActionMessage.const_776:
            ...
            case RoomWidgetUserActionMessage.const_912:
               ...
               break;
            case RoomWidgetUserActionMessage.const_899:
            ...
            case RoomWidgetFurniActionMessage.const_854:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_232:
            ...
            case RoomWidgetRoomTagSearchMessage.const_777:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_794:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_833:
            ...
            case RoomWidgetPetCommandMessage.const_879:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_556:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_317);
               _loc6_.id = param1.id;
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_468) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_468);
               }
               ...
               {
                  _loc26_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_322);
               ...
               _loc11_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1111);
               _loc12_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1179);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc30_ = "";
                  _loc31_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_896)
                  {
                     _loc32_ = this.var_219.getRoomItemPlaylist();
                     if(_loc32_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_384) == 0)
                  {
                     _loc33_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_384.length);
                     _loc28_ = parseInt(_loc33_);
                     _loc31_ = "null";
                  }
                  if(_loc28_ != -1)
                  {
                     _loc34_ = this.var_219.getSongInfo(_loc28_);
                     if(_loc34_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc13_.type == RoomObjectTypeEnum.const_184)
               {
                  _loc14_ = "null";
               ...
               {
                  if(_loc13_.type != RoomObjectTypeEnum.const_914)
                  {
                     return null;
                  }
                  _loc14_ = "null";
               ...
               if(_loc19_ != null)
               {
                  _loc15_.carryItem = _loc19_.getModel().getNumber(RoomObjectVariableEnum.const_449);
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_115)
               {
                  _loc15_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_135)
               {
                  ...
                  if(_loc19_ != null)
                  {
                     _loc40_ = _loc19_.getModel().getString(RoomObjectVariableEnum.const_855);
                  ...
                  if(!_loc36_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1158;
                  }
                  if(!_loc37_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1105;
                  }
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc16_.push(RoomWidgetUserInfoUpdateEvent.const_1650);
               }
               else
               {
               ...
               _loc21_ = _loc13_.sex;
               _loc22_ = this._container.avatarRenderManager.createAvatarImage(_loc20_,AvatarScaleType.const_56,_loc21_);
               if(_loc22_ != null)
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_593.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_593.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_855);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_219 != null)
         {
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_325,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_219 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_511,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
