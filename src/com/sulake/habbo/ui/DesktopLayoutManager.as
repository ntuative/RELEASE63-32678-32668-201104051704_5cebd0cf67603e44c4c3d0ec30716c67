package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1248:String = "room_view";
      
      private const const_1996:String = "room_widget";
      
      private var var_48:IWindowContainer;
      
      private var var_708:int = 50;
      
      private var var_2892:XML = null;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager, param3:IHabboConfigurationManager) : void
      {
         ...
         while(_loc6_ < this.var_48.numChildren)
         {
            ...
            {
               _loc5_.addEventListener(WindowEvent.const_138,this.trimContainer);
            }
            _loc6_++;
         }
      }
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_48.getChildByTag(this.const_1248) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         {
            case "LEFT":
               _loc2_.x = this.var_708;
               _loc2_.width = this.var_48.desktop.width - this.var_708;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = this.var_708;
               _loc2_.height = this.var_48.desktop.height - this.var_708;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = this.var_48.desktop.width;
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_48.findChildByTag(this.const_1248) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
