package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_832,RoomWidgetViralFurniMessage.const_795,RoomWidgetViralFurniMessage.const_172];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_832:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_549);
                     _loc8_ = "+";
               ...
               break;
            case RoomWidgetViralFurniMessage.const_795:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendViralFurniFoundMessage();
               }
               break;
            case RoomWidgetViralFurniMessage.const_172:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_599,RoomSessionViralFurniStatusEvent.const_455];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_599:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_853);
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_455:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_900);
               _loc3_.campaignID = _loc2_.campaignID;
               _loc3_.status = _loc2_.status;
               _loc3_.data = _loc2_.shareId;
               _loc3_.itemCategory = _loc2_.itemCategory;
