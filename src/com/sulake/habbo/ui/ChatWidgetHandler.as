package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_1129:Number = 0.0;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_429 != null)
         {
            ...
            {
               _loc2_ = this.var_429.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_743,RoomWidgetChatSelectAvatarMessage.const_752];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_743:
               if(this._container != null && this._container.roomSession != null)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.method_1("fuse_habbo_chooser",HabboClubLevelEnum.const_43) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1095))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.method_1("fuse_furni_chooser",HabboClubLevelEnum.const_43) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1095))
                              {
                     ...
                     {
                        case RoomWidgetChatMessage.const_151:
                        ...
                        case RoomWidgetChatMessage.const_124:
                           ...
                           break;
                        case RoomWidgetChatMessage.const_154:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_183)
                           {
                              _loc13_ = this.var_301.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_429.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_603.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_183:
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_603.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    ...
                                    {
                                       this.var_429.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1129 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1129);
            }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_429)
         {
            _loc2_ = this.var_429.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1130.push(_loc2_);
            }
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_603.add(param1,_loc7_);
                  }
               }
            }
         }
