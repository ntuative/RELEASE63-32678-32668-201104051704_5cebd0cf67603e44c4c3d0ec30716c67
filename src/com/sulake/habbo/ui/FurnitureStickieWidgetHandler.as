package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_911,RoomWidgetStickieSendUpdateMessage.const_724,RoomWidgetStickieSendUpdateMessage.const_508];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_911:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     _loc7_ = _loc6_.getString(RoomObjectVariableEnum.const_1217);
                     if(_loc7_.length < 6)
                     {
                        return null;
                     }
                     ...
                     _loc11_ = new RoomWidgetStickieDataUpdateEvent(RoomWidgetStickieDataUpdateEvent.const_781,_loc2_.id,_loc3_.getType(),_loc9_,_loc8_,_loc10_);
            ...
            case RoomWidgetStickieSendUpdateMessage.const_508:
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_724:
