package com.sulake.habbo.ui
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1278:String = "hr-165-45.hd-208-2.ch-250-64.lg-285-82.sh-290-64";
      
      private static const const_1277:String = "hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_686,RoomWidgetClothingChangeMessage.const_390,RoomWidgetAvatarEditorMessage.const_411];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_686:
            ...
            case RoomWidgetClothingChangeMessage.const_390:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     this.var_373 = _loc7_.objectId;
                     _loc9_ = "null";
                     _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_1175);
                     if(_loc10_ == null)
                     {
                        _loc10_ = const_1278;
                     }
                     ...
                     if(this._container.avatarEditor.openEditor(_loc7_.window,this,[AvatarEditorFigureCategory.const_256,AvatarEditorFigureCategory.const_793],true))
                     {
                        _loc11_ = 0;
      ...
      public function saveFigure(param1:String, param2:String) : void
      {
         ...
         this._container.roomSession.sendUpdateClothingChangeFurniture(this.var_373,param2,param1);
