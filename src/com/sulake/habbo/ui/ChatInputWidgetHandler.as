package com.sulake.habbo.ui
{
   ...
   public class ChatInputWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetChatInputWidgetMessage.const_727);
         _loc1_.push(RoomWidgetChatTypingMessage.const_901);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatInputWidgetMessage.const_727:
               ...
               break;
            case RoomWidgetChatTypingMessage.const_901:
      ...
      private function positionWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_159.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_1089,HabboToolbarIconEnum.CHATINPUT,param1));
      }
      
      public function getProcessedEvents() : Array
      {
         return [RoomSessionChatEvent.const_601];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_601:
