package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_890,RoomWidgetEcotronBoxOpenMessage.const_678,RoomWidgetEcotronBoxOpenedMessage.const_1439];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_890:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_678:
