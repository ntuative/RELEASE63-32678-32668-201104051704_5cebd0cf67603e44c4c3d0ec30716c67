package com.sulake.habbo.ui
{
   ...
   public class PurseWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetPurseData.const_877);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetPurseData.const_877:
               ...
               this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_106,_loc2_.getActivityPointsForType(Purse.const_204)));
               break;
               ...
               if(this._container.catalog != null)
               {
                  switch(_loc3_.pageKey)
                  {
                     case RoomWidgetOpenCatalogMessage.const_1181:
                        this._container.catalog.openCatalogPage(CatalogPageName.const_1617);
                        break;
                     case RoomWidgetOpenCatalogMessage.const_1205:
