package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1940:int = 16777216;
      ...
      private var var_1601:int = 16777216;
      
      private var var_2890:int = 69069;
      
      private var var_2891:int = 5;
      ...
      {
         var _loc1_:int = this.var_2890 * this.var_1602 + this.var_2891;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1601;
         this.var_1602 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1601 * param2);
      }
   }
}
