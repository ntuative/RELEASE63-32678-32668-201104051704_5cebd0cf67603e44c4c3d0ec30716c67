package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_127.length)
            {
               _loc2_ = this.var_127.getWithIndex(_loc1_) as Plane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc3_ = this.var_366.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc3_ != null)
            {
               _loc3_.clearCache();
            }
      ...
      private function resetMaterials() : void
      {
         ...
         while(_loc1_ < this.var_366.length)
         {
            _loc2_ = this.var_366.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      private function resetTextures() : void
      {
         ...
         {
            _loc2_ = this.var_199.getWithIndex(_loc1_) as PlaneTexture;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return this.var_199.getValue(param1) as PlaneTexture;
      }
      
      protected function getMaterial(param1:String) : PlaneMaterial
      {
         return this.var_366.getValue(param1) as PlaneMaterial;
      }
      
      protected function getPlane(param1:String) : Plane
      {
         return this.var_127.getValue(param1);
      }
      ...
      protected function addPlane(param1:String, param2:Plane) : Boolean
      {
         ...
         if(this.var_127.getValue(param1) == null)
         {
            this.var_127.add(param1,param2);
            return true;
         }
         return false;
      }
      ...
      private function parseTextures(param1:XML, param2:IGraphicAssetCollection) : void
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            {
               _loc6_ = _loc5_.@id;
               if(this.var_199.getValue(_loc6_) == null)
               {
                  ...
                  this.var_199.add(_loc6_,_loc7_);
               }
            }
            _loc4_++;
         }
