package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1708:int = 16777215;
      
      public static const const_1647:int = 13421772;
      
      private static const const_957:int = 16777215;
      
      private static const const_955:int = 13421772;
      
      private static const const_954:int = 10066329;
      
      private static const const_956:int = 10066329;
      
      public static const const_1583:int = 16777215;
      
      public static const const_1458:int = 13421772;
      ...
      private var var_744:Rectangle = null;
      ...
      private var var_2365:String = null;
      
      private var var_1142:uint = 16777215;
      
      private var var_2363:int = 255;
      
      private var var_2362:int = 255;
      ...
      private var var_1684:int = -1000;
      
      private const const_2007:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_302["null"] = false;
         this.var_302["null"] = true;
         this.var_302["null"] = true;
         this.var_302["null"] = true;
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_127.length)
            {
               _loc4_ = this.var_127[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_744 = super.boundingRectangle;
         }
         return new Rectangle(this.var_744.x,this.var_744.y,this.var_744.width,this.var_744.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_127.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_127[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1236);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_200)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_221,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1708;
               }
               else
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_167)
            {
               ...
               {
                  _loc13_.color = const_955;
               }
               else
               {
                  _loc13_.color = const_954;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1645)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_121,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1684 + this.const_2007 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_354.length)
            {
               _loc11_ = this.var_606[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_354[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1742)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2361 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2362 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2363 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1632)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1353 || _loc3_.y != this.var_2172 || _loc3_.z != this.var_2171 || param1.scale != this.var_2168))
            {
               this.var_1353 = _loc3_.x;
               this.var_2172 = _loc3_.y;
               this.var_2171 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1053);
            if(_loc3_ != this.var_2365)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2365 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_714));
            if(_loc4_ != this.var_1142)
            {
               this.var_1142 = _loc4_;
               this.var_2361 = this.var_1142 & 255;
               this.var_2362 = this.var_1142 >> 8 & 255;
               this.var_2363 = this.var_1142 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1113));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_175 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_324);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_298);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_330);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_718));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_779));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_645));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_127.length)
         {
            _loc5_ = this.var_127[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_221 && param1 != null)
               {
                  _loc5_.id = param1;
               }
      ...
      {
         if(param1 != this.var_302["null"] || param2 != this.var_302["null"] || param3 != this.var_302["null"])
         {
            this.var_302["null"] = param1;
            this.var_302["null"] = param2;
            this.var_302["null"] = param3;
            this.var_354 = [];
            this.var_606 = [];
         }
      }
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_221)
                        {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_302[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1743;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         {
            _loc3_ = this.var_127[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         while(_loc8_ < this.var_504.maskCount)
         {
            ...
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_127.length)
               {
                  _loc3_ = this.var_127[_loc13_] as RoomPlane;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_121 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_247)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_127[_loc18_] as RoomPlane;
