package com.sulake.habbo.room.object.visualization.room.mask
{
   ...
   public class PlaneMask
   {
      ...
      private var var_1250:PlaneMaskVisualization = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_546 != null)
         {
            _loc1_ = null;
            _loc2_ = 0;
            while(_loc2_ < this.var_546.length)
            {
               _loc1_ = this.var_546.getWithIndex(_loc2_) as PlaneMaskVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         if(this.var_546.getValue(String(param1)) != null)
         {
            return null;
         }
         var _loc2_:PlaneMaskVisualization = new PlaneMaskVisualization();
         this.var_546.add(String(param1),_loc2_);
      ...
      protected function getMaskVisualization(param1:int) : PlaneMaskVisualization
      {
         ...
         {
            this.var_1250 = this.var_546.getValue(String(this._sizes[_loc2_])) as PlaneMaskVisualization;
         }
         else
         {
            this.var_1250 = null;
