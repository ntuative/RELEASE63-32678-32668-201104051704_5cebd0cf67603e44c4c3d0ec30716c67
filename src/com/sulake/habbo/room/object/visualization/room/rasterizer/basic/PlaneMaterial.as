   ...
   public class PlaneMaterial
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_388 != null)
         {
            ...
            {
               _loc2_ = this.var_388[_loc1_] as PlaneMaterialCellMatrix;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getMaterialCellMatrix(param1:IVector3d) : PlaneMaterialCellMatrix
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_388.length)
         {
            _loc3_ = this.var_388[_loc2_] as PlaneMaterialCellMatrix;
            if(_loc3_ != null)
            {
