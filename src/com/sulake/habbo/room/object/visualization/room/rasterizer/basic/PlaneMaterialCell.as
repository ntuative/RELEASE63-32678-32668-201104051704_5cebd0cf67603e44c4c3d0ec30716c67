package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_644:PlaneTexture;
      ...
      public function PlaneMaterialCell(param1:PlaneTexture, param2:Array = null, param3:Array = null, param4:int = 0)
      {
         ...
         if(param2 != null && param2.length > 0 && param4 > 0)
         {
            ...
            while(_loc5_ < param2.length)
            {
               ...
               if(_loc6_ != null)
               {
                  this.var_968.push(_loc6_);
               }
               _loc5_++;
            }
            if(this.var_968.length > 0)
            {
               if(param3 != null)
               {
                  _loc5_ = 0;
      ...
      public function getHeight(param1:IVector3d) : int
      {
         ...
         if(this.var_644 != null)
         {
            _loc2_ = this.var_644.getBitmap(param1);
            if(_loc2_ != null)
            {
         ...
         if(this.var_644 != null)
         {
            ...
            if(_loc2_ != null)
            {
               if(!this.isStatic)
               {
                  ...
                  _loc3_ = Math.min(this.var_1190,this._extraItemOffsets.length);
                  _loc4_ = Math.max(this.var_1190,this._extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(this.var_1190,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     _loc7_ = this._extraItemOffsets[_loc5_[_loc6_]] as Point;
                     _loc8_ = this.var_968[_loc6_ % this.var_968.length] as IGraphicAsset;
