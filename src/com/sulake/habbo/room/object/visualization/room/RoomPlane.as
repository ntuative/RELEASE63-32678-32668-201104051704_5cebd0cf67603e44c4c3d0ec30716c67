package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1034:IPlaneRasterizer = null;
      
      private var var_808:PlaneMaskManager = null;
      ...
      private var var_239:BitmapData = null;
      ...
      private var var_835:Boolean = true;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_2803 = param10;
         this.var_2800 = param11;
         this.var_2802 = param12;
      ...
      {
         return this._isVisible && this.var_835;
      }
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_635);
                  return param1;
               }
            }
         }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1034.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_835 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_391))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_295.length * param1.scale;
            _loc6_ = this.var_294.length * param1.scale;
            ...
            if(this.var_1034 != null)
            {
               _loc3_ = this.var_1034.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_2013,this.var_2801,this.var_2803,this.var_2800,this.var_2802,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1632 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_835)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1479.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1479[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1089);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_150.z - originZ,this.var_109.z - originZ,this.var_84.z - originZ,this.var_110.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2170 = relativeDepth;
            this._isVisible = true;
            this.var_1632 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2804);
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_281.length == this.var_1035.length)
         {
            while(_loc1_ < this.var_281.length)
            {
               ...
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_1035.length)
                  {
                     _loc7_ = this.var_1035[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_390.length > this.var_1552.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1033 || this.var_281.length == 0 && this.var_390.length == 0 && !this.var_391 || this.var_808 == null)
         {
            return;
         }
         ...
         if(this.var_391)
         {
            ...
            while(_loc5_ < this.var_281.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_72.width - this.var_72.width * _loc3_.leftSideLoc / this.var_295.length;
                  _loc11_ = this.var_72.height - this.var_72.height * _loc3_.rightSideLoc / this.var_294.length;
                  _loc12_ = _loc3_.type;
                  this.var_808.updateMask(this.var_72,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_1035.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_390.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_72.width - this.var_72.width * _loc4_.leftSideLoc / this.var_295.length;
                  _loc11_ = this.var_72.height - this.var_72.height * _loc4_.rightSideLoc / this.var_294.length;
                  _loc13_ = this.var_72.width * _loc4_.leftSideLength / this.var_295.length;
                  _loc14_ = this.var_72.height * _loc4_.rightSideLength / this.var_294.length;
                  this.var_72.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1552.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_391 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_239 != null && (this.var_239.width != param1.width || this.var_239.height != param1.height))
         {
            this.var_239.dispose();
            this.var_239 = null;
         }
         if(this.var_239 == null)
         {
            this.var_239 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_239.copyChannel(param1,param1.rect,const_635,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_239.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_239,this.var_239.rect,const_635,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
