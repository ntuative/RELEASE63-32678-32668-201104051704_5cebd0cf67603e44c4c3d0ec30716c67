package com.sulake.habbo.room.object.visualization.room.publicroom
{
   ...
   public class PublicRoomVisualization extends RoomVisualization
   {
      ...
      {
         createSprites(this.var_1306 + param1);
      }
      ...
      private function initializeLayout(param1:IRoomGeometry) : void
      {
         ...
         if(this.data != null)
         {
            this.var_1306 = spriteCount;
            _loc2_ = object.getModel();
            _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_1054);
            ...
            {
               this.data.layoutRasterizer.setElementToSprite(_loc4_,getSprite(_loc4_ + this.var_1306));
               _loc4_++;
            }
            this.data.layoutRasterizer.initializeAds(this.var_1306,this);
         }
         this.var_2217 = true;
      }
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc8_:* = !Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_462));
