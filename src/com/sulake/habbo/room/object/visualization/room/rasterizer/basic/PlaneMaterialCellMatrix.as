package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_650:int = 6;
      
      public static const const_1457:int = const_393;
      ...
      private var var_1872:Boolean = true;
      
      private var var_2527:Number = -1.0;
      
      private var _normalMaxX:Number = 1.0;
      
      private var var_2526:Number = -1.0;
      
      private var var_2528:Number = 1.0;
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc2_ = this.var_369[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= this.var_369.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = this.var_369[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         this.var_369[param1] = _loc5_;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_31 != null)
            {
               if(this.var_31.width == param2 && this.var_31.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_645,param6,param7);
                     return param1;
                  }
                  return this.var_31;
               }
         ...
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < this.var_369.length)
         {
            _loc11_ = this.var_369[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         {
            _loc5_ = new Rectangle(0,0,this.var_31.width,this.var_645);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_31.height - this.var_645,this.var_31.width,this.var_645);
         }
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(this.var_369.length == 1)
         {
            _loc4_ = this.var_369[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
