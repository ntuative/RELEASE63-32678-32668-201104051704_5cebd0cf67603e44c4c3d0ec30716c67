package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1344:String = "head";
      
      private static const const_617:int = 1;
      
      private static const const_975:int = 1000;
      
      private static const const_1346:String = "pet_experience_bubble_png";
      
      private static const const_1347:int = 0;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1346) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2509)
            {
               this.var_2509 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_237);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_144);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_237);
            if(!isNaN(_loc6_))
            {
            ...
            this.var_1999 = _loc3_.getNumber(RoomObjectVariableEnum.const_423) > 0;
            ...
            this.var_1452 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2483 = _loc3_.getNumber(RoomObjectVariableEnum.const_703);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_856);
            if(_loc9_ != this.var_1825)
            {
               this.var_1825 = _loc9_;
               this.var_2510 = this.var_1825.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_365 != null)
         {
            ...
            if(this.var_1452 > 0)
            {
               _loc2_ = param1 - this.var_1452;
               if(_loc2_ < const_975)
               {
                  this.var_365.alpha = int(Math.sin(_loc2_ / const_975 * 0) * 255);
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param2 != this.var_1543)
         {
            ...
            this.setAnimationForIndex(const_1345,_loc3_);
         }
      }
      ...
      {
         return super.getAdditionalSpriteCount() + const_617;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2510);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_617)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_617))
            {
               if(param2 >= FurnitureVisualizationData.const_523.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_523[param2];
               if(_loc4_ == 1)
               {
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_90,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1344)
            {
