package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetAnimationSizeData extends AnimationSizeData
   {
      ...
      public function definePostures(param1:XML) : Boolean
      {
         ...
         {
            this.var_853 = param1.@defaultPosture;
         }
         else
         {
            this.var_853 = null;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_693.add(_loc6_,_loc7_);
         ...
         if(this.var_693.getValue(this.var_853) == null)
         {
            return false;
         }
         return true;
      ...
      public function defineGestures(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            _loc6_ = String(_loc5_.@id);
            _loc7_ = int(_loc5_.@animationId);
            this.var_854.add(_loc6_,_loc7_);
            _loc4_++;
         }
         return true;
      }
      ...
      public function getAnimationForPosture(param1:String) : int
      {
         ...
         return int(this.var_693.getValue(param1));
      }
      
      public function getAnimationForGesture(param1:String) : int
      {
         if(this.var_854.getValue(param1) == null)
         {
            return const_742;
         }
         return int(this.var_854.getValue(param1));
      }
      ...
      {
         if(param1 >= 0 && param1 < this.var_854.length)
         {
            return this.var_854.getKey(param1);
         }
         return null;
      }
