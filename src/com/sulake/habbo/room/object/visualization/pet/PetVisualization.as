package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private var var_675:PetVisualizationData = null;
      ...
      private const const_2046:int = 3;
      ...
      private const const_1396:int = 3;
      ...
      private var var_1995:Number = NaN;
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_564.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_564.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
      ...
      {
         this.var_675 = param1 as PetVisualizationData;
         createSprites(this.const_1396);
         var _loc2_:BitmapData = (this.var_675.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset).content as BitmapData;
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_1999 = param1.getNumber(RoomObjectVariableEnum.const_423) > 0;
            this.var_1543 = param1.getString(RoomObjectVariableEnum.const_144);
            this.var_278 = param1.getString(RoomObjectVariableEnum.const_237);
            this._postureParameter = param1.getString(RoomObjectVariableEnum.const_681);
            this.var_1995 = param1.getNumber(RoomObjectVariableEnum.const_192);
            this.var_1452 = param1.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2483 = param1.getNumber(RoomObjectVariableEnum.const_703);
            this.validateActions();
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_191);
            if(this.var_596 != _loc3_)
            {
               this.var_596 = _loc3_;
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_474 != param1.getUpdateID() || this.var_1632 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_1995;
            if(isNaN(this.var_1995))
            {
               _loc5_ = _loc4_;
            }
            else
            ...
            if(_loc4_ != this.var_1994 || param3)
            {
               this.var_1994 = _loc4_;
               _loc4_ -= 112.5;
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         var _loc3_:IAvatarImage = this.var_564.getValue(_loc2_) as IAvatarImage;
         if(_loc3_ == null)
         {
            _loc3_ = this.var_675.getAvatar(this.var_596,param1,this);
            if(_loc3_ != null)
            {
               this.var_564.add(_loc2_,_loc3_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateShadow(param1:Number) : void
      {
         ...
         this.var_674 = null;
         _loc2_ = getSprite(this.const_1775);
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(param1 < 48)
         {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc12_:Boolean = this.var_897 || this.var_1298 > 0 || this.var_2051;
         this.var_365.alpha = 0;
         if(this.var_1452 > 0)
         {
            _loc13_ = param2 - this.var_1452;
            if(_loc13_ < AvatarAction.const_975)
            {
               this.var_365.alpha = int(Math.sin(_loc13_ / 0 * 0) * 255);
               this.var_365.setExperience(this.var_2483);
               this.var_1298 = this.const_2046;
            }
            else
            {
               this.var_1452 = 0;
            }
            _loc14_ = getSprite(this.const_1772);
            if(_loc14_ != null)
            {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         {
            param1.appendAction(AvatarAction.const_345,this.var_1543);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1396;
