package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1515:int = 360;
      
      private var var_813:DirectionData = null;
      
      private var var_271:Map;
      
      private var _colors:Map;
      
      private var var_1225:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_813 = new DirectionData(param1);
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_813,_loc2_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc3_.copyValues(this.var_813);
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1515 / 2) % 360 / this.var_1515;
         ...
         {
            _loc6_ = int(this.var_271.getKey(_loc5_)) * this.var_1515;
