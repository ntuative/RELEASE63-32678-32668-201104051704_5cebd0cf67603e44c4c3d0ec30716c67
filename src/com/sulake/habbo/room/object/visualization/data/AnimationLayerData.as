package com.sulake.habbo.room.object.visualization.data
{
   public class AnimationLayerData
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_229[_loc1_] as AnimationFrameSequenceData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function calculateLength() : void
      {
         ...
         while(_loc1_ < this.var_229.length)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_447 += _loc2_.frameCount;
            }
            _loc1_++;
         }
      }
      ...
      public function getFrame(param1:int, param2:int) : AnimationFrame
      {
         ...
         var _loc3_:* = null;
         param2 /= this.var_1869;
         var _loc4_:Boolean = false;
         var _loc5_:int = 0;
         if(!this.var_1862)
         {
            _loc6_ = param2 / this.var_447;
            param2 %= this.var_447;
            if(this._loopCount > 0 && _loc6_ >= this._loopCount || this._loopCount <= 0 && this.var_447 == 1)
            {
               param2 = this.var_447 - 1;
               _loc4_ = true;
            }
            _loc7_ = 0;
            _loc5_ = 0;
            ...
            {
               _loc3_ = this.var_229[_loc5_] as AnimationFrameSequenceData;
               if(_loc3_ != null)
               {
         ...
         _loc5_ = this.var_229.length * Math.random();
         _loc3_ = this.var_229[_loc5_] as AnimationFrameSequenceData;
      ...
      {
         if(param2 < 0 || param2 >= this.var_229.length)
         {
            return null;
         }
         var _loc5_:AnimationFrameSequenceData = this.var_229[param2] as AnimationFrameSequenceData;
         if(_loc5_ != null)
         {
      ...
      private function getFrameFromSpecificSequence(param1:int, param2:AnimationFrameSequenceData, param3:int, param4:int, param5:Boolean) : AnimationFrame
      {
         ...
         if(param2 != null)
         {
            ...
            _loc12_ = this.var_1869 * _loc11_;
            if(param5)
            {
               _loc12_ = 0;
            }
            _loc13_ = false;
            if(!this.var_1862 && !param2.isRandom)
            {
               if(param3 == this.var_229.length - 1 && param4 == param2.frameCount - 1)
               {
                  _loc13_ = true;
               }
            }
