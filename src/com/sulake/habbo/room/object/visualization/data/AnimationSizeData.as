   ...
   public class AnimationSizeData extends SizeData
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_292 != null)
         {
            ...
            {
               _loc2_ = this.var_292.getWithIndex(_loc1_) as AnimationData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineAnimations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_292.add(_loc6_,_loc8_);
            _loc4_++;
         }
         return true;
      }
      ...
      {
         if(this.var_292.getValue(param1) != null)
         {
            return true;
         }
         return false;
      ...
      {
         var _loc3_:AnimationData = this.var_292.getValue(param1) as AnimationData;
         if(_loc3_ != null)
         {
      ...
      {
         var _loc6_:* = null;
         var _loc5_:AnimationData = this.var_292.getValue(param1) as AnimationData;
         if(_loc5_ != null)
         {
      ...
      {
         var _loc8_:* = null;
         var _loc7_:AnimationData = this.var_292.getValue(param1) as AnimationData;
         if(_loc7_ != null)
         {
