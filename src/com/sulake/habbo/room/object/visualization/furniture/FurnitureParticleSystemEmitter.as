package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1667:String = "cone";
      
      public static const const_1486:String = "plane";
      
      public static const const_1616:String = "sphere";
       
      
      private var _name:String;
      
      private var var_2796:int = -1;
      
      private var var_2795:Number;
      
      private var _direction:Vector3D;
      
      private var var_1031:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_1032 = 0;
         this.var_1046 = false;
         this.init(0,0,0,this._direction,this.var_2795,this.var_1031,this.var_2797,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1269.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_1046 = true;
         if(this.var_1032 < this.var_1551)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2798)
         {
            switch(this.var_2794)
            {
               case const_1667:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_1031,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1269.length);
         return this.var_1269[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1032 < this.var_1551)
         {
            if(this.age % this.var_2799 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1032 < this.var_1551)
         {
            ...
            this.y = (2 - this.var_280) * this.y - (1 - this.var_280) * this.lastY + this.var_2012 * this.var_1031 * this.var_1031;
         ...
         for each(_loc2_ in this.var_389)
         {
            ...
            _loc2_.y = (2 - this.var_280) * _loc2_.y - (1 - this.var_280) * _loc2_.lastY + this.var_2012 * this.var_1031 * this.var_1031;
