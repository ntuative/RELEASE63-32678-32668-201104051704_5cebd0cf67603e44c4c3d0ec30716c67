package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1375:String = "shore";
       
      
      private var var_1943:Boolean = true;
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1222)
            {
      ...
      {
         if(this.var_2680 == param1 && this.var_2681 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1375)
            {
               this.var_1942 = _loc2_;
               this.var_2680 = param1;
               this.var_2681 = direction;
               return this.var_1942;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1222.indexOf(_loc2_) < 0)
            {
               this.var_1222.push(_loc2_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_1943 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_455.length)
         {
            if(this.var_455[_loc5_] == true)
            {
               this.var_1943 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_658[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_658[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_535 == 0 || this.var_657 == 0)
         {
            ...
            this.var_535 = _loc2_.getNumber(RoomObjectVariableEnum.const_296);
            this.var_657 = _loc2_.getNumber(RoomObjectVariableEnum.const_399);
         }
         this.var_455 = [];
         this.var_658 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_535 * 2 + this.var_657 * 2)
         {
            this.var_455.push(false);
            this.var_658.push(ShoreMaskCreatorUtility.const_76);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_72,getSize(param3),this.var_455,this.var_658,assetCollection);
      }
