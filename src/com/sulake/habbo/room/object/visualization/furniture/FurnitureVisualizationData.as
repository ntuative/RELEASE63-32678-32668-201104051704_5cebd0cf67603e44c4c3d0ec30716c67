package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      public static const const_372:int = 1000;
      
      public static const const_523:Array = new Array("a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z");
      ...
      private var var_1019:SizeData = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_324 != null)
         {
            ...
            {
               _loc1_ = this.var_324.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(this.var_324.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            this.var_324.add(String(_loc6_),_loc9_);
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         if(_loc2_ < this._sizes.length)
         {
            this.var_1019 = this.var_324.getValue(String(this._sizes[_loc2_])) as SizeData;
         }
         else
         {
            this.var_1019 = null;
