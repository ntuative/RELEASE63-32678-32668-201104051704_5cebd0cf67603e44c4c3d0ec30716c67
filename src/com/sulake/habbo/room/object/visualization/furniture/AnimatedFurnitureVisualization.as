   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  if(this.usesAnimationResetting())
                  {
                     ...
                     if(_loc4_ > this.var_1704)
                     {
                        this.var_1704 = _loc4_;
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               if(!this._animationData.isImmediateChange(this.var_908,param2,_loc5_))
               {
                  _loc6_ = AnimationData.getTransitionFromAnimationId(_loc5_);
                  if(this._animationData.hasAnimation(this.var_908,_loc6_))
                  {
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_112 != null)
         {
            this.var_112.setLayerCount(this.var_595);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         {
            this.var_908 = param1;
            this.var_595 = this._animationData.getLayerCount(param1);
      ...
      {
         var _loc2_:int = 0;
         if(!this.var_112.animationOver || this.var_909)
         {
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : int
      {
         ...
         var _loc11_:* = null;
         var _loc12_:int = 0;
         if(param1.animationOver && !this.var_909)
         {
            return 0;
         }
         ...
         var _loc7_:* = 1 << this.var_595 - 1;
         var _loc8_:int = this.var_595 - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = param1.getAnimationPlayed(_loc8_);
            if(!_loc9_ || this.var_909)
            {
               ...
               if(this.var_909 || _loc11_ == null || _loc11_.remainingFrameRepeats >= 0 && _loc13_ <= 0)
               {
                  _loc12_ = 0;
                  if(_loc11_ != null)
                  {
                  ...
                  if(_loc12_ == AnimationFrame.const_1065)
                  {
               ...
               if(_loc11_ == null || _loc11_.remainingFrameRepeats == AnimationFrame.const_472)
               {
                  _loc10_ = true;
                  _loc9_ = true;
               }
