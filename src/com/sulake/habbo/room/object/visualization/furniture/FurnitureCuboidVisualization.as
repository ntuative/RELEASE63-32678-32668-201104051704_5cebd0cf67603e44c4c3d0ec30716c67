   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_127 != null)
         {
            ...
            {
               _loc2_ = this.var_127[_loc1_] as FurniturePlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_399);
         var _loc5_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_693);
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:int) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < this.var_127.length)
         {
            _loc6_ = false;
            ...
            _loc9_ = this.var_127[_loc5_] as FurniturePlane;
            if(_loc9_ != null)
            {
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc6_)
               {
                  _loc10_.assetName = _loc7_ + "_" + _loc3_.getInstanceId() + "_" + this.var_1743;
               }
