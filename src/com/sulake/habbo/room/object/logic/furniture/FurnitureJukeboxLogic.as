package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_478,RoomObjectFurnitureActionEvent.const_531,RoomObjectFurnitureActionEvent.const_495,RoomObjectFurnitureActionEvent.const_491,RoomObjectWidgetRequestEvent.const_146];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_468,RoomWidgetInfostandExtraParamEnum.const_896);
            ...
            if(_loc4_ != this.var_2444)
            {
               this.var_2444 = _loc4_;
               if(_loc4_ == 1)
               {
      ...
      private function requestInit() : void
      {
         ...
         this.var_1789 = true;
         var _loc1_:RoomObjectFurnitureActionEvent = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_491,object.getId(),object.getType());
