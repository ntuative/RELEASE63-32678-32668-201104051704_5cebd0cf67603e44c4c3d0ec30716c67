package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureTeaserLogic extends FurnitureLogic
   {
      ...
      private const const_2001:String = "TYPE_INJECTED";
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_TEASER,RoomObjectFurnitureActionEvent.const_447];
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         else if(param1.type == MouseEvent.DOUBLE_CLICK)
         {
            if(eventDispatcher != null)
            {
               _loc7_ = object.getId();
               _loc8_ = object.getType();
               _loc9_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_447,_loc7_,_loc8_);
               eventDispatcher.dispatchEvent(_loc9_);
            }
         }
