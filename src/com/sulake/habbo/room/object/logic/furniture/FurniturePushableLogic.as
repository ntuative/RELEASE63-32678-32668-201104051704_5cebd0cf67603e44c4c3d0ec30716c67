package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_1733:int = 1;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(_loc3_.state > 0)
            {
               moveUpdateInterval = const_666 / this.getUpdateIntervalValue(_loc3_.state);
            }
            else
            {
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            this.var_1729.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),this.var_1729).length == 0)
            {
