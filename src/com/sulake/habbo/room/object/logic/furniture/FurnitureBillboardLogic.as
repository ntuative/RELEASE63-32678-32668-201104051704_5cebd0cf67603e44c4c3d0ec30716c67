   ...
   public class FurnitureBillboardLogic extends FurnitureLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1 is RoomObjectRoomAdUpdateMessage)
         {
            ...
            switch(_loc2_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1135:
                  object.getModelController().setString(RoomObjectVariableEnum.const_521,"true");
                  _loc3_ = true;
                  break;
               case RoomObjectRoomAdUpdateMessage.const_1208:
                  object.getModelController().setString(RoomObjectVariableEnum.const_521,"error");
                  Logger.log("failed to load billboard image from url " + object.getModelController().getString(RoomObjectVariableEnum.const_928));
            }
            if(_loc3_)
            {
               object.setDirty();
         ...
         if(object != null)
         {
            ...
            if(_loc1_ != null)
            {
               ...
               if(_loc2_ != null && _loc2_.length >= 2)
               {
                  _loc3_ = _loc2_[0];
                  _loc4_ = _loc2_[1];
                  object.getModelController().setString(RoomObjectVariableEnum.const_928,_loc3_);
                  object.getModelController().setString(RoomObjectVariableEnum.FURNITURE_BILLBOARD_CLICK_URL,_loc4_);
                  object.getModelController().setString(RoomObjectVariableEnum.const_521,"loading");
