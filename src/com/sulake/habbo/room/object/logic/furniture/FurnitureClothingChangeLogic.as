package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureClothingChangeLogic extends FurnitureLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_128];
      ...
      private function updateClothingData(param1:String) : void
      {
         ...
         if(param1 != null && param1.length > 0)
         {
            ...
            if(_loc2_.length > 0)
            {
               object.getModelController().setString(RoomObjectVariableEnum.const_1175,_loc2_[0]);
            }
            if(_loc2_.length > 1)
            {
               object.getModelController().setString(RoomObjectVariableEnum.const_1211,_loc2_[1]);
            }
         }
      }
