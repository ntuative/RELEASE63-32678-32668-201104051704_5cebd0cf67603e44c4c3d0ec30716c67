package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureStickieLogic extends FurnitureLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_130,RoomObjectFurnitureActionEvent.const_542];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         {
            _loc2_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_130,object.getId(),object.getType());
            if(_loc2_ != null)
            {
      ...
      private function setColorIndexFromItemData() : void
      {
         ...
         if(object != null)
         {
            ...
            object.getModelController().setNumber(RoomObjectVariableEnum.const_262,_loc3_ + 1);
         }
      }
         ...
         switch(param1.type)
         {
            case MouseEvent.DOUBLE_CLICK:
               if(eventDispatcher != null)
               {
                  ...
                  _loc5_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_542,_loc3_,_loc4_);
                  if(_loc5_ != null)
                  {
