package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      private static const const_1258:String = "goawaybus";
      
      private static const const_1259:String = "bus";
      
      private static const const_1257:String = "bus_oviopen_hidden";
      ...
      {
         var _loc1_:Array = [RoomObjectRoomActionEvent.const_584,RoomObjectRoomActionEvent.const_539];
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               switch(_loc3_.spriteTag)
               {
                  ...
                  case const_1259:
                  case const_1257:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_539,0,_loc4_,_loc5_);
               }
         }
