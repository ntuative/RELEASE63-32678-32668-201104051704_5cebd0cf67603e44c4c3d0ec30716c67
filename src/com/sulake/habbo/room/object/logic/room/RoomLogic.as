package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1810:int = 255;
      
      private var var_1447:uint = 16777215;
      
      private var var_1811:int = 255;
      
      private var var_1167:uint = 16777215;
      
      private var var_1812:int = 255;
      
      private var var_1168:int = 0;
      
      private var var_1809:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_444,RoomObjectMouseEvent.const_132];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_714,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_718,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_779,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_645,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1168)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1810;
            if(_loc2_ - this.var_1168 >= this.var_1809)
            {
               _loc3_ = this.var_1167;
               _loc4_ = this.var_1812;
               this.var_1168 = 0;
            }
            else
            {
               _loc7_ = this.var_1447 >> 16 & 255;
               _loc8_ = this.var_1447 >> 8 & 255;
               _loc9_ = this.var_1447 & 255;
               _loc10_ = this.var_1167 >> 16 & 255;
               _loc11_ = this.var_1167 >> 8 & 255;
               _loc12_ = this.var_1167 & 255;
               _loc13_ = (_loc2_ - this.var_1168) / this.var_1809;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1811 + (this.var_1812 - this.var_1811) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_714,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_857:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_852:
               param2.setString(RoomObjectVariableEnum.const_324,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_723:
               param2.setString(RoomObjectVariableEnum.const_330,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_580:
               _loc5_ = "null";
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_697:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1053,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1161:
               param2.setNumber(RoomObjectVariableEnum.const_718,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1064:
               param2.setNumber(RoomObjectVariableEnum.const_779,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_645,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1113,int(param1.bgOnly));
         this.var_1447 = this._color;
         this.var_1811 = this.var_1810;
         this.var_1167 = _loc3_;
         this.var_1812 = _loc4_;
         this.var_1168 = getTimer();
         this.var_1809 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_568,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1597,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1508,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1442,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_568,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_167 || _loc12_ == RoomPlaneData.const_290)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
