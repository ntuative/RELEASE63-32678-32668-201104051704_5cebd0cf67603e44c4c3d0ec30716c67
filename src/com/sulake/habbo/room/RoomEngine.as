package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_637:String = "temporary_room";
      ...
      private static const const_1404:String = "tile_cursor";
      
      private static const const_1009:int = -3;
      
      private static const const_1403:String = "selection_arrow";
      
      private static const OVERLAY_SPRITE:String = "overlay";
      
      private static const const_356:String = "object_icon_sprite";
      
      private static const const_442:int = 15;
      
      private static const const_1008:int = 40;
      ...
      private var var_1036:RoomMessageHandler = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_1036 = new RoomMessageHandler(this);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1038.release(new IIDRoomRendererFactory());
            this.var_1038 = null;
         }
         ...
         if(this.var_321)
         {
            this.var_321.release(new IIDHabboAdManager());
            this.var_321 = null;
         }
         ...
         if(this.var_330 != null)
         {
            ...
            {
               _loc2_ = this.var_330.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         var _loc4_:RoomInstanceData = this.var_330.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            this.var_330.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            _loc2_ = this._roomManager.getRoom(this.getRoomIdentifier(this.var_99,this.var_98));
      ...
      private function addBtnMouseCursorOwner(param1:int, param2:int) : void
      {
         ...
         if(param1 == RoomObjectCategoryEnum.const_28)
         {
            param2 *= -1;
         }
         var _loc3_:int = this.var_554.indexOf(param2);
         if(_loc3_ == -1)
         {
            this.var_554.push(param2);
            this.var_1272 = true;
         }
      }
      ...
      private function createRoomFurniture() : void
      {
         ...
         do
         {
            for each(_loc4_ in _loc8_)
            {
               ...
               while(!this.var_1037 && (_loc6_ = _loc4_.getWallItemData()) != null)
               {
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_330.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  if(_loc5_ != this.var_99 || _loc6_ != this.var_98 || !this.var_1271)
                  {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               if(_loc9_.screenWd != _loc13_ || _loc9_.screenHt != _loc14_ || _loc9_.scale != _loc8_.scale || _loc9_.geometryUpdateId != _loc8_.updateId || !Vector3d.isEqual(param4,_loc9_.targetObjectLoc) || _loc9_.isMoving)
               {
                  ...
                  _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_799) - 0.5;
                  _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_927) - 0.5;
                  _loc18_ = _loc10_.getNumber(RoomVariableEnum.const_704) + 0.5;
                  _loc19_ = _loc10_.getNumber(RoomVariableEnum.const_887) + 0.5;
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1038 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_1036 != null)
            {
               this.var_1036.connection = param1;
            }
         }
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            events.addEventListener(RoomContentLoader.const_783,this.onContentLoaderReady);
            this.var_13.initialize(events,this.var_165);
         }
         this.var_2807 = this.var_165.getKey("room.dragging.always_center","0") == "1";
         this.initializeRoomManager();
      }
      
      private function onContentLoaderReady(param1:Event) : void
      {
         if(param1 != null && param1.type == RoomContentLoader.const_783)
         {
            this.var_2806 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_321 = param2 as IAdManager;
         this.var_321.events.addEventListener(AdEvent.const_452,this.showRoomAd);
         this.var_321.events.addEventListener(AdEvent.const_705,this.onRoomAdImageLoaded);
         this.var_321.events.addEventListener(AdEvent.const_840,this.onRoomAdImageLoaded);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_13.sessionDataManager = this.var_305;
      }
      ...
      {
         if(this.var_836 == null || this.var_514 == null || this._roomManager == null || this.var_1038 == null || this._communication == null || this.var_165 == null || !this.var_2806)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_553 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_759,0,0));
            _loc2_ = 0;
            while(_loc2_ < this.var_392.length)
            {
               _loc3_ = this.var_392.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1214,_loc5_);
            if(_loc5_ == 0)
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_492,param1,param2));
            }
            else
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_476,param1,param2));
            }
         }
      }
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1214);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_553)
         {
            _loc5_ = this.var_392.remove(_loc4_);
            if(_loc5_ != null)
            {
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_357,_loc11_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1054,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_807,1,true);
            _loc12_ = parseInt(this.var_165.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1127,_loc12_,true);
            if(this.var_13 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_357,const_636,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_807,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_719,_loc10_,true);
         if(param2 != null)
         {
            _loc13_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_799,_loc15_);
               _loc7_.setNumber(RoomVariableEnum.const_704,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_927,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_887,_loc18_);
               _loc13_ += _loc15_ * 423 + _loc16_ * 671 + _loc17_ * 913 + _loc18_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1236,_loc13_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         {
            ...
            if(param3 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_857,param3);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_298,param3);
            }
            if(param4 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_852,param4);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_324,param4);
            }
            if(param5 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_723,param5);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_330,param5);
            }
            if(param2 != null)
            {
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc23_ < _loc20_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                     {
                        ...
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_580,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_247);
                        _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                        if(_loc28_ == 90 || _loc28_ == 180)
                        {
                           if(_loc28_ == 90)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_778,_loc25_ - 0.5,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_863,_loc26_,true);
                           }
                           if(_loc28_ == 180)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_778,_loc25_,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_863,_loc26_ - 0.5,true);
                           }
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1040,_loc27_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1216,_loc28_,true);
                        }
                     }
                     _loc23_++;
                  }
         ...
         _loc7_.createRoomObject(const_1010,const_1404,RoomObjectCategoryEnum.const_341);
         if(this.var_165.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_1009,const_1403,RoomObjectCategoryEnum.const_341);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_357,RoomObjectCategoryEnum.const_77);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc10_ = this.var_392.getValue(_loc9_);
            if(_loc10_ == null)
            {
               _loc10_ = new RoomData(param1,param2,null);
               this.var_392.add(_loc9_,_loc10_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            ...
            _loc8_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_857,param3);
         ...
         if(param4 != null)
         {
            ...
            _loc8_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_852,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc8_);
         }
         if(param5 != null)
         {
            ...
            _loc8_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_723,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc8_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1510,param3,param4,param5);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1064,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1161,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_330.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_302,param1,param2));
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_1038.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1059;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_719);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_778);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_863);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1040);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1216);
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         var _loc9_:int = param3 - this.var_1554;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1271 = true;
               this.var_838 = false;
               this.var_2808 = this.var_1555;
               this.var_2805 = this.var_1554;
            }
         }
         else if(param4 == MouseEvent.MOUSE_UP)
         {
            if(this.var_1271)
            {
               ...
               if(this.var_838)
               {
                  _loc10_ = this.getRoomInstanceData(this.var_99,this.var_98);
                  if(_loc10_ != null)
                  {
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1271)
            {
               if(!this.var_838)
               {
                  _loc8_ = param2 - this.var_2808;
                  _loc9_ = param3 - this.var_2805;
                  if(_loc8_ <= -const_442 || _loc8_ >= const_442 || _loc9_ <= -const_442 || _loc9_ >= const_442)
                  {
                     this.var_838 = true;
                  }
                  _loc8_ = 0;
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_99,this.var_98,param1);
         if(_loc9_ != null)
         {
            _loc10_ = this.getOverlaySprite(_loc9_);
            _loc11_ = this.getOverlayIconSprite(_loc10_,const_356);
            if(_loc11_ != null)
            {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_505,this.var_99,this.var_98,-1,RoomObjectCategoryEnum.const_171));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_78 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_357,const_636);
                     this.var_78.handleRoomObjectEvent(_loc14_,this.var_99,this.var_98);
                  }
               }
            }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc5_ = this.getRoomObjectImage(this.var_99,this.var_98,param1,param2,new Vector3d(),1,null);
         }
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_99,this.var_98,this.var_1553);
         if(_loc6_ != null)
         {
            _loc9_ = this.getOverlaySprite(_loc6_);
            this.removeOverlayIconSprite(_loc9_,const_356);
            _loc10_ = this.addOverlayIconSprite(_loc9_,const_356,_loc5_.data);
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1555 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1554 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_99,this.var_98,this.var_1553);
         if(_loc2_ != null)
         {
            _loc3_ = this.getOverlaySprite(_loc2_);
            _loc4_ = this.getOverlayIconSprite(_loc3_,const_356);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_99,this.var_98,this.var_1553);
         if(_loc1_ != null)
         {
            _loc2_ = this.getOverlaySprite(_loc1_);
            this.removeOverlayIconSprite(_loc2_,const_356);
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_78 != null)
         {
            return this.var_78.modifyRoomObject(this.var_99,this.var_98,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_78 != null)
         {
            ...
            {
               return this.var_78.modifyWallItemData(this.var_99,this.var_98,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_78 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return this.var_78.deleteWallItem(this.var_99,this.var_98,param1);
            }
         }
         return false;
      }
      ...
      {
         var _loc5_:IRoomInstance = this.getRoom(this.var_99,this.var_98);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_807) != 0)
         {
            return false;
         }
         if(this.var_78 != null)
         {
            return this.var_78.initializeRoomObjectInsert(this.var_99,this.var_98,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_78 != null)
         {
            this.var_78.cancelRoomObjectInsert(this.var_99,this.var_98);
         }
      }
      ...
      public function getRoomObjectCategory(param1:String) : int
      {
         ...
         return RoomObjectCategoryEnum.const_171;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1009,RoomObjectCategoryEnum.const_341);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1010,RoomObjectCategoryEnum.const_341);
      }
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_262,_loc7_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_322,param4.typeId,true);
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_408,_loc8_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_889,1,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1111,param4.expiryTime);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1179,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_361,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
      ...
      public function disposeObjectFurniture(param1:int, param2:int, param3:int) : void
      {
         ...
         this.removeBtnMouseCursorOwner(RoomObjectCategoryEnum.const_28,param3);
      }
      ...
      private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_262,_loc6_,false);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_322,param4.typeId,true);
            _loc8_.getModelController().setString(RoomObjectVariableEnum.const_408,_loc7_,true);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1059,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_361,param1,param2,param3,RoomObjectCategoryEnum.const_26));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1074) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1066);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_580,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_697,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_361,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
         return true;
      }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_886,this.var_99,this.var_98,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_78 != null)
         {
            this.var_78.handleRoomObjectEvent(param1,this.var_99,this.var_98);
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_26:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_262));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_314);
                     break;
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               _loc8_.addPlane(RoomPlaneData.const_200,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
               ...
               _loc8_.addPlane(RoomPlaneData.const_290,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
               _loc9_ = _loc8_.getXML();
               param1.getEventHandler().initialize(_loc9_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_298,_loc4_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_324,_loc5_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_330,_loc6_);
               if(_loc7_ != null)
               {
                  _loc10_ = null;
                  _loc11_ = "undefined_1";
                  _loc10_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_580,_loc11_,_loc7_,new Vector3d(2,0,1.75));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         var _loc11_:IRoomInstance = this._roomManager.getRoom(const_637);
         if(_loc11_ == null)
         {
            _loc11_ = this._roomManager.createRoom(const_637,null);
            if(_loc11_ == null)
            {
               return _loc10_;
            }
         ...
         switch(_loc13_)
         {
            case RoomObjectCategoryEnum.const_28:
            case RoomObjectCategoryEnum.const_26:
               _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_262,int(param2));
               _loc14_.getModelController().setString(RoomObjectVariableEnum.const_314,param7);
               break;
            case RoomObjectCategoryEnum.const_34:
               ...
               {
                  _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_856,int(param2));
               }
               break;
         ...
         {
            this.var_1270.add(String(_loc12_),param5);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1092,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_99,this.var_98,const_357,RoomObjectCategoryEnum.const_77,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this._roomManager.getRoom(const_637);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1092);
               ...
               _loc13_ = this.var_1270.remove(String(_loc10_)) as IGetImageListener;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1107,param1.adWarningL,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1195,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1141,RoomObjectVariableEnum.const_386,param1.clickUrl);
      ...
      public function requestRoomAdImage(param1:int, param2:int, param3:String, param4:String) : void
      {
         ...
         {
            this.var_321.loadRoomAdImage(param1,param2,param3,param4);
         }
      }
      ...
      private function onRoomAdImageLoaded(param1:AdEvent) : void
      {
         ...
         switch(param1.type)
         {
            case AdEvent.const_705:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1135,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
               break;
            case AdEvent.const_840:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1208,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
         }
         if(_loc4_ != null)
         {
            _loc3_.getEventHandler().processUpdateMessage(_loc4_);
