package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_707,param1,param2,param3,param4));
         }
      }
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_97:
               ...
               break;
            case RoomObjectStateChangeEvent.const_708:
            ...
            case RoomObjectDimmerStateUpdateEvent.const_64:
               ...
               break;
            case RoomObjectMoveEvent.const_358:
               this.handleSelectedObjectMove(param1,param2,param3);
               break;
            case RoomObjectMoveEvent.const_919:
            ...
            case RoomObjectFurnitureActionEvent.const_589:
               ...
               break;
            case RoomObjectFurnitureActionEvent.const_491:
            ...
            case RoomObjectRoomAdEvent.const_603:
            ...
            case RoomObjectRoomActionEvent.const_1478:
            case RoomObjectRoomActionEvent.const_539:
      ...
      private function handleRoomObjectMouseEvent(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         switch(param1.type)
         {
            case RoomObjectMouseEvent.const_132:
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               ...
               else
               {
                  ...
                  if(_loc10_ != null)
                  {
                     ...
                     if(_loc13_)
                     {
                        this.setMouseEventId(RoomObjectCategoryEnum.const_171,MouseEvent.CLICK,_loc10_);
                     }
                  }
               }
         }
         if(_loc8_ == RoomObjectCategoryEnum.const_77)
         {
            _loc14_ = this.getMouseEventId(RoomObjectCategoryEnum.const_171,MouseEvent.CLICK);
            ...
            if(_loc14_ != _loc10_ && _loc15_ != _loc10_)
            {
               ...
               if(_loc16_ != null)
               {
                  _loc16_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_505,param2,param3,-1,RoomObjectCategoryEnum.const_171));
               }
      ...
      private function handleRoomObjectMouseMove(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(this._roomEngine != null)
         {
            ...
            if(_loc8_ != null && _loc8_.getEventHandler() != null)
            {
               ...
               {
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_481);
               }
               _loc8_.getEventHandler().processUpdateMessage(_loc10_);
            }
         }
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.const_28 || _loc8_ == RoomObjectCategoryEnum.const_26)
               {
                  if(param1.altKey)
                  {
                     ...
                     if(_loc10_ != null)
                     {
                        _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_682,param2,param3,_loc6_,_loc8_));
                     }
                  }
               }
         }
         ...
         if(_loc6_ == null)
         {
            ...
            if(_loc6_ != null)
            {
               if(_loc5_.category == RoomObjectCategoryEnum.const_28)
               {
                  ...
                  {
                     _loc9_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_744);
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_554:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_817,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_544:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_920,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_577:
               ...
               break;
            case RoomObjectFurnitureActionEvent.const_589:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_674,param2,param3,param1.objectId,_loc4_));
         }
      }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_491:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_733,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_478:
               ...
               break;
            case RoomObjectFurnitureActionEvent.const_531:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_735,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_495:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_371,param2,param3,param1.objectId,_loc4_));
         }
      }
      ...
      private function validateFurnitureDirection(param1:IRoomObject, param2:IVector3d, param3:TileHeightMap) : Boolean
      {
         ...
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_399);
         if(_loc6_ < 1)
         {
            _loc6_ = 1;
         }
      ...
      private function validateFurnitureLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:TileHeightMap) : Vector3d
      {
         ...
         var _loc8_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_399);
         if(_loc7_ < 1)
         {
            _loc7_ = 1;
         }
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_693);
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_1063);
      ...
      private function setObjectAlphaMultiplier(param1:IRoomObjectController, param2:Number) : void
      {
         ...
         {
            param1.getModelController().setNumber(RoomObjectVariableEnum.const_332,param2);
         }
      }
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = this._roomEngine.getRoomObject(roomId,roomCategory,this.var_1560,category) as IRoomObjectController;
         ...
         if(selectionArrow != null && selectionArrow.getEventHandler() != null)
         {
            ...
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_481));
            }
         }
      }
      ...
      private function getValidFurnitureDirection(param1:IRoomObjectController, param2:Boolean) : int
      {
         ...
         {
            _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.const_744);
         }
      ...
      private function placeObject(param1:int, param2:int) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.connection != null)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_34 && _loc3_.typeId == RoomObjectTypeEnum.const_183)
               {
