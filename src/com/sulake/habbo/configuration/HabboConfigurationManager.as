package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_642 = this.getKey("url_prefix");
         if(this.var_642 != null && this.var_642.length > 0)
         {
            this.setKey("client.fatal.error.url",this.var_642 + "/flash_client_error");
         }
         this.init();
      }
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. URL " + this.getKey("external.variables.txt") + "HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1565);
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         this.var_642 = this.getKey("url.prefix");
         if(this.var_642.length > 0)
         {
            externalAccessDomain = this.var_642.replace("http://","");
      ...
      {
         var _loc2_:String = this.var_1182[param1] as String;
         return _loc2_ != null;
      }
      
      public function getKey(param1:String, param2:String = "", param3:Dictionary = null) : String
      {
         var _loc4_:String = this.var_1182[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",this.var_642);
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false, param4:Boolean = false) : void
      {
         if(param4)
         {
            if(this.var_1182[param1] == null)
            {
               Logger.log(param1 + "=" + param2);
            }
         }
         if(this.var_1849.indexOf(param1) < 0 || param3)
         {
            this.var_1182[param1] = param2;
         }
         if(param3)
         {
            this.var_1849.push(param1);
         }
      }
