package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_432:uint = 3;
      ...
      private var var_1623:ProfilerOutput;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_879 = new SkinContainer(_loc4_.content as XML,assets);
         this._windowRenderer = new WindowRenderer(this.var_879);
         this._windowContextArray = new Array(const_432);
         ...
         this.var_279 = this._windowContextArray[const_1252];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1623)
            {
               this.var_1623 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1623.profiler = _loc3_;
            ...
            this.var_1347 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1347);
            this.var_1084 = true;
         }
      }
      ...
      {
         return this.var_279.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_279.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this.var_879.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this._windowContextArray[param1].getDesktopWindow().getChildAt(this.var_279.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_401.length > 0)
         {
            this.var_1346.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_432 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1346.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_432)
         {
         ...
         if(WindowContext.var_401.length > 0)
         {
            WindowContext.var_401.flush();
         }
         MouseCursorControl.change();
         this.var_1346.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1426,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1564,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1682,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1568,param2.name + ": " + param2.toString());
            }
         }
      }
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.test({
            "type":WindowType.const_482,
            "style":WindowStyle.const_185,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
