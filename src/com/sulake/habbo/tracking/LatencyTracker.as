package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1691 = int(this.var_179.getKey("latencytest.interval"));
         this.var_1693 = int(this.var_179.getKey("latencytest.report.index"));
         this.var_2263 = int(this.var_179.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1694 > this.var_1691)
         {
            this.testLatency();
         }
      }
      ...
      {
         this.var_1694 = getTimer();
         this.var_598.add(this.var_1388,this.var_1694);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1388));
         ++this.var_1388;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_598 == null || this.var_222 == null)
         {
            return;
         }
         var _loc2_:LatencyPingResponseMessageParser = (param1 as LatencyPingResponseMessageEvent).getParser();
         var _loc3_:int = this.var_598.getValue(_loc2_.requestId);
         this.var_598.remove(_loc2_.requestId);
         var _loc4_:int = getTimer() - _loc3_;
         this.var_222.push(_loc4_);
         if(this.var_222.length == this.var_1693 && this.var_1693 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1692) > this.var_2263 || this.var_1692 == 0)
            {
               this.var_1692 = _loc9_;
