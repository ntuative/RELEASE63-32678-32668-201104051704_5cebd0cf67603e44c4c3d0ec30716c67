package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_937:uint = 11;
      ...
      private var var_1082:IHabboWindowManager;
      ...
      private var var_412:FramerateTracker = null;
      
      private var var_244:LatencyTracker = null;
      
      private var var_586:LagWarningLogger = null;
      
      private var var_585:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_245 = new PerformanceTracker();
         this.var_412 = new FramerateTracker();
         this.var_244 = new LatencyTracker();
         this.var_586 = new LagWarningLogger();
         this.var_585 = new ToolbarClickTracker(this);
         this.var_1341 = new Array(const_937);
         var _loc4_:int = 0;
         while(_loc4_ < const_937)
         {
            this.var_1341[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1434,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1558,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1476,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_669,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1164,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1082)
            {
               this.var_1082.release(new IIDHabboWindowManager());
               this.var_1082 = null;
            }
            if(this.var_321)
            {
            ...
            if(this.var_197)
            {
               if(!this.var_197.disposed)
               {
                  ...
                  Component(this.var_197).events.removeEventListener(HabboFriendListTrackingEvent.const_410,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_159)
            {
               if(!this.var_159.disposed)
               {
                  this.var_159.events.removeEventListener(HabboToolbarEvent.const_36,this.onToolbarClick);
               }
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_302,this.onRoomAction);
               }
            ...
            {
               this.var_293.stop();
               this.var_293.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_293 = null;
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_179)
         {
            if(this.var_244 != null)
            {
               this.var_244.configuration = this.var_179;
            }
            if(this.var_245 != null)
            {
               this.var_245.configuration = this.var_179;
            }
            ...
            if(this.var_179)
            {
               ...
               {
                  this.var_586.configure(this.var_179);
               }
               if(this.var_412 != null)
               {
                  this.var_412.configure(this.var_179);
               }
               if(this.var_585 != null)
               {
                  this.var_585.configure(this.var_179);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_179,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_260,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_808,this.onHotelViewEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_245 != null)
            {
               this.var_245.connection = param1;
            }
            if(this.var_244 != null)
            {
            ...
            if(this.var_586 != null)
            {
               this.var_586.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_808)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1669);
         }
         else if(param1.type == HabboHotelViewEvent.const_566)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1501);
         }
         else if(param1.type == HabboHotelViewEvent.const_73)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1648);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1432);
               break;
            case HabboCommunicationEvent.const_874:
               this.trackLoginStep(HabboLoginTrackingStep.const_1631,String(this._communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_179:
               this.trackLoginStep(HabboLoginTrackingStep.const_179);
               break;
      ...
      {
         this.var_1082 = IHabboWindowManager(param2);
         if(this.var_1082)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_179)
            {
               if(this.var_179.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1341)
                  {
                  ...
                  if(this.var_245 != null)
                  {
                     _loc4_["null"] = this.var_245.flashVersion;
                     _loc4_["null"] = this.var_245.averageUpdateInterval;
                  }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_197).events.addEventListener(HabboFriendListTrackingEvent.const_410,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_410:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1164,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_669,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_302,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_321 = param2 as IAdManager;
         this.var_321.events.addEventListener(AdEvent.const_452,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_159 = param2 as IHabboToolbar;
         this.var_159.events.addEventListener(HabboToolbarEvent.const_36,this.onToolbarClick);
      }
      ...
      private function onRoomAction(param1:RoomEngineEvent) : void
      {
         if(param1.type == RoomEngineEvent.const_328)
         {
            if(this.var_1616 < 1)
            {
               if(!this.var_293)
               {
                  this.var_293 = new Timer(60000,1);
                  this.var_293.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_293.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_302)
         {
            if(this.var_293)
            {
               this.var_293.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_412)
               {
                  ...
                  this._connection.send(new ConversionPointMessageComposer("Performance","fps",String(this.var_412.frameRate),_loc2_));
                  ++this.var_1616;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_585)
         {
            this.var_585.track(param1.iconName);
         }
      }
      ...
      {
         this.var_586.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1617;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1617);
         }
         if(this.var_483 > -1 && _loc2_ - this.var_483 > 15000)
         {
            ++this.var_1615;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1615);
         }
         this.var_483 = _loc2_;
         if(this.var_245 != null)
         {
            this.var_245.update(param1,this.var_483);
         }
         if(this.var_244 != null)
         {
         ...
         if(this.var_412 != null)
         {
            this.var_412.trackUpdate(param1,this,this.var_483);
         }
         if(this.var_586 != null)
         {
            this.var_586.update(this.var_483);
         }
      }
   }
}
