package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_973:int = 0;
      
      private static const const_434:int = 1;
      
      private static const const_972:int = 2;
      ...
      {
         return this.var_629 != const_973;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1820 != RecyclerStatusMessageEvent.const_1121;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_629 == const_434;
      }
      ...
      {
         this.var_629 = const_972;
         this.var_117 = new Array(const_194);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1820)
         {
            case RecyclerStatusMessageEvent.const_1447:
               this.var_629 = const_434;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1121:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1636:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1078:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1709:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_117.length < const_194)
         {
            return false;
         }
         var _loc1_:int = 0;
