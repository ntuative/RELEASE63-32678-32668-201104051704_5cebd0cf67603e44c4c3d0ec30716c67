package com.sulake.habbo.catalog.recycler
{
   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      private var var_332:IBitmapWrapperWindow;
      ...
      {
         var _loc8_:* = null;
         this.var_332 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {
      ...
      {
         var _loc3_:* = null;
         if(this.var_332 != null && !this.var_332.disposed)
         {
            if(param1 == null)
            {
            ...
            this.var_332.bitmap = new BitmapData(this.var_332.width,this.var_332.height,true,16777215);
            this.var_332.bitmap.fillRect(this.var_332.bitmap.rect,16777215);
            _loc3_ = new Point((this.var_332.width - param1.width) / 2,(this.var_332.height - param1.height) / 2);
            this.var_332.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         }
