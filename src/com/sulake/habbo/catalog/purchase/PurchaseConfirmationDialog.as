package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1997:int = 10;
      ...
      private const const_1736:uint = 4.293848814E9;
      
      private const const_1735:uint = 4.294967295E9;
      
      private const const_1998:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1620 = _loc1_.stuffTypes;
            this.var_710 = _loc1_.boxTypes;
            this.var_711 = _loc1_.ribbonTypes;
            this.var_1083 = this.var_1620[0];
            this.var_342 = this.var_710[0];
            this.var_341 = this.var_711[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_341 < 0)
         {
            this.var_341 = this.var_711.length - 1;
         }
         if(this.var_341 > this.var_711.length - 1)
         {
            this.var_341 = 0;
         }
         if(this.var_342 < 0)
         {
            this.var_342 = this.var_710.length - 1;
         }
         if(this.var_342 > this.var_710.length - 1)
         {
            this.var_342 = 0;
         }
         var _loc1_:int = this.var_710[this.var_342] * 1000 + this.var_711[this.var_341];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_91.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1083,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1344 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1620;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1083);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_710[this.var_342]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_711[this.var_341]);
         this._catalog.purchaseProductAsGift(this.var_1342,this.var_91,this.var_1343,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1342,this.var_91.offerId,this.var_1343);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_107:
               ...
               if(this.var_2149 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_233)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_1997)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2149 = _loc3_.text;
               break;
            case WindowMouseEvent.const_45:
               ...
               break;
            case WindowKeyboardEvent.const_391:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_587 == null)
         {
            this.var_587 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_587.procedure = this.suggestionsEventHandler;
         }
         if(this.var_246 == null || this.var_587 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_587.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1998;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1736) : uint(this.const_1735);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1083;
               }
            }
            _loc4_++;
         }
