   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1555;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1499;
            }
         }
      }
      ...
      {
         this.var_62 = navigator.catalog.windowManager.buildFromXML(var_1436) as IItemListWindow;
         if(this.var_62 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1437) as IWindowContainer;
         }
         else
         {
