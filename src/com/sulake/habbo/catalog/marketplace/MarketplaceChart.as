package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         {
            if(_loc4_ > this.var_599)
            {
               this.var_599 = _loc4_;
            }
         }
         _loc5_ = Math.pow(10,int(this.var_599).toString().length - 1);
         this.var_599 = Math.ceil(this.var_599 / _loc5_) * _loc5_;
         ...
         _loc6_.text = this.var_599.toString();
         _loc3_.draw(_loc6_);
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_1108,(param2 - this.var_904) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_1108 + this.var_1108 / -this.var_2898 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_904 - this.var_904 / this.var_599 * this.var_152[param1];
      }
