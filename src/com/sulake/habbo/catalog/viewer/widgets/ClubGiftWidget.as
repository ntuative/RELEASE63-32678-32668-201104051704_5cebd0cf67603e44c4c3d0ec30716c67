package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private const const_213:int = 31;
      ...
      private function updateInfo() : void
      {
         ...
         if(_loc5_)
         {
            _loc2_ = this._controller.purse.pastClubDays >= this.const_213 ? "catalog.club_gift.past_club.long" : "catalog.club_gift.past_club";
            _loc3_ = this._controller.purse.pastClubDays % this.const_213;
            _loc4_ = this._controller.purse.pastClubDays / this.const_213;
         ...
         if(_loc6_)
         {
            _loc2_ = this._controller.purse.pastVipDays >= this.const_213 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = this._controller.purse.pastVipDays % this.const_213;
            _loc4_ = this._controller.purse.pastVipDays / this.const_213;
            this._controller.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            this._controller.localization.registerParameter(_loc2_,"months",_loc4_.toString());
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         if(!param2.isSelectable && _loc6_ > 0)
         {
            ...
            if(_loc6_ >= this.const_213)
            {
               _loc7_ += ".long";
            }
            _loc12_ = _loc6_ % this.const_213;
            _loc13_ = _loc6_ / this.const_213;
