package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1740:Point;
      
      private var var_503:IItemGridWindow;
      
      private var var_1417:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_922 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1141 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_86 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1740 = new Point(this.var_86.x,this.var_86.y);
         this.var_503 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1417 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1741 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_503 != null)
         {
            this.var_503.visible = false;
            this.var_503.destroyGridItems();
         }
         ...
         this.var_922.text = _loc4_;
         this.var_1141.text = _loc5_;
         this.var_922.height = this.var_922.textHeight + 5;
         this.var_1141.y = this.var_922.y + this.var_922.height;
         this.var_1141.height = Math.max(130,this.var_1141.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_507:
                  _loc6_ = this.var_1741.clone();
                  if(this.var_503 != null)
                  {
                     this.var_503.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_503,this.var_1417,this.var_1958);
                     this.var_503.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_177:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_345,AvatarAction.const_576);
                              _loc16_.appendAction(AvatarAction.const_295,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2360)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2360 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_86 != null && true)
         {
            ...
            this.var_86.x = this.var_1740.x;
            this.var_86.y = this.var_1740.y;
            if(param3 != null)
            {
