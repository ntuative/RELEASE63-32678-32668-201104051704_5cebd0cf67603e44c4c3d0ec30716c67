package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_371:IGridItem;
      
      private var var_1987:int = 0;
      
      protected var var_205:Timer;
      
      protected var var_208:Boolean = true;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_806,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_197,this.deActivateScrollbar);
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_205.stop();
            this.var_205.removeEventListener(TimerEvent.TIMER,this.populateItemGrid);
            this.var_205 = null;
         }
      ...
      {
         if(param1 > -1 && param1 < this.var_477.numGridItems)
         {
            this.select(this.var_477.getGridItemAt(param1) as IGridItem);
         }
      }
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_507)
         {
            ++this.var_1987;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1987);
         }
      }
