package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_888:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_889.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_889 = null;
         }
         if(this.var_888 != null)
         {
            this.var_888.removeEventListener(WindowKeyboardEvent.const_190,this.windowKeyEventProcessor);
            this.var_888 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_889 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_889 != null)
         {
            this.var_889.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_888 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_888 != null)
         {
            this.var_888.addEventListener(WindowKeyboardEvent.const_190,this.windowKeyEventProcessor);
         }
         return true;
      }
