package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1314:int = 16763904;
      
      private static const const_1315:int = 13421772;
      
      private static const const_1313:int = 13395456;
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(this.var_750);
            if(_loc3_ == null)
            {
      ...
      private function onWidgetsInitialized(param1:CatalogWidgetsInitializedEvent) : void
      {
         ...
         _loc2_.push(const_1314);
         _loc2_.push(const_1315);
         _loc2_.push(const_1313);
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(this.var_750);
            if(_loc3_ == null)
            {
