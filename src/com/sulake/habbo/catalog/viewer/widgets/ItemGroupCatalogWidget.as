package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_231[this.var_651][this.var_795];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_651 = var_477.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_651];
         var _loc3_:Array = this.var_231[this.var_651] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_795 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_795] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_359 || _loc1_.pricingModel == Offer.const_409)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_75 || _loc3_.productType == ProductTypeEnum.const_83)
                  {
