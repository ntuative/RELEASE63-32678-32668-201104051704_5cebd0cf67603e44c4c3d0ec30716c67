package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1717:String = "ctlg_";
       
      
      protected var var_2102:XML;
      ...
      private var var_520:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1171:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_520 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1170);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1170);
      }
      ...
      {
         var _loc2_:String = const_1717 + param1;
         ...
         this.var_2102 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2102) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1456:
               if(this.var_1171 == null)
               {
                  this.var_1171 = new ItemGridCatalogWidget(param1);
                  this.var_37.push(this.var_1171);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1640:
               ...
               break;
            case CatalogWidgetEnum.const_1466:
            ...
            case CatalogWidgetEnum.const_1530:
               ...
               break;
            case CatalogWidgetEnum.const_1657:
            ...
            case CatalogWidgetEnum.const_1618:
               ...
               break;
            case CatalogWidgetEnum.const_1611:
            ...
            case CatalogWidgetEnum.const_1641:
               ...
               break;
            case CatalogWidgetEnum.const_1574:
            ...
            case CatalogWidgetEnum.const_1622:
               ...
               break;
            case CatalogWidgetEnum.const_1575:
            ...
            case CatalogWidgetEnum.const_1658:
               ...
               break;
            case CatalogWidgetEnum.const_1491:
               this.var_37.push(new MarketPlaceCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1659:
            ...
            case CatalogWidgetEnum.const_1484:
               ...
               break;
            case CatalogWidgetEnum.const_1567:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_520.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_520 != null)
         {
            return this.var_520.dispatchEvent(param1);
         }
         return false;
      }
