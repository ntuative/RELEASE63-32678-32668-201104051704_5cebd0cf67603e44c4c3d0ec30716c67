package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1817:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array, param5:int) : void
      {
         ...
         {
            if(this.var_362.pageId == param1)
            {
               if(param5 > -1)
               {
                  this.var_362.selectOffer(param5);
               }
               return;
            }
            this._container.removeChild(this.var_362.window);
            this.var_362.dispose();
         }
         var _loc6_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,this.var_1817);
         this.var_362 = _loc6_;
      ...
      {
         return this.var_362.dispatchWidgetEvent(param1);
      }
      ...
      public function getCurrentLayoutCode() : String
      {
         ...
         return this.var_362.layoutCode;
      }
   }
}
