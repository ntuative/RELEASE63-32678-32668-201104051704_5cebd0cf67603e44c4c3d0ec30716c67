package com.sulake.habbo.widget.friendrequest
{
   ...
   public class FriendRequestDialog
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window.addEventListener(WindowEvent.const_522,this.onDeactivated);
      ...
      public function set targetRect(param1:Rectangle) : void
      {
         ...
         if(!param1)
         {
            this._widget.ignoreRequest(this.var_1210);
            return;
         }
         if(this.var_1918 || this.var_1919)
         {
            return;
         }
      ...
      private function onAccept(param1:WindowMouseEvent) : void
      {
         if(this._widget != null)
         {
            this._widget.acceptRequest(this.var_1210);
         }
      }
      ...
      private function onDecline(param1:WindowMouseEvent) : void
      {
         if(this._widget != null)
         {
            this._widget.declineRequest(this.var_1210);
         }
      }
   }
}
