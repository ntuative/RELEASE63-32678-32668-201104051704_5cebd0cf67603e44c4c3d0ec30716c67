package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_1888 = param1.id;
         this._type = param1.petType;
         this.var_2480 = param1.petRace;
         this.var_46 = param1.image;
         this.var_2485 = param1.isOwnPet;
         this.var_2359 = param1.ownerId;
         this._ownerName = param1.ownerName;
         this._canOwnerBeKicked = param1.canOwnerBeKicked;
         this.var_1364 = param1.level;
         this.var_2484 = param1.levelMax;
         this.var_2483 = param1.experience;
         this.var_2481 = param1.experienceMax;
         this._energy = param1.energy;
         this.var_2482 = param1.energyMax;
         this._nutrition = param1.nutrition;
         this.var_2486 = param1.nutritionMax;
         this._petRespect = param1.petRespect;
         this.var_2201 = param1.roomIndex;
         this.var_492 = param1.age;
      }
   }
}
