package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_52:IBorderWindow;
      ...
      private const const_2032:int = 152;
      
      private const const_2036:int = 16;
      
      private const const_1376:int = 4;
      
      private const const_2025:uint = 14342874;
      
      private const const_2028:uint = 3815994;
      
      private const const_2035:uint = 2085362;
      
      private const const_2027:uint = 39616;
      
      private const const_2026:uint = 10513106;
      
      private const const_2029:uint = 8734654;
      
      private const const_2037:uint = 9094430;
      
      private const const_2030:uint = 6200576;
      
      private const const_2033:String = "happiness";
      
      private const const_2031:String = "experience";
      
      private const const_2034:String = "energy";
      ...
      {
         if(this.var_53 == null || this.var_52 == null || this._buttons == null)
         {
            return;
         }
         ...
         this.var_52.height = this.var_53.height + 20;
         this._window.width = Math.max(this.var_52.width,this._buttons.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_52.width < this._buttons.width)
         {
            this.var_52.x = this._window.width - this.var_52.width;
            this._buttons.x = 0;
         }
         else
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2033,param1.nutrition,param1.nutritionMax,this.const_2027,this.const_2035);
         this.updateStateElement(this.const_2031,param1.experience,param1.experienceMax,this.const_2029,this.const_2026);
         this.updateStateElement(this.const_2034,param1.energy,param1.energyMax,this.const_2030,this.const_2037);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2032,this.const_2036,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2025);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2028);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1376,_loc7_.width - 2,_loc7_.height - 2 - this.const_1376);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1376);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_499) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_52 = this._window.getListItemByName("info_border") as IBorderWindow;
         if(this.var_52 != null)
         {
            this.var_53 = this.var_52.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         this._widget.mainContainer.addChild(this._window);
         var _loc3_:IWindow = this.var_52.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_52.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         var _loc7_:IBitmapWrapperWindow = this.var_52.findChildByName("status_happiness_icon") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = this.var_52.findChildByName("status_experience_icon") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
         ...
         var _loc9_:IBitmapWrapperWindow = this.var_52.findChildByName("status_energy_icon") as IBitmapWrapperWindow;
         if(_loc9_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_209 && this.var_209.getPetId() == this.var_499)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1459,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_520,this._widget.petData.ownerId);
