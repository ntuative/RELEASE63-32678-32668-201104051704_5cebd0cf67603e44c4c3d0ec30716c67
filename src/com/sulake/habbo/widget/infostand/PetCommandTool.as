package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_427:IFrameWindow;
      ...
      private const const_2005:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_350 = new Timer(this.const_2005);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1118.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_499);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1118.getValue(this.var_499) as CommandConfiguration;
      ...
      {
         this.var_1118.remove(param1);
         this.var_1118.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_879,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_39.setParamFlag(WindowParam.const_102,true);
         this.var_39.context.getDesktopWindow().addEventListener(WindowEvent.const_38,this.onWindowDesktopResized);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_427 == null)
         {
            ...
            this.var_427 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_427 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_427.x = 200;
            this.var_427.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_414,this.var_499));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_556,this.var_499,this.var_1711 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_556,this.var_499,this.var_1711 + " " + _loc5_);
