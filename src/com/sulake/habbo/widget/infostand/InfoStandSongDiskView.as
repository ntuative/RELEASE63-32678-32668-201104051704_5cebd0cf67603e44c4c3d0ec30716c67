package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandSongDiskView extends InfoStandFurniView
   {
      ...
      {
         super.update(param1);
         this.var_2026 = this.getSongIdFromExtraParam(param1.extraParam);
      }
      
      public function updateSongInfo(param1:RoomWidgetSongUpdateEvent) : void
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_511 && param1.songId == this.var_2026)
         {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         var_52 = _window.getListItemByName("info_border") as IBorderWindow;
         _buttons = _window.getListItemByName("button_list") as IItemListWindow;
         if(var_52 != null)
         {
            var_53 = var_52.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_52.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var_241 = var_52.findChildByTag("catalog");
         if(var_241 != null)
         {
            var_241.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onCatalogButtonClicked);
         }
         var _loc7_:IBitmapWrapperWindow = var_52.findChildByName("icon_disc") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = var_52.findChildByName("icon_composer") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
      ...
      private function getSongIdFromExtraParam(param1:String) : int
      {
         ...
         if(param1 != null)
         {
            _loc2_ = param1.substr(RoomWidgetInfostandExtraParamEnum.const_384.length,param1.length);
