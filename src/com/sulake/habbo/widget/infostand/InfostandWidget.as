package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1752:String = "infostand_user_view";
      
      private const const_1755:String = "infostand_furni_view";
      
      private const const_1757:String = "infostand_pet_view";
      
      private const const_1754:String = "infostand_bot_view";
      
      private const const_1753:String = "infostand_jukebox_view";
      
      private const const_1756:String = "infostand_songdisk_view";
      
      private var var_1183:InfoStandFurniView;
      ...
      private var var_966:InfoStandJukeboxView;
      
      private var var_967:InfoStandSongDiskView;
      
      private var var_2566:Array;
      
      private var var_1468:InfostandUserData;
      
      private var var_655:InfostandFurniData;
      ...
      private const const_2011:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog, param6:IHabboSoundManager)
      {
         ...
         this.var_345 = param6;
         this.var_1183 = new InfoStandFurniView(this,this.const_1755,this._catalog);
         this.var_136 = new InfoStandUserView(this,this.const_1752);
         this.var_368 = new InfoStandPetView(this,this.const_1757,this._catalog);
         this.var_444 = new InfoStandBotView(this,this.const_1754);
         this.var_966 = new InfoStandJukeboxView(this,this.const_1753,this._catalog);
         this.var_967 = new InfoStandSongDiskView(this,this.const_1756,this._catalog);
         this.var_1468 = new InfostandUserData();
         this.var_655 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_166 = new Timer(this.const_2011);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_317,this.onFurniInfo);
         param1.addEventListener(RoomWidgetUserTagsUpdateEvent.const_174,this.onUserTags);
         param1.addEventListener(RoomWidgetUserFigureUpdateEvent.const_168,this.onUserFigureUpdate);
         param1.addEventListener(RoomWidgetUserBadgesUpdateEvent.const_71,this.onUserBadges);
         param1.addEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_695,this.onUserGivableBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_663,this.onBadgeImage);
         param1.addEventListener(RoomWidgetPetInfoUpdateEvent.PET_INFO,this.onPetInfo);
         param1.addEventListener(RoomWidgetPetCommandsUpdateEvent.PET_COMMANDS,this.onPetCommands);
         param1.addEventListener(RoomWidgetSongUpdateEvent.const_325,this.onSongUpdate);
         param1.addEventListener(RoomWidgetSongUpdateEvent.const_511,this.onSongUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_317,this.onFurniInfo);
         param1.removeEventListener(RoomWidgetUserTagsUpdateEvent.const_174,this.onUserTags);
         param1.removeEventListener(RoomWidgetUserFigureUpdateEvent.const_168,this.onUserFigureUpdate);
         param1.removeEventListener(RoomWidgetUserBadgesUpdateEvent.const_71,this.onUserBadges);
         param1.removeEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_695,this.onUserGivableBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_663,this.onBadgeImage);
         param1.removeEventListener(RoomWidgetPetInfoUpdateEvent.PET_INFO,this.onPetInfo);
         param1.removeEventListener(RoomWidgetPetCommandsUpdateEvent.PET_COMMANDS,this.onPetCommands);
         param1.removeEventListener(RoomWidgetSongUpdateEvent.const_325,this.onSongUpdate);
         param1.removeEventListener(RoomWidgetSongUpdateEvent.const_511,this.onSongUpdate);
      }
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_414,this.var_368.getCurrentPetId()));
      }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_896)
         {
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_136.setTags(param1.tags,this.var_2566);
         }
      }
