package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_163:IFrameWindow;
      
      private var var_630:IWindow;
      
      private var var_52:IBorderWindow;
      
      private var var_1191:TagListRenderer;
      ...
      private const const_1744:int = 39;
      
      private const const_1745:int = 7829367;
      
      private const const_1746:int = 16777215;
      
      private const const_2009:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1191 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var _loc5_:IBitmapWrapperWindow = this.var_52.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc6_:IWindow = this.var_52.findChildByTag("close");
         if(_loc6_ != null)
         {
         ...
         while(_loc7_ < 5)
         {
            _loc9_ = this.var_52.findChildByName("badge_" + _loc7_);
            if(_loc9_ != null)
            {
         ...
         _loc9_ = this.var_52.findChildByName("badge_group");
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1745;
            }
            else
            {
               _loc3_.textColor = this.const_1746;
            }
            _loc3_.enable();
         }
         else
         ...
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_391,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_391,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1191.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_1158:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1105:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2496 > this.const_2009 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2496 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1745;
            if(_loc3_.length >= this.const_1744)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1744 - 1);
            }
         }
      }
      ...
      {
         this.var_163 = this._widget.getXmlWindow("give_badge") as IFrameWindow;
         this.var_163.center();
         this.var_163.procedure = this.badgesEventProc;
         this.var_163.visible = param1;
      }
      
      public function updateGivableBadges() : void
      {
         if(this.var_163 && this.var_163.visible)
         {
            this.showGivableBadges();
         }
      }
      ...
      private function showGivableBadges() : void
      {
         ...
         this.var_630 = null;
         var _loc2_:IItemGridWindow = this.var_163.findChildByName("list.badges") as IItemGridWindow;
         if(_loc2_)
         {
      ...
      public function setGivableBadgeImage(param1:Array, param2:BitmapData) : void
      {
         ...
         var _loc3_:IItemGridWindow = this.var_163.findChildByName("list.badges") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = -1;
               _loc4_ = this.var_163.findChildByName("list.badges") as IItemGridWindow;
               if(_loc4_)
               {
