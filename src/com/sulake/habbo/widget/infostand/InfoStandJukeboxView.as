package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_325)
         {
            this.var_2026 = param1.songId;
         }
         if(param1.songId == this.var_2026)
         {
            this._songName = param1.songName;
            this.var_2737 = param1.songAuthor;
            this.updateNowPlaying(this.var_2026 >= 0);
         }
      }
      ...
      private function updateNowPlaying(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2737;
         }
         else
         {
