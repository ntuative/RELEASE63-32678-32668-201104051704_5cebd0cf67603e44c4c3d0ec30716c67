package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2023:int = 5;
      
      private const const_2024:int = 5;
      
      private var _widget:InfostandWidget;
      
      private var var_160:Function;
      
      private var _offsetX:int;
      
      private var var_1205:int;
      
      private var var_1206:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1205 = 0;
         this.var_1206 = param2.rectangle.clone();
         this.var_1206.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1206.width)
         {
            return false;
         }
         if(this.var_1205 + param1.height > this.var_1206.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1206.width)
         {
            this._offsetX = 0;
            this.var_1205 += param1.height + this.const_2024;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1205);
         this._offsetX += param1.width + this.const_2023;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1494 != null && this.var_1494.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_160);
