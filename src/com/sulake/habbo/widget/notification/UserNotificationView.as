package com.sulake.habbo.widget.notification
{
   ...
   public class UserNotificationView implements IDisposable
   {
      ...
      protected static const const_1723:String = "button_ok";
      
      protected static const const_1724:String = "text_title";
      
      protected static const DESCRIPTION_NAME:String = "text_description";
      
      protected static const const_1994:String = "widget_notification_frame";
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            if(this.var_666)
            {
               while(this.var_666.length > 0)
               {
                  this.var_666.pop().dispose();
               }
               this.var_666 = null;
            }
            this._widget = null;
      ...
      public function showNotification(param1:String, param2:String) : Boolean
      {
         ...
         dialog.findChildByName(const_1724).caption = title;
         dialog.findChildByName(DESCRIPTION_NAME).caption = description;
         dialog.center();
         dialog.findChildByName(const_1723).addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,function(param1:WindowMouseEvent):void
         {
      ...
      public function hideNotification(param1:IFrameWindow) : void
      {
         ...
         if(param1 != null)
         {
            _loc2_ = this.var_666.indexOf(param1);
            if(_loc2_ > -1)
            {
               this.var_666.splice(_loc2_,1);
            }
            param1.dispose();
         }
      }
