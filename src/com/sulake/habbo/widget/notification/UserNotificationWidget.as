package com.sulake.habbo.widget.notification
{
   ...
   public class UserNotificationWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetUserNotificationEvent.const_593,this.onDisplayNotification);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetUserNotificationEvent.const_593,this.onDisplayNotification);
