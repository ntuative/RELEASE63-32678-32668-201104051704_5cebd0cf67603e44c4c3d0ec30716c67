package com.sulake.habbo.widget.poll
{
   ...
   public class PollSession implements IDisposable
   {
      ...
      private var var_1138:PollWidget;
      ...
      {
         this.hideOffer();
         this.var_259 = new PollOfferDialog(this._id,param1,this.var_1138);
      }
      ...
      public function showContent(param1:String, param2:String, param3:Array) : void
      {
         ...
         this.var_259 = new PollContentDialog(this._id,param1,param3,this.var_1138);
      }
      ...
      {
         this.var_1138.windowManager.alert("${poll_thanks_title}",this.var_1880,0,function(param1:IAlertDialog, param2:WindowEvent):void
         {
            param1.dispose();
         });
      }
