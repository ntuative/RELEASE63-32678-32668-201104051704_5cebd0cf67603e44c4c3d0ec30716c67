package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1577:int = 30000;
      ...
      public function VoteWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         {
            this.var_1577 = int(this._config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_166.reset();
            this.var_166.removeEventListener(TimerEvent.TIMER,this.updateEvent);
            this.var_166 = null;
         }
         this._config = null;
         super.dispose();
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_133,this.showVoteResult);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_133,this.showVoteResult);
      }
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         {
            this.var_166 = new Timer(1000);
            this.var_166.addEventListener(TimerEvent.TIMER,this.updateEvent);
         }
      ...
      private function updateTimerView() : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((this.var_1577 - _loc1_) / 1000,0);
      ...
      {
         var _loc2_:int = getTimer() - this.var_2048;
         if(_loc2_ > this.var_1577)
         {
            this.vote();
            return;
         }
