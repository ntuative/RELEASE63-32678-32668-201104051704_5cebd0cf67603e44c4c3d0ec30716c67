package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_1995:int = 1000;
      ...
      {
         super();
         this.var_205 = new Timer(this.const_1995);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_177.isActive)
         {
            ...
            this.var_876.width = _loc2_ * this.var_327;
         }
         else
         {
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_704 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_704 == null)
            {
               return;
            }
         ...
         if(!this.var_177.isActive)
         {
            this.var_704.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_704.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_704.text;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(this.var_876 != null)
         {
            this.var_327 = this.var_876.width;
            this.var_205.start();
            this.onUpdate();
         }
