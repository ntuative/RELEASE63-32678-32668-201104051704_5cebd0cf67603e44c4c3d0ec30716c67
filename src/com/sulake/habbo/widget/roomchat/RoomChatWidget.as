package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1371:int = 9;
      
      private static const const_994:int = 10;
      
      private static const const_627:int = 25;
      
      private static const const_1334:int = 25;
      
      private static const const_992:int = 4000;
      
      private static const const_1368:int = 6000;
      
      private static const const_1369:int = 3;
      
      private static const const_1370:int = 1;
      
      private static const const_626:int = 8;
      
      private static const const_439:int = 0;
      
      private static const const_993:int = (const_626 + const_439) * const_110 + const_110;
      
      private static const const_438:int = 9;
      ...
      private var var_377:IItemListWindow;
      ...
      private var var_2656:int = 150;
      
      private var var_232:int = 171.0;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         this.var_41 = param1.createWindow("chat_container","",HabboWindowType.const_68,HabboWindowStyle.const_29,HabboWindowParam.const_44,new Rectangle(0,0,200,this.var_232 + RoomChatHistoryPulldown.const_84),null,0) as IWindowContainer;
         this.var_41.background = true;
         this.var_41.color = 33554431;
         this.var_41.tags.push("room_widget_chat");
         this.var_377 = param1.createWindow("chat_contentlist","",HabboWindowType.const_1235,HabboWindowStyle.const_44,0 | 0,new Rectangle(0,0,200,this.var_232),null,0) as IItemListWindow;
         this.var_41.addChild(this.var_377);
         this._activeContentWindow = param1.createWindow("chat_active_content","",HabboWindowType.const_68,HabboWindowStyle.const_44,HabboWindowParam.const_62,new Rectangle(0,0,200,this.var_232),null,0) as IWindowContainer;
         this._activeContentWindow.clipping = false;
         this.var_377.addListItem(this._activeContentWindow);
         this.var_28 = new RoomChatHistoryViewer(this,param1,this.var_41,param2);
         this.var_2654 = param4.getKey("site.url");
         this.var_2656 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      {
         var _loc2_:int = 0;
         if(getTimer() > this.var_1220 && this.var_1220 > 0)
         {
            this.var_1220 = -1;
            this.animationStart();
         }
         if(this.var_897)
         {
            _loc2_ = param1 / const_1334 * const_1369;
            if(_loc2_ + this.var_996 > this.var_997)
            {
               _loc2_ = this.var_997 - this.var_996;
            }
            if(_loc2_ > 0)
            {
            ...
            if(this.var_996 >= this.var_997)
            {
               this.var_997 = const_110;
               this.var_996 = 0;
               this.animationStop();
               this.processBuffer();
               this.var_1220 = getTimer() + const_992;
            }
         }
         if(this.var_28 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_772,this.onChatMessage);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_326,this.onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_711,this.onRoomViewUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_772,this.onChatMessage);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_326,this.onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_711,this.onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_767,this.onRoomViewUpdate);
      }
      
      private function onChatMessage(param1:RoomWidgetChatUpdateEvent) : void
      {
         var _loc2_:RoomChatItem = new RoomChatItem(this,windowManager,assets,this.getFreeItemId(),localizations,this.var_2654);
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(this.var_1928 == 0)
            {
               this.var_1928 = param1.scale;
            }
            else
            {
               this.var_995 = param1.scale / this.var_1928;
            }
         }
         if(param1.positionDelta != null)
         {
            this.var_800.x += param1.positionDelta.x / this.var_995;
            this.var_800.y += param1.positionDelta.y / this.var_995;
         }
         if(param1.rect != null)
         {
            if(this.var_28 == null)
            ...
            this.var_41.height = this.var_232 + this.var_28.pulldownBarHeight;
            this.var_377.width = this.var_41.width - this.var_28.scrollbarWidth;
            this.var_377.height = this.var_232;
            this.var_377.x = this.var_41.x;
            this.var_377.y = this.var_41.y;
            this._activeContentWindow.width = this.var_41.width - this.var_28.scrollbarWidth;
            this._activeContentWindow.height = this.var_232;
      ...
      private function processBuffer() : void
      {
         ...
         while(this.var_71.length > const_1370 || this.historyViewerActive() && this.var_71.length > 0)
         {
         ...
         else
         {
            ...
            {
               this.var_997 = this.getItemSpacing(this._itemList[this._itemList.length - 1],this.var_71[0]);
            }
            else
            {
               this.var_997 = const_110;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(this._itemList.length > 1)
               {
                  ...
                  {
                     _loc1_.screenLevel = _loc3_ + Math.max(this.var_801,1);
                  }
               }
               else
               {
               ...
               _loc1_.aboveLevels = this.var_801;
               if(_loc1_.aboveLevels > const_626 + const_439 + 2)
               {
                  _loc1_.aboveLevels = const_626 + const_439 + 2;
               }
               this.var_801 = 0;
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_439 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timeStamp >= const_1368)
               {
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + this.var_800.x) * this.var_995;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = -this.var_41.width / 2 - const_994;
         var _loc6_:Number = this.var_41.width / 2 + const_994 - this.var_28.scrollbarWidth;
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            _loc3_ = !!this.historyViewerActive() ? 0 : Number(this.var_801);
            if(_loc2_ == this._itemList.length - 1)
            {
               param1.y = this.getAreaBottom() - (_loc3_ + 1) * const_110 - const_438;
            }
            else
            {
      ...
      private function getAreaBottom() : Number
      {
         ...
         return this.var_232 + this.var_41.y;
      }
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(this._itemList.length > this.var_2656)
         {
      ...
      {
         return "chat_" + this.var_2653.toString() + "_item_" + (this.var_2655++).toString();
      }
      ...
      public function onItemMouseClick(param1:int, param2:String, param3:int, param4:int, param5:int, param6:WindowMouseEvent) : void
      {
         ...
         var _loc7_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_367,param1,param3);
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         this.var_232 = param1 - this.var_41.y;
         this.var_41.height = this.var_232 + RoomChatHistoryPulldown.const_84;
         if(this.var_28 != null)
         {
            this.var_28.containerResized(this.var_41.rectangle);
         }
      ...
      public function resetArea() : void
      {
         ...
         this.animationStop();
         this.var_232 = const_993 + const_438;
         this.var_41.height = this.var_232 + this.var_28.pulldownBarHeight;
         this.var_377.width = this.var_41.width - this.var_28.scrollbarWidth;
         this.var_377.height = this.var_232;
         this._activeContentWindow.width = this.var_41.width - this.var_28.scrollbarWidth;
         if(this.historyViewerActive())
         {
            this._activeContentWindow.height = this.getTotalContentHeight() + const_438;
         }
         else
         {
            this._activeContentWindow.height = this.var_232;
         }
         this.var_377.scrollV = 1;
         if(!this.historyViewerActive())
         {
            this.var_28.containerResized(this.var_41.rectangle);
         }
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_1149)
         {
            this.resetArea();
            return;
         }
      ...
      public function mouseUp() : void
      {
         ...
         if(_loc1_ < const_993)
         {
            if(_loc1_ <= this.var_232 + this.var_41.y)
            {
               if(this.historyViewerActive())
               {
                  this.hideHistoryViewer();
         ...
         if(this.var_1929 && !this.historyViewerActive())
         {
            this.resetArea();
            this.var_1929 = false;
         }
