package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1335:int = 18;
      
      private static const SCROLLBAR_WIDTH:int = 20;
      
      public static const const_1149:int = 3;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_188.state = RoomChatHistoryPulldown.const_279;
         ...
         this.var_49 = param2.createWindow("chatscroller","",HabboWindowType.const_1159,HabboWindowStyle.const_44,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_188.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_279);
      }
      ...
      {
         return !!this.var_432 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_188.state == RoomChatHistoryPulldown.const_382 || this.var_188.state == RoomChatHistoryPulldown.const_548;
      }
      ...
      {
         if(!this.var_432 && !this.var_1776)
         {
            this.var_432 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_188.state = RoomChatHistoryPulldown.const_382;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_49 != null)
         {
            ...
            if(param2)
            {
               this.var_49.scrollV = this.var_626;
            }
         }
         if(this.var_188 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_433 > 0 && param2)
         {
            if(this.var_1799)
            {
               if(Math.abs(param1 - this.var_433) <= const_1149)
               {
                  return;
               }
               this.var_1799 = false;
            ...
            if(this.var_432)
            {
               ...
               _loc5_ = (param1 - this.var_433) / this.var_49.height;
               _loc3_ = this.var_626 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_433;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_49.scrollV < 1 - const_1335 / this.var_49.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1800)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_49 != null)
         {
            this.var_626 = this.var_49.scrollV;
         }
         if(this.var_49 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_626 - this.var_49.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
