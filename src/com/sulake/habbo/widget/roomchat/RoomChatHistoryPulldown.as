package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_279:int = 0;
      
      public static const const_84:int = 39;
      
      private static const const_968:int = 150;
      
      private static const const_967:int = 250;
      ...
      private var var_2440:BitmapData;
      
      private var var_1784:BitmapData;
      
      private var var_2441:BitmapData;
      ...
      private var var_2442:BitmapData;
      
      private var var_2438:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_41 = param3;
         this.var_2440 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1784 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2441 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1783 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1785 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2437 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2442 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_75 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_310,HabboWindowStyle.const_29,HabboWindowParam.const_62,new Rectangle(0,0,param3.width,param3.height - const_84),null,0,0) as IBitmapWrapperWindow;
         this.var_41.addChild(this.var_75);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_68,HabboWindowStyle.const_29,0 | 0,new Rectangle(0,this.var_41.height - const_84,param3.width,const_84),null,0) as IWindowContainer;
         this.var_41.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_552,HabboWindowStyle.const_44,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_84),null,0) as IRegionWindow;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowMouseEvent.const_61,this.onCloseButtonMouseUp);
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_548:
               this.var_75.blend += param1 / const_967;
               this._window.blend += param1 / const_967;
               if(this._window.blend >= 1)
               {
                  this.state = const_382;
               }
               break;
            case const_980:
               this.var_75.blend -= param1 / const_968;
               this._window.blend -= param1 / const_968;
      ...
      public function set state(param1:int) : void
      {
         ...
         {
            case const_382:
               if(this._state == const_279)
               {
                  this.state = const_548;
               }
               else
               {
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_41.width - this.var_2438;
         }
         if(this.var_75 != null)
         {
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2439 == this._window.width)
         {
            return;
         }
         this.var_2439 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2441;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1783;
            _loc2_.disposesBitmap = false;
            this.var_2438 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2440,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1784,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1784,_loc9_);
         ...
         this.var_75.bitmap = this.var_2442;
