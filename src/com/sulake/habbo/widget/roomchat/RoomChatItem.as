package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_632:int = 6;
      
      private static const const_1395:int = 6;
      
      private static const const_1004:int = 35;
      
      private static const const_436:String = "name";
      
      private static const const_988:String = "message";
      
      private static const const_1394:String = "pointer";
      ...
      private static var var_238:IRegionWindow;
      
      private static var var_460:IRegionWindow;
      ...
      public function RoomChatItem(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IHabboLocalizationManager, param6:String)
      {
         ...
         if(!var_238)
         {
            var_238 = this._windowManager.buildFromXML(this._assetLibrary.getAssetByName("bubble_speak").content as XML,1) as IRegionWindow;
            var_238.tags.push("roomchat_bubble");
            var_238.x = 0;
            var_238.y = 0;
            var_238.width = 0;
            var_238.background = true;
            var_238.mouseThreshold = 0;
            var_238.setParamFlag(WindowParam.WINDOW_PARAM_FORCE_CLIPPING,true);
         }
         if(!var_459)
         {
            var_459 = this._windowManager.buildFromXML(this._assetLibrary.getAssetByName("bubble_shout").content as XML,1) as IRegionWindow;
         ...
         if(!var_460)
         {
            var_460 = this._windowManager.buildFromXML(this._assetLibrary.getAssetByName("bubble_whisper").content as XML,1) as IRegionWindow;
            var_460.tags.push("roomchat_bubble");
            var_460.x = 0;
            var_460.y = 0;
            var_460.width = 0;
            var_460.background = true;
            var_460.mouseThreshold = 0;
            var_238.setParamFlag(WindowParam.WINDOW_PARAM_FORCE_CLIPPING,true);
         }
         if(!var_385)
         {
      ...
      {
         this.var_1537 = param1.chatType;
         this.var_1259 = param1.userId;
         this.var_1024 = param1.userName;
         this.var_1258 = param1.userCategory;
         this._message = param1.text;
         this.var_386 = param1.links;
         this.var_1983 = param1.userX;
         this.var_277 = param1.userImage;
         this.var_2752 = param1.userColor;
      ...
      {
         var _loc5_:Rectangle = new Rectangle(this._x,this.var_152,this.width,const_1003);
      ...
      public function renderView() : void
      {
         ...
         {
            case RoomWidgetChatUpdateEvent.const_151:
               this._window = var_238.clone() as IRegionWindow;
               break;
            case RoomWidgetChatUpdateEvent.const_154:
               this._window = var_460.clone() as IRegionWindow;
               break;
         ...
         var pointerWindow:IBitmapWrapperWindow = this._window.findChildByName(const_1394) as IBitmapWrapperWindow;
         ...
         if(this.var_277 && !isRespect)
         {
            ...
            if(userIconWindow)
            {
               ...
               userIconWindow.x = x1;
               userIconWindow.y = y1;
               this.var_824 = Math.max(0,(this.var_277.height - background.height) / 2);
         ...
         if(nameWindow != null)
         {
            if(!isRespect)
            {
               nameWindow.text = this.var_1024 + ": ";
               nameWindow.y += this.var_824;
               nameWindow.width = nameWindow.textWidth + const_632;
            }
            else
            {
               nameWindow.text = "";
         ...
         if(this.var_1537 == RoomWidgetChatUpdateEvent.const_331)
         {
            textWindow.text = this.var_67.registerParameter("widgets.chatbubble.respect","username",this.var_1024);
            this.var_276 = const_1004;
         }
         else if(this.var_1537 == RoomWidgetChatUpdateEvent.const_306)
         {
            textWindow.text = this.var_67.registerParameter("widget.chatbubble.petrespect","petname",this.var_1024);
            this.var_276 = const_1004;
         }
         ...
         if(textWindow.visible)
         {
            ...
            if(nameWindow != null)
            {
               ...
               if(nameWindow.width > const_632)
               {
                  textWindow.x -= const_632 - 1;
               }
            }
            textWindow.y += this.var_824;
            messageWidth = textWindow.textWidth;
            textWindow.width = messageWidth + const_1395;
         ...
         var bitmap:BitmapData = this.buildBubbleImage(nameWindow.width + textWindow.width,background.height,this.var_2752,isRespect);
         ...
         if(_loc4_ > -1)
         {
            ...
            while(_loc5_ < this.var_823.length)
            {
               if(_loc4_ >= this.var_823[_loc5_][0] && _loc4_ <= this.var_823[_loc5_][1])
               {
                  ...
                  {
                     HabboWebTools.openWebPage(this.var_1985 + this.var_386[_loc5_][0],"habboMain");
                  }
                  else
                  {
                     HabboWebTools.openWebPage(this.var_1985 + this.var_386[_loc5_][0]);
                  }
                  return true;
               }
               _loc5_++;
      ...
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         ...
         this._widget.onItemMouseClick(this.var_1259,this.var_1024,this.var_1258,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseDown(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseDown(this.var_1259,this.var_1258,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOver(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOver(this.var_1259,this.var_1258,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOut(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOut(this.var_1259,this.var_1258,this._roomId,this._roomCategory,param1);
      }
