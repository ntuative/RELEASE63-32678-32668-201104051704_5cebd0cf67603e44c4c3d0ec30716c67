package com.sulake.habbo.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_448,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_392,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_448,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_392,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPetPackageUpdateEvent) : void
      {
         ...
         switch(event.type)
         {
            case RoomWidgetPetPackageUpdateEvent.const_579:
               this.hideInterface();
               this.var_373 = event.objectId;
               this.var_671 = event.image;
               this.showInterface();
               this.showPetImage();
               break;
            case RoomWidgetPetPackageUpdateEvent.const_448:
               if(!this.var_1246)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPetPackageUpdateEvent.const_392:
               if(event.objectId != this.var_373)
               {
                  return;
               }
               this.var_671 = event.image;
      ...
      {
         var _loc2_:* = null;
         if(this.var_671 == null || this._window == null)
         {
            return;
         }
         ...
         if(_loc1_ != null)
         {
            ...
            _loc2_ = new Point((_loc1_.width - this.var_671.width) / 2,(_loc1_.height - this.var_671.height) / 2);
            _loc1_.bitmap.copyPixels(this.var_671,this.var_671.rect,_loc2_);
         }
      }
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1246 || this.var_373 == -1)
         {
            return;
         }
         ...
         {
            this.var_1246 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_768,this.var_373,name);
