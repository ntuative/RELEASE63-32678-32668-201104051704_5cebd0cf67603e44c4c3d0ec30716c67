package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_621:String = "welcome_gift_email_unverified";
      
      private const const_981:String = "welcome_gift_email_verified";
      
      private const const_1359:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1192)
         {
            this.setViewState(this.const_981);
         }
         else
         {
            this.setViewState(this.const_621);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_621:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1878;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_1878);
               break;
            case this.const_981:
      ...
      {
         this.setViewState(this.const_1359);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_667,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1192 ? this.const_981 : this.const_621);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1476 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1476));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_493,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_726,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_493,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_726,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_493:
               this.var_1475 = param1.email;
               this.var_1192 = param1.isVerified;
               this.var_1878 = param1.allowEmailChange;
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1476);
