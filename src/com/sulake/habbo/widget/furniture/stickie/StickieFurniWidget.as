package com.sulake.habbo.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1312:int = 14;
      
      private static const const_1311:int = 500;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetStickieDataUpdateEvent.const_781,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetStickieDataUpdateEvent.const_781,this.onObjectUpdate);
      }
      ...
      private function showInterface() : void
      {
         ...
         {
            this._window = windowManager.createWindow("stickieui_container","",HabboWindowType.const_68,HabboWindowStyle.const_29,0 | 0,new Rectangle(const_1247,WINDOW_INITIAL_Y,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null)
         {
            ...
            else
            {
               ...
               _loc6_.color = uint("0xFF" + this.var_924);
            }
      ...
      private function sendUpdate() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_508,this.var_373,this._text,this.var_924);
      ...
      private function sendSetColor(param1:uint) : void
      {
         ...
         if(messageListener != null)
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_508,this.var_373,this._text,this.var_924);
      ...
      private function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_724,this.var_373);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function onTextWindowEvent(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1311;
         if(_loc2_.numLines < const_1312)
         {
            return;
         }
