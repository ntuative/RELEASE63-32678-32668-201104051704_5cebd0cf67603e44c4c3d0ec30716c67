package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_411:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_68,HabboWindowStyle.const_29,0 | 0,new Rectangle(const_1247,WINDOW_INITIAL_Y,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            this.var_411 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
         this.var_269 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_269.numTabItems)
         {
            _loc6_ = this.var_269.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         if(this.var_411 != null)
         {
            this.var_411.setValue(this.var_1336);
         }
         this.var_540 = this.colors.indexOf(_loc2_.color);
         if(this.var_583 != null)
         {
            this.var_583.setSelectedColorIndex(this.var_540);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_269.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_269.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_269.selector.getSelected();
         return this.var_269.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_411 != null)
         {
            this.var_411.min = this._widget.minLights[param1 - 1];
         }
      }
