package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      {
         if(this._view == null || this.var_522 == null)
         {
            return;
         }
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(this.var_1832) as IWindowContainer;
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_953.width,this.var_953.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_953,this.var_953.rect,new Point(0,0),null,null,true);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_1832 = XML(_loc2_.content);
         ...
         this.var_953 = BitmapData(_loc3_.content);
      }
