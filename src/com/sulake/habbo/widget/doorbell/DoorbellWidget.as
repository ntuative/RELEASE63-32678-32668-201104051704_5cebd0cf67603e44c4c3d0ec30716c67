package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1342:int = 50;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_821,this.onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_143,this.onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_821,this.onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_143,this.onDoorbellHandled);
      ...
      public function addUser(param1:String) : void
      {
         ...
         if(this._users.length >= const_1342)
         {
            this.deny(param1);
            return;
         }
