   ...
   public class PurseWidget extends RoomWidgetBase
   {
      ...
      public function PurseWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager)
      {
         ...
         if(_loc4_)
         {
            ...
            this._view.x = _loc5_.width - this._view.width - this.const_1728;
            this._view.y = this.const_1728;
      ...
      {
         this.var_1647 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("credits").caption = this.var_1647.toString();
            this._view.findChildByName("credits_shadow").caption = this.var_1647.toString();
         }
      }
      
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         this.var_1646 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("pixels").caption = this.var_1646.toString();
            this._view.findChildByName("pixels_shadow").caption = this.var_1646.toString();
         }
      }
