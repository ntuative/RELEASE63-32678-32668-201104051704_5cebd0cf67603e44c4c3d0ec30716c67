package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      private static const const_1356:int = 2;
      
      private static const const_1751:int = 3;
      ...
      {
         return this.getUserDataByType(param1,const_1355);
      }
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = this.var_965.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      {
         this.var_965.remove(param1);
         this.var_965.add(param1,param2);
      }
      ...
      {
         return this.getUserDataByType(param1,const_1356);
      }
