package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_936:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1251:String = "sendAccessTokenToServer";
      
      private static const const_1250:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1251,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1250,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_936);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_936);
         }
      }
