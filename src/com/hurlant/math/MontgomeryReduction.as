package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_1970 = param1.invDigit();
         this.var_1971 = this.var_1970 & 32767;
         this.var_2720 = this.var_1970 >> 15;
         this.var_2721 = 131071;
         this.var_2722 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_162) > 0)
         {
